...
| **triggers** | [../model/List[Trigger]](Trigger.md) | Required | The triggers associated with the integration instance. |
...
| **post_process_tasks** | [../model/List[PostProcessTask]](PostProcessTask.md) | Required | The post process tasks associated with the integration instance. |
