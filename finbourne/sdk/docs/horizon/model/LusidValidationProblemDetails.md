...
| **errors** | **Dict[str, List[str]]** | Required | *No description available.* |
...
```python
from finbourne.sdk.services.horizon.models.LusidValidationProblemDetails import LusidValidationProblemDetails
