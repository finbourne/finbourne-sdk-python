...
[**create_matching_ruleset**](RecsApi.md#create_matching_ruleset) | **POST** /api/api/recs/matchingrulesets | [EXPERIMENTAL] CreateMatchingRuleset: CreateMatchingRuleset
[**create_rec_definition**](RecsApi.md#create_rec_definition) | **POST** /api/api/recs/definitions | [EXPERIMENTAL] CreateRecDefinition: CreateRecDefinition
[**delete_matching_ruleset**](RecsApi.md#delete_matching_ruleset) | **DELETE** /api/api/recs/matchingrulesets/{scope}/{code} | [EXPERIMENTAL] DeleteMatchingRuleset: DeleteMatchingRuleset
[**delete_rec_definition**](RecsApi.md#delete_rec_definition) | **DELETE** /api/api/recs/definitions/{scope}/{code} | [EXPERIMENTAL] DeleteRecDefinition: DeleteRecDefinition
...
[**list_rec_definitions**](RecsApi.md#list_rec_definitions) | **GET** /api/api/recs/definitions | [EXPERIMENTAL] ListRecDefinitions: ListRecDefinitions
...
> MatchingRuleset createMatchingRuleset = create_matching_ruleset(create_matching_ruleset_request)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_matching_ruleset_request** | [**CreateMatchingRulesetRequest**](../model/CreateMatchingRulesetRequest.md)| The matching ruleset to create. | [required] 
...
> RecDefinition createRecDefinition = create_rec_definition(create_rec_definition_request)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **create_rec_definition_request** | [**CreateRecDefinitionRequest**](../model/CreateRecDefinitionRequest.md)| The rec definition to create. | [required] 
...
> DeletedEntityResponse deleteMatchingRuleset = delete_matching_ruleset(scope, code)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **scope** | **str**| The scope of the matching ruleset. | [required] 
 **code** | **str**| The code of the matching ruleset. Together with the scope this uniquely identifies the matching ruleset. | [required] 
...
> DeletedEntityResponse deleteRecDefinition = delete_rec_definition(scope, code)
...
> MatchingRuleset getMatchingRuleset = get_matching_ruleset(scope, code, as_at=as_at)
...
> PagedResourceListOfMatchingRuleset listMatchingRulesets = list_matching_rulesets(as_at=as_at, page=page, sort_by=sort_by, limit=limit, filter=filter)
...
> MatchingRuleset updateMatchingRuleset = update_matching_ruleset(scope, code, update_matching_ruleset_request)
 ...
 **scope** | **str**| The scope of the matching ruleset. | [required] 
 **code** | **str**| The code of the matching ruleset. Together with the scope this uniquely identifies the matching ruleset. | [required] 
 **update_matching_ruleset_request** | [**UpdateMatchingRulesetRequest**](../model/UpdateMatchingRulesetRequest.md)| The updated matching ruleset values. | [required] 
...
> RecDefinition updateRecDefinition = update_rec_definition(scope, code, update_rec_definition_request)
 ...
 **scope** | **str**| The scope of the rec definition. | [required] 
 **code** | **str**| The code of the rec definition. Together with the scope this uniquely identifies the rec definition. | [required] 
 **update_rec_definition_request** | [**UpdateRecDefinitionRequest**](../model/UpdateRecDefinitionRequest.md)| The updated rec definition values. | [required] 
