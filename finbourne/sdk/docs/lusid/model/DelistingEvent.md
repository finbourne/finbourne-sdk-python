...
|------|------|----------|-------------|
| **effective_date** | **datetime** | Optional | The date the security is removed from official board quotation (the trading-status change takes effect). |
| **announcement_date** | **datetime** | Optional | The date the delisting was announced. Optional — null when no separate announcement date is provided.  When populated, must be &lt;&#x3D; EffectiveDate. |
...
```python
from finbourne.sdk.services.lusid.models.DelistingEvent import DelistingEvent

instance = DelistingEvent(
    effective_date=datetime.now(),  # optional — The date the security is removed from official board quotation (the trading-status change takes effect).
    announcement_date=datetime.now(),  # optional — The date the delisting was announced. Optional — null when no separate announcement date is provided.  When populated, must be &lt;&#x3D; EffectiveDate.
