...
|------|------|----------|-------------|
| **detail** | **Dict[str, Optional[str]]** | Optional | Information about the particular instance of the ChangeInterval (supplied information depends on the type of Action). Contains extra detail for order management actions such as related entity ids and compliance run details. |
| **action_description** | **str** | Optional | Description of the action performed on the entity. |
...
```python
from finbourne.sdk.services.lusid.models.ChangeIntervalWithOrderManagementDetail import ChangeIntervalWithOrderManagementDetail

instance = ChangeIntervalWithOrderManagementDetail(
    ...
    action_description="...",  # optional — Description of the action performed on the entity.
