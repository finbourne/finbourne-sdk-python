...
| **dividend_currency** | **str** | Required | Payment currency |
| **dividend_rate** | **float** | Required | Dividend rate or payment rate as a percentage.  i.e. 5% is written as 0.05 |
...
```python
from finbourne.sdk.services.lusid.models.AccumulationEvent import AccumulationEvent

instance = AccumulationEvent(
    announcement_date=datetime.now(),  # optional — Date on which the dividend was announced / declared.
    dividend_currency="...",  # required — Payment currency
    dividend_rate=0.0,  # required — Dividend rate or payment rate as a percentage.  i.e. 5% is written as 0.05
