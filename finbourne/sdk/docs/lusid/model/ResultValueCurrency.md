...
|------|------|----------|-------------|
| **value** | **str** | Optional | The value itself |
...
```python
from finbourne.sdk.services.lusid.models.ResultValueCurrency import ResultValueCurrency

instance = ResultValueCurrency(
