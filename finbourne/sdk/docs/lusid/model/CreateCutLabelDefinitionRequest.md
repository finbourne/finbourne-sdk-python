...
```python
from finbourne.sdk.services.lusid.models.CreateCutLabelDefinitionRequest import CreateCutLabelDefinitionRequest

instance = CreateCutLabelDefinitionRequest(
    code="...",  # required
