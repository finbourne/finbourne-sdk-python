...
|------|------|----------|-------------|
| **start_date** | **datetime** | Optional | The first date on which the instrument could close |
| **end_date** | **datetime** | Optional | The last date on which the instrument could close |
...
```python
from finbourne.sdk.services.lusid.models.CloseEvent import CloseEvent

instance = CloseEvent(
    start_date=datetime.now(),  # optional — The first date on which the instrument could close
    end_date=datetime.now(),  # optional — The last date on which the instrument could close
