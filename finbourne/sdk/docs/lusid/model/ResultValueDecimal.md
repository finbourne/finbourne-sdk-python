...
|------|------|----------|-------------|
| **value** | **float** | Optional | The value itself |
...
```python
from finbourne.sdk.services.lusid.models.ResultValueDecimal import ResultValueDecimal

instance = ResultValueDecimal(
    value=0.0,  # optional — The value itself
