...
| **market** | [../model/MarketContext](MarketContext.md) | Optional | *No description available.* |
| **pricing** | [../model/PricingContext](PricingContext.md) | Optional | *No description available.* |
| **aggregation** | [../model/AggregationContext](AggregationContext.md) | Optional | *No description available.* |
| **description** | **str** | Optional | User can assign a description to understand more humanly the recipe. |
| **holding** | [../model/HoldingContext](HoldingContext.md) | Optional | *No description available.* |
| **translation** | [../model/TranslationContext](TranslationContext.md) | Optional | *No description available.* |
