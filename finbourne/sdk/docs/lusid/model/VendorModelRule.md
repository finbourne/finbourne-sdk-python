...
|------|------|----------|-------------|
| **supplier** | **str** | Required | Available values: Lusid, RefinitivQps, RefinitivTracsWeb, VolMaster, IsdaCds, YieldBook, LusidCalc. |
...
| **model_options** | [../model/ModelOptions](ModelOptions.md) | Optional | *No description available.* |
...
| **address_key_filters** | [../model/List[AddressKeyFilter]](AddressKeyFilter.md) | Optional | Condition for model selection. If a condition is satisfied the default model for valuation is overridden (for that instrument). |
