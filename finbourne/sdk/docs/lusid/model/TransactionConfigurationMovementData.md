...
| **mappings** | [../model/List[TransactionPropertyMapping]](TransactionPropertyMapping.md) | Optional | This allows you to map a transaction property to a property on the underlying holding |
