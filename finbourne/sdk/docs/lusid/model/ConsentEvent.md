...
| **lapse_elections** | [List[LapseElection]](LapseElection.md) | Optional | List of possible lapse elections for this event (NOAC). |
| **consent_granted_elections** | [List[ConsentGrantedElection]](ConsentGrantedElection.md) | Optional | List of possible consent-granted elections for this event (CONY), each optionally carrying a consent fee. |
| **consent_denied_elections** | [List[ConsentDeniedElection]](ConsentDeniedElection.md) | Optional | List of possible consent-denied elections for this event (CONN). |
| **abstain_elections** | [List[AbstainElection]](AbstainElection.md) | Optional | List of possible abstain elections for this event (ABST). |
...
instance = ConsentEvent(
    ...
    lapse_elections=[],  # optional — List of possible lapse elections for this event (NOAC).
    consent_granted_elections=[],  # optional — List of possible consent-granted elections for this event (CONY), each optionally carrying a consent fee.
    consent_denied_elections=[],  # optional — List of possible consent-denied elections for this event (CONN).
    abstain_elections=[],  # optional — List of possible abstain elections for this event (ABST).
