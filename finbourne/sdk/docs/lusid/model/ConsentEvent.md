...
| **cash_offer_elections** | [../model/List[CashOfferElection]](CashOfferElection.md) | Optional | List of possible cash offer elections for this event. Each tier (CONY-standard, CONY-early)  is modelled as a separate entry; the election carries the per-unit fee rate and currency. |
| **lapse_elections** | [../model/List[LapseElection]](LapseElection.md) | Optional | List of possible lapse elections for this event (NOAC, CONN, ABST). |
