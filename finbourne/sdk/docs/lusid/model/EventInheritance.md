...
```python
from finbourne.sdk.services.lusid.models.EventInheritance import EventInheritance

instance = EventInheritance(
    parent_corporate_action_source_id=ResourceId(...)  # required
)
```
