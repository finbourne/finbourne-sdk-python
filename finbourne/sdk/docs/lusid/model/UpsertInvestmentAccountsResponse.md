...
| **values** | [../model/Dict[str, InvestmentAccount]](InvestmentAccount.md) | Optional | The investment accounts which have been successfully updated or created. |
| **failed** | [../model/Dict[str, ErrorDetail]](ErrorDetail.md) | Optional | The investment accounts that could not be updated or created or were left unchanged without error along with a reason for their failure. |
