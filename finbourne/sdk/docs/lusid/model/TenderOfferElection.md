...
|------|------|----------|-------------|
| **tender_offer_currency** | **str** | Required | Currency of the cash offer |
| **tender_offer_price** | **float** | Required | Price per share of the cash offer |
...
```python
from finbourne.sdk.services.lusid.models.TenderOfferElection import TenderOfferElection

instance = TenderOfferElection(
    tender_offer_currency="...",  # required — Currency of the cash offer
    tender_offer_price=0.0,  # required — Price per share of the cash offer
