...
|------|------|----------|-------------|
| **anchor_date** | **datetime** | Optional | The date on the which the instrument was opened. |
...
```python
from finbourne.sdk.services.lusid.models.OpenEvent import OpenEvent

instance = OpenEvent(
    anchor_date=datetime.now(),  # optional — The date on the which the instrument was opened.
