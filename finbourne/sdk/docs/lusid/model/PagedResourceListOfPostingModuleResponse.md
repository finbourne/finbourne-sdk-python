...
```python
from finbourne.sdk.services.lusid.models.PagedResourceListOfPostingModuleResponse import PagedResourceListOfPostingModuleResponse

instance = PagedResourceListOfPostingModuleResponse(
    next_page="...",  # optional
