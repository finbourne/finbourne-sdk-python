...
| **prevailing_compliance_rule** | [ComplianceRuleResponse](ComplianceRuleResponse.md) | Optional | *No description available.* |
| **deleted_compliance_rule** | [ComplianceRuleResponse](ComplianceRuleResponse.md) | Optional | *No description available.* |
| **previewed_status** | **str** | Optional | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. |
| **previewed_compliance_rule** | [ComplianceRuleResponse](ComplianceRuleResponse.md) | Optional | *No description available.* |
...
```python
from finbourne.sdk.services.lusid.models.ComplianceRuleEntity import ComplianceRuleEntity

instance = ComplianceRuleEntity(
    ...
    prevailing_compliance_rule=ComplianceRuleResponse(...),  # optional
    deleted_compliance_rule=ComplianceRuleResponse(...),  # optional
    previewed_status="...",  # optional — The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist.
    previewed_compliance_rule=ComplianceRuleResponse(...),  # optional
    links=[]  # optional
)
```
