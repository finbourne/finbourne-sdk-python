...
| **display_name** | **str** | Optional | The display name of the bucket, as configured on the fund configuration. |
...
instance = BucketSetResultBucket(
    ...
    display_name="..."  # optional — The display name of the bucket, as configured on the fund configuration.
)
```
