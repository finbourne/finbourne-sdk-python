...
| **lapse_elections** | [../model/List[LapseElection]](LapseElection.md) | Optional | Election for controlling whether the interest is paid automatically or not.  Exactly one election must be provided. |
