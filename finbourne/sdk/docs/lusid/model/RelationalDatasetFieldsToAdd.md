...
|------|------|----------|-------------|
| **series_identifiers** | [../model/List[CreateSeriesIdentifierField]](CreateSeriesIdentifierField.md) | Optional | The schema defining the structure and data types of the relational dataset. |
