...
| **traversal_direction** | **str** | Required | Direction of relationship between the requested entity and related entity. This can be &#39;In&#39; or &#39;Out&#39;. Read more about relationships traversal direction in LUSID Knowledge Base here https://support.lusid.com/docs/creating-relationships-between-certain-types-of-entity. |
...
instance = Relationship(
    ...
    traversal_direction="...",  # required — Direction of relationship between the requested entity and related entity. This can be &#39;In&#39; or &#39;Out&#39;. Read more about relationships traversal direction in LUSID Knowledge Base here https://support.lusid.com/docs/creating-relationships-between-certain-types-of-entity.
