...
|------|------|----------|-------------|
| **model_selection** | [../model/ModelSelection](ModelSelection.md) | Optional | *No description available.* |
...
| **return_zero_pv** | [../model/ReturnZeroPvOptions](ReturnZeroPvOptions.md) | Optional | *No description available.* |
