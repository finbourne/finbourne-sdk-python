...
| **option_exercise_elections** | [../model/List[OptionExerciseElection]](OptionExerciseElection.md) | Optional | Option exercise elections for this event. At least one entry. |
| **lapse_elections** | [../model/List[LapseElection]](LapseElection.md) | Optional | Lapse elections for this event. Required when participation is MandatoryWithChoices or when the  issuer publishes a no-action default. |
