...
|------|------|----------|-------------|
| **settlement_date** | **datetime** | Optional | Date that the cash payment settles. This is a required field. |
| **entitlement_date** | **datetime** | Optional | Date the recipient of the cash payment is entitled to receive the cash. This is a required field. |
| **currency** | **str** | Required | Currency of the payment. This is a required field. |
...
```python
from finbourne.sdk.services.lusid.models.FlexibleRepoCashFlowEvent import FlexibleRepoCashFlowEvent

instance = FlexibleRepoCashFlowEvent(
    settlement_date=datetime.now(),  # optional — Date that the cash payment settles. This is a required field.
    entitlement_date=datetime.now(),  # optional — Date the recipient of the cash payment is entitled to receive the cash. This is a required field.
