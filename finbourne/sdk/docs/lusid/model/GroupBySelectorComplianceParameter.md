...
```python
from finbourne.sdk.services.lusid.models.GroupBySelectorComplianceParameter import GroupBySelectorComplianceParameter

instance = GroupBySelectorComplianceParameter(
    value="...",  # required
