...
|------|------|----------|-------------|
| **value** | **str** | Required | The key that uniquely identifies a queryable address in Lusid. |
...
```python
from finbourne.sdk.services.lusid.models.AddressKeyComplianceParameter import AddressKeyComplianceParameter

instance = AddressKeyComplianceParameter(
