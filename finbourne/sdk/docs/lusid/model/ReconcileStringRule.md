...
|------|------|----------|-------------|
| **comparison_type** | **str** | Required | Available values: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf, IsOneOfCaseInsensitive. |
...
| **applies_to** | [../model/AggregateSpec](AggregateSpec.md) | Required | *No description available.* |
...
instance = ReconcileStringRule(
    comparison_type="...",  # required — Available values: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf, IsOneOfCaseInsensitive.
