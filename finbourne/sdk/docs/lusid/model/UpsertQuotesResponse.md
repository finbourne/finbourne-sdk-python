...
| **values** | [../model/Dict[str, Quote]](Quote.md) | Optional | The quotes which have been successfully updated or inserted. |
| **failed** | [../model/Dict[str, ErrorDetail]](ErrorDetail.md) | Optional | The quotes that could not be updated or inserted along with a reason for their failure. |
