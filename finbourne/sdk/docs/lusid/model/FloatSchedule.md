...
| **convention_name** | [../model/FlowConventionName](FlowConventionName.md) | Optional | *No description available.* |
...
| **index_convention_name** | [../model/FlowConventionName](FlowConventionName.md) | Optional | *No description available.* |
| **index_conventions** | [../model/IndexConvention](IndexConvention.md) | Optional | *No description available.* |
...
| **ex_dividend_configuration** | [../model/ExDividendConfiguration](ExDividendConfiguration.md) | Optional | *No description available.* |
| **compounding** | [../model/Compounding](Compounding.md) | Optional | *No description available.* |
| **reset_convention** | **str** | Optional | Control how resets are generated relative to payment convention(s).    Default value: InAdvance. Available values: InAdvance, InArrears. |
...
instance = FloatSchedule(
    ...
    reset_convention="...",  # optional — Control how resets are generated relative to payment convention(s).    Default value: InAdvance. Available values: InAdvance, InArrears.
