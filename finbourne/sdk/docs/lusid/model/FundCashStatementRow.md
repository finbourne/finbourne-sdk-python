...
| **cashflow_local** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **balance_local** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **cashflow_base** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **realised_fx_pnl** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **cost_basis_base** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
...
| **properties** | [../model/Dict[str, ModelProperty]](ModelProperty.md) | Optional | The requested properties decorated onto the cash statement row. |
