...
|------|------|----------|-------------|
| **limit** | **float** | Required | Limit of this contract.  Must be positive. |
| **var_date** | **datetime** | Optional | Initialisation date of the contract. |
...
```python
from finbourne.sdk.services.lusid.models.ContractInitialisationEvent import ContractInitialisationEvent

instance = ContractInitialisationEvent(
    limit=0.0,  # required — Limit of this contract.  Must be positive.
    var_date=datetime.now(),  # optional — Initialisation date of the contract.
