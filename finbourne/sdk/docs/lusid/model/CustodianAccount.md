...
|------|------|----------|-------------|
| **custodian_account_id** | [../model/ResourceId](ResourceId.md) | Required | *No description available.* |
...
| **custodian** | [../model/LegalEntity](LegalEntity.md) | Required | *No description available.* |
