...
| **rules** | [../model/List[TaxRule]](TaxRule.md) | Required | The rules of this rule set, which stipulate what rate to apply (i.e. write to the OutputPropertyKey) under certain conditions |
