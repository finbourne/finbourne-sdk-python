...
| **retain_elections** | [List[RetainElection]](RetainElection.md) | Optional | List of possible retain elections for this event (PROX) — keep the holding rather than redeem. |
...
instance = PutRedemptionEvent(
    ...
    retain_elections=[],  # optional — List of possible retain elections for this event (PROX) — keep the holding rather than redeem.
...
- [RetainElection](RetainElection.md) — used in `retain_elections`
