...
| **flow_conventions** | [../model/CdsFlowConventions](CdsFlowConventions.md) | Optional | *No description available.* |
...
| **protection_detail_specification** | [../model/CdsProtectionDetailSpecification](CdsProtectionDetailSpecification.md) | Optional | *No description available.* |
| **additional_payments** | [../model/List[AdditionalPayment]](AdditionalPayment.md) | Optional | Optional additional payments at a given date e.g. to level off an uneven swap.  The dates must be distinct and either all payments are Pay or all payments are Receive. |
