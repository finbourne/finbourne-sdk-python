...
|------|------|----------|-------------|
| **election_key** | **str** | Required | Unique key associated to this election (the PIK type) |
...
```python
from finbourne.sdk.services.lusid.models.PikElection import PikElection

instance = PikElection(
    election_key="...",  # required — Unique key associated to this election (the PIK type)
