...
|------|------|----------|-------------|
| **maturity_date** | **datetime** | Optional | Maturity date of the instrument |
...
```python
from finbourne.sdk.services.lusid.models.MaturityEvent import MaturityEvent

instance = MaturityEvent(
    maturity_date=datetime.now(),  # optional — Maturity date of the instrument
