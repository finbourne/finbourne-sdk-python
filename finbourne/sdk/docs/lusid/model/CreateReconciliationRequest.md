...
|------|------|----------|-------------|
| **code** | **str** | Required | The unique identifier associated with the reconciliation |
...
```python
from finbourne.sdk.services.lusid.models.CreateReconciliationRequest import CreateReconciliationRequest

instance = CreateReconciliationRequest(
