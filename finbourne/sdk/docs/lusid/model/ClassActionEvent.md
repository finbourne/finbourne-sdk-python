...
| **cash_offer_elections** | [../model/List[CashOfferElection]](CashOfferElection.md) | Optional | Cash offer elections for this event. Exactly one entry carrying the per-share  settlement amount as CashOfferPrice and settlement currency as CashOfferCurrency. |
| **lapse_elections** | [../model/List[LapseElection]](LapseElection.md) | Optional | Lapse elections for this event. Exactly one entry (NOAC) with IsDefault &#x3D; true. |
