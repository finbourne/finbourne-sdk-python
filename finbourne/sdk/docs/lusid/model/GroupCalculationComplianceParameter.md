...
```python
from finbourne.sdk.services.lusid.models.GroupCalculationComplianceParameter import GroupCalculationComplianceParameter

instance = GroupCalculationComplianceParameter(
    value="...",  # required
