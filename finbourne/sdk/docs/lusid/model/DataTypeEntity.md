...
| **prevailing_data_type** | [DataType](DataType.md) | Optional | *No description available.* |
| **deleted_data_type** | [DataType](DataType.md) | Optional | *No description available.* |
| **previewed_status** | **str** | Optional | The status of the previewed entity. |
| **previewed_data_type** | [DataType](DataType.md) | Optional | *No description available.* |
