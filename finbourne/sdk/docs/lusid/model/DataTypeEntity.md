...
| **prevailing_data_type** | [../model/DataType](DataType.md) | Optional | *No description available.* |
| **deleted_data_type** | [../model/DataType](DataType.md) | Optional | *No description available.* |
| **previewed_status** | **str** | Optional | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. |
| **previewed_data_type** | [../model/DataType](DataType.md) | Optional | *No description available.* |
...
```python
from finbourne.sdk.services.lusid.models.DataTypeEntity import DataTypeEntity

instance = DataTypeEntity(
    ...
    prevailing_data_type=DataType(...),  # optional
    deleted_data_type=DataType(...),  # optional
    previewed_status="...",  # optional — The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist.
    previewed_data_type=DataType(...),  # optional
    links=[]  # optional
)
```
