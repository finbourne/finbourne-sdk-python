...
| **failed** | [../model/Dict[str, ErrorDetail]](ErrorDetail.md) | Optional | Information about where instruments have failed to return cashflows in so far as it is available.  e.g., failure to retrieve a market quote for a floating rate instrument. |
