...
| **rollover_constituents** | [../model/List[RolloverConstituent]](RolloverConstituent.md) | Required | Source and target contracts of the rollover. That is, a set of contracts and their respective changes to balance  Expect at least one contract to as the source of the rollover and at least one target contract. |
