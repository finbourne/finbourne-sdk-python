...
| **cash_and_security_offer_elections** | [List[CashAndSecurityOfferElection]](CashAndSecurityOfferElection.md) | Optional | List of possible CashAndSecurityOfferElections for this exchange offer event. |
| **consent_and_exchange_elections** | [List[ConsentAndExchangeElection]](ConsentAndExchangeElection.md) | Optional | List of possible consent-and-exchange elections for this event (CTEN-style consent paired with the exchange). |
...
instance = ExchangeOfferEvent(
    ...
    cash_and_security_offer_elections=[],  # optional — List of possible CashAndSecurityOfferElections for this exchange offer event.
    consent_and_exchange_elections=[],  # optional — List of possible consent-and-exchange elections for this event (CTEN-style consent paired with the exchange).
...
- [ConsentAndExchangeElection](ConsentAndExchangeElection.md) — used in `consent_and_exchange_elections`
