...
| **rounding_target** | **str** | Optional | The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows. |
| **rounding_type** | **str** | Optional | The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest. |
...
instance = RoundingConvention(
    ...
    rounding_target="...",  # optional — The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows.
    rounding_type="..."  # optional — The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest.
)
```
