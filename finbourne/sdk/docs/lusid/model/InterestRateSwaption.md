...
| **dom_ccy** | **str** | Optional | The currency the option settles in.                If not specified, the currency of the underlying swap is used. When specified it must be one of  the currencies of the underlying swap. |
| **exercise_date** | **datetime** | Optional | The date the option expires, and for European exercise the date it is exercised.                If not specified, the start date of the underlying swap is used. |
...
instance = InterestRateSwaption(
    ...
    dom_ccy="...",  # optional — The currency the option settles in.                If not specified, the currency of the underlying swap is used. When specified it must be one of  the currencies of the underlying swap.
    exercise_date=datetime.now(),  # optional — The date the option expires, and for European exercise the date it is exercised.                If not specified, the start date of the underlying swap is used.
