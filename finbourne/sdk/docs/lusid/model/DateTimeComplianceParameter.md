...
|------|------|----------|-------------|
| **value** | **datetime** | Required | *No description available.* |
...
```python
from finbourne.sdk.services.lusid.models.DateTimeComplianceParameter import DateTimeComplianceParameter

instance = DateTimeComplianceParameter(
    value=datetime.now(),  # required
