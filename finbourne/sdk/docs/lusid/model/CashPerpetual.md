...
| **principal** | **float** | Required | The face-value or principal for the cash at outset. |
...
```python
from finbourne.sdk.services.lusid.models.CashPerpetual import CashPerpetual

instance = CashPerpetual(
    ...
    principal=0.0,  # required — The face-value or principal for the cash at outset.
