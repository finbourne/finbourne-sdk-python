...
|------|------|----------|-------------|
| **cash_flow_per_unit** | **float** | Optional | The cashflow per unit |
...
```python
from finbourne.sdk.services.lusid.models.OptionExerciseCashEvent import OptionExerciseCashEvent

instance = OptionExerciseCashEvent(
    cash_flow_per_unit=0.0,  # optional — The cashflow per unit
    ...
    exercise_type="...",  # required — The optionality type of the underlying option. Available values: None, European, Bermudan, American.
    ...
    option_type="...",  # required — Type of optionality that is present. Available values: None, Call, Put.
    start_date=datetime.now(),  # optional — The start date of the option.
