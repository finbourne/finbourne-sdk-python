...
|------|------|----------|-------------|
| **status** | **str** | Required | The Status of the Nav Type. Available values: Active, Inactive. |
...
| **settlement_configuration** | [NavSettlementConfiguration](NavSettlementConfiguration.md) | Required | *No description available.* |
...
instance = NavType(
    ...
    settlement_configuration=NavSettlementConfiguration(...),  # required
    ...
    amortisation_method="...",  # required — The amortisation method used by the portfolio for the calculation. Available values: NoAmortisation, StraightLine, EffectiveYield, StraightLineSettlementDate, EffectiveYieldSettlementDate.
