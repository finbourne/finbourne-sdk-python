...
|------|------|----------|-------------|
| **class_dealing** | [../model/Dict[str, ShareClassAmount]](ShareClassAmount.md) | Required | Bucket of detail for any &#39;Dealing&#39; specific to the share class that has occurred inside the queried period. |
| **class_dealing_units** | [../model/Dict[str, Amount]](Amount.md) | Required | Bucket of detail for any &#39;Dealing&#39; units specific to the share class that has occurred inside the queried period. |
