...
| **values** | [../model/Dict[str, CancelledPlacementResult]](CancelledPlacementResult.md) | Optional | The placements which have been successfully cancelled. |
| **failed** | [../model/Dict[str, ErrorDetail]](ErrorDetail.md) | Optional | The placements that could not be cancelled, along with a reason for their failure. |
