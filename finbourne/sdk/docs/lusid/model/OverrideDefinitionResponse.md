...
| **precedes_event** | **bool** | Optional | True when this replacement&#39;s trade date is earlier than the target instrument event&#39;s current effective date, which orphans the entry it belongs to. |
...
```python
from finbourne.sdk.services.lusid.models.OverrideDefinitionResponse import OverrideDefinitionResponse

instance = OverrideDefinitionResponse(
    ...
    precedes_event=True  # optional — True when this replacement&#39;s trade date is earlier than the target instrument event&#39;s current effective date, which orphans the entry it belongs to.
)
```
