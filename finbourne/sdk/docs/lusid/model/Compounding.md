...
| **compounding_method** | **str** | Required | If the interest rate is simple, compounded or using a pre-computed compounded index.    Supported string (enumeration) values are: [Averaging, Compounding, CompoundedIndex, NonCumulativeCompounding, NonCumulativeCompoundingBalanceAware]. |
| **reset_frequency** | **str** | Required | The interest payment frequency.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid) |
...
instance = Compounding(
    ...
    compounding_method="...",  # required — If the interest rate is simple, compounded or using a pre-computed compounded index.    Supported string (enumeration) values are: [Averaging, Compounding, CompoundedIndex, NonCumulativeCompounding, NonCumulativeCompoundingBalanceAware].
    reset_frequency="...",  # required — The interest payment frequency.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid)
