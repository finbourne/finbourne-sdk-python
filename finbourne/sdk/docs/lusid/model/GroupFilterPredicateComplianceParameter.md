...
```python
from finbourne.sdk.services.lusid.models.GroupFilterPredicateComplianceParameter import GroupFilterPredicateComplianceParameter

instance = GroupFilterPredicateComplianceParameter(
    value="...",  # required
