...
|------|------|----------|-------------|
| **value** | [../model/ResourceId](ResourceId.md) | Required | *No description available.* |
...
```python
from finbourne.sdk.services.lusid.models.PortfolioGroupIdListComplianceParameter import PortfolioGroupIdListComplianceParameter

instance = PortfolioGroupIdListComplianceParameter(
    value=ResourceId(...),  # required
