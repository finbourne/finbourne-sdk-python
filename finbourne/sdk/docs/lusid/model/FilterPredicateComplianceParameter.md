...
```python
from finbourne.sdk.services.lusid.models.FilterPredicateComplianceParameter import FilterPredicateComplianceParameter

instance = FilterPredicateComplianceParameter(
    value="...",  # required
