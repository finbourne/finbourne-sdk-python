...
```python
from finbourne.sdk.services.lusid.models.BlockAndOrderIdRequest import BlockAndOrderIdRequest

instance = BlockAndOrderIdRequest(
    destination_block_id=ResourceId(...),  # required
