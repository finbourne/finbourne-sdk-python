...
| **properties** | [../model/Dict[str, ModelProperty]](ModelProperty.md) | Optional | The properties which have been requested to be decorated onto the holding. These will be from the &#39;Instrument&#39; or &#39;Holding&#39; domain. |
...
| **cost** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Required | *No description available.* |
| **cost_portfolio_ccy** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Required | *No description available.* |
| **transaction** | [../model/Transaction](Transaction.md) | Optional | *No description available.* |
...
| **notional_cost** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **amortised_cost** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **amortised_cost_portfolio_ccy** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **variation_margin** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **variation_margin_portfolio_ccy** | [../model/CurrencyAndAmount](CurrencyAndAmount.md) | Optional | *No description available.* |
| **settlement_schedule** | [../model/List[SettlementSchedule]](SettlementSchedule.md) | Optional | Where no. of days ahead has been specified, future dated settlements will be captured here. |
...
| **resolved_custodian_account** | [../model/ResolvedCustodianAccount](ResolvedCustodianAccount.md) | Optional | *No description available.* |
