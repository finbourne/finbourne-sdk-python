...
| **errors** | **Dict[str, List[str]]** | Optional | *No description available.* |
...
```python
from finbourne.sdk.services.notifications.models.LusidValidationProblemDetails import LusidValidationProblemDetails

instance = LusidValidationProblemDetails(
    name="...",  # required
