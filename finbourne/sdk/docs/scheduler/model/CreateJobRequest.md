...
| **date_created** | **datetime** | Optional | Date when job was created. Defaults to now. |
...
```python
from finbourne.sdk.services.scheduler.models.CreateJobRequest import CreateJobRequest

instance = CreateJobRequest(
    job_id=ResourceId(...),  # required
    name="...",  # required — Name of the job
    author="...",  # optional — Author of the job
    date_created=datetime.now(),  # optional — Date when job was created. Defaults to now.
