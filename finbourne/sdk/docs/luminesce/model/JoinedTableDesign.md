...
| **join_type** | [../model/DesignJoinType](DesignJoinType.md) | Required | *No description available.* |
| **on_clause_terms** | [../model/List[OnClauseTermDesign]](OnClauseTermDesign.md) | Required | Filter clauses to apply to this join in the on clause |
| **right_table_available_fields** | [../model/List[AvailableField]](AvailableField.md) | Optional | Fields that are known to be available for design when parsing SQL, of the right hand table |
