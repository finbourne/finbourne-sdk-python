...
| **operation** | **str** | Required | The API operation invoked by the request. |
| **session_id** | **str** | Optional | The identifier of the session that the request was made in. |
| **verb** | **str** | Optional | The HTTP verb of the request. |
| **url** | **str** | Optional | The URL of the request. |
| **domain** | **str** | Optional | The domain of the request. |
| **user** | **str** | Optional | The user who made the request. |
| **user_type** | **str** | Optional | The type of the user who made the request. |
| **outcome** | **str** | Optional | The outcome of the request: Completed, Errored or Failed. |
| **duration** | **float** | Optional | The duration of the request in milliseconds. |
| **http_status_code** | **int** | Optional | The status code of the request. |
...
```python
from finbourne.sdk.services.insights.models.QueriedRequestLog import QueriedRequestLog

instance = QueriedRequestLog(
    ...
    duration=0.0,  # optional — The duration of the request in milliseconds.
    http_status_code=0,  # optional — The status code of the request.
