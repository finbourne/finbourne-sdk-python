...
| **values** | [../model/List[RequestLog]](RequestLog.md) | Required | *No description available.* |
...
```python
from finbourne.sdk.services.insights.models.ResourceListWithHistogramOfRequestLog import ResourceListWithHistogramOfRequestLog

instance = ResourceListWithHistogramOfRequestLog(
