...
| **task_activity** | [../model/TaskActivityResponse](TaskActivityResponse.md) | Required | *No description available.* |
...
```python
from finbourne.sdk.services.workflow.models.EventHandler import EventHandler
...
instance = EventHandler(
    ...
    task_activity=TaskActivityResponse(...)  # required
)
```
