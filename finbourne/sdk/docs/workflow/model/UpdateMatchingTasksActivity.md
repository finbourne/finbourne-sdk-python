...
| **trigger** | **str** | Required | Trigger to supply to all tasks that have been matched |
...
```python
from finbourne.sdk.services.workflow.models.UpdateMatchingTasksActivity import UpdateMatchingTasksActivity

instance = UpdateMatchingTasksActivity(
