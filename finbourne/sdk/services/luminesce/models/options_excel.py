...
class OptionsExcel(BaseModel):
    ...
    password:  Optional[StrictStr] = Field(default=None,alias="password", description="If specified will be used as the password used for password protected workbooks") 
    worksheet:  Optional[StrictStr] = Field(default=None,alias="worksheet", description="The worksheet containing the cell range to import (name or index, will default to first)") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.range_or_table is None and "range_or_table" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> OptionsExcel:
        ...
        if not isinstance(obj, dict):
            return OptionsExcel.model_validate(obj)

        _obj = OptionsExcel.model_validate({
