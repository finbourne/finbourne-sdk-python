...
class JoinedTableDesign(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.right_table_available_fields is None and "right_table_available_fields" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> JoinedTableDesign:
        ...
        if not isinstance(obj, dict):
            return JoinedTableDesign.model_validate(obj)

        _obj = JoinedTableDesign.model_validate({
...
JoinedTableDesign.model_rebuild()
