...
class OptionsParquet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["columnNamesWanted"]
    ...
    def from_dict(cls, obj: dict) -> OptionsParquet:
        ...
        if not isinstance(obj, dict):
            return OptionsParquet.model_validate(obj)

        _obj = OptionsParquet.model_validate({
            "column_names_wanted": obj.get("columnNamesWanted")
        })
        return _obj

OptionsParquet.model_rebuild()
