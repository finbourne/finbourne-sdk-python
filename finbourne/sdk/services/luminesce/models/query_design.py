...
class QueryDesign(BaseModel):
    ...
    alias:  Optional[StrictStr] = Field(default=None,alias="alias", description="Alias for the table in the generated SQL, if any") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.joined_tables is None and "joined_tables" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> QueryDesign:
        ...
        if not isinstance(obj, dict):
            return QueryDesign.model_validate(obj)
