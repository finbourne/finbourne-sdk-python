...
class FieldDesign(BaseModel):
    ...
    table_alias:  Optional[StrictStr] = Field(default=None,alias="tableAlias", description="Alias of the Table the field belongs to") 
    alias:  Optional[StrictStr] = Field(default=None,alias="alias", description="Alias if any (if none the Name is used)") 
    ...
    def from_dict(cls, obj: dict) -> FieldDesign:
        ...
        if not isinstance(obj, dict):
            return FieldDesign.model_validate(obj)

        _obj = FieldDesign.model_validate({
            "name": obj.get("name"),
