...
class InlinedPropertyDesign(BaseModel):
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.provider_name_extension is None and "provider_name_extension" in self.model_fields_set:
            _dict['providerNameExtension'] = None

        # set to None if inlined_property_items (nullable) is None
        # and model_fields_set contains the field
        if self.inlined_property_items is None and "inlined_property_items" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InlinedPropertyDesign:
        ...
        if not isinstance(obj, dict):
            return InlinedPropertyDesign.model_validate(obj)
...
InlinedPropertyDesign.model_rebuild()
