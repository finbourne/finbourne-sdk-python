...
class FileReaderBuilderDef(BaseModel):
    ...
    variable_name:  Optional[StrictStr] = Field(default=None,alias="variableName", description="The name of the variable for the `use` statement") 
    file_path:  Optional[StrictStr] = Field(default=None,alias="filePath", description="The file (or folder) path") 
    folder_filter:  Optional[StrictStr] = Field(default=None,alias="folderFilter", description="The filter to apply to a folder (all matching files then being read) a RegExp") 
    zip_filter:  Optional[StrictStr] = Field(default=None,alias="zipFilter", description="The filter to apply to folder structures with zip archives (all matching files then being read) a RegExp") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.folder_filter is None and "folder_filter" in self.model_fields_set:
            _dict['folderFilter'] = None

        # set to None if zip_filter (nullable) is None
        # and model_fields_set contains the field
        if self.zip_filter is None and "zip_filter" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FileReaderBuilderDef:
        ...
        if not isinstance(obj, dict):
            return FileReaderBuilderDef.model_validate(obj)
...
FileReaderBuilderDef.model_rebuild()
