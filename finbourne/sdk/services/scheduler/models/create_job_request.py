...
class CreateJobRequest(BaseModel):
    ...
    min_memory:  Optional[StrictStr] = Field(default=None,alias="minMemory", description="Specifies the minimum amount of memory  to be allocated for the job") 
    max_memory:  Optional[StrictStr] = Field(default=None,alias="maxMemory", description="Specifies the maximum amount of memory to be allocated for the job") 
    ...
    __properties: ClassVar[List[str]] = ["jobId", "name", "author", "dateCreated", "description", "imageName", "imageTag", "ttl", "minCpu", "maxCpu", "minMemory", "maxMemory", "argumentDefinitions", "commandLineArgumentSeparator", "requiredResources"]
    ...
    def from_dict(cls, obj: dict) -> CreateJobRequest:
        ...
        if not isinstance(obj, dict):
            return CreateJobRequest.model_validate(obj)

        _obj = CreateJobRequest.model_validate({
