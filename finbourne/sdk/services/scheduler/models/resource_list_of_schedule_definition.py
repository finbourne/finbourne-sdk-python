...
class ResourceListOfScheduleDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfScheduleDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfScheduleDefinition.model_validate(obj)

        _obj = ResourceListOfScheduleDefinition.model_validate({
            "values": [ScheduleDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfScheduleDefinition.model_rebuild()
