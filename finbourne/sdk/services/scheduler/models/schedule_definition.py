...
class ScheduleDefinition(BaseModel):
    ...
    name:  Optional[StrictStr] = Field(default=None,alias="name", description="A display name for this Schedule") 
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="A description of the Schedule") 
    author:  Optional[StrictStr] = Field(default=None,alias="author", description="Name of the author of this schedule") 
    owner:  Optional[StrictStr] = Field(default=None,alias="owner", description="Name of owner of this schedule") 
    use_as_auth:  Optional[StrictStr] = Field(default=None,alias="useAsAuth", description="User to runs schedule when automatically run and authenticates  requests in the schedule") 
...
ScheduleDefinition.model_rebuild()
