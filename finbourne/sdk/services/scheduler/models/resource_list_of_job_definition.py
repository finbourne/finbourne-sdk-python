...
class ResourceListOfJobDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfJobDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfJobDefinition.model_validate(obj)

        _obj = ResourceListOfJobDefinition.model_validate({
            "values": [JobDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfJobDefinition.model_rebuild()
