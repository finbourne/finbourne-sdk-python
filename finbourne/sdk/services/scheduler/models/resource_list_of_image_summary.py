...
class ResourceListOfImageSummary(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfImageSummary:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfImageSummary.model_validate(obj)

        _obj = ResourceListOfImageSummary.model_validate({
            "values": [ImageSummary.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfImageSummary.model_rebuild()
