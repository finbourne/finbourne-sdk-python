...
class ResourceListOfRepository(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfRepository:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfRepository.model_validate(obj)

        _obj = ResourceListOfRepository.model_validate({
            "values": [Repository.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfRepository.model_rebuild()
