...
class CreateScheduleRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateScheduleRequest:
        ...
        if not isinstance(obj, dict):
            return CreateScheduleRequest.model_validate(obj)

        _obj = CreateScheduleRequest.model_validate({
