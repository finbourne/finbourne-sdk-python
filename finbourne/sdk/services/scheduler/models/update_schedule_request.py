...
class UpdateScheduleRequest(BaseModel):
    ...
    author:  Optional[StrictStr] = Field(default=None,alias="author", description="The updated author of the schedule") 
    owner:  Optional[StrictStr] = Field(default=None,alias="owner", description="The update owner of the schedule") 
    ...
    __properties: ClassVar[List[str]] = ["jobId", "name", "description", "author", "owner", "arguments", "trigger", "notifications", "enabled", "useAsAuth"]
    ...
    def from_dict(cls, obj: dict) -> UpdateScheduleRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateScheduleRequest.model_validate(obj)

        _obj = UpdateScheduleRequest.model_validate({
