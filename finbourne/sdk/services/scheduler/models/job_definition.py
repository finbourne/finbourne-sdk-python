...
class JobDefinition(BaseModel):
    ...
    author:  Optional[StrictStr] = Field(default=None,alias="author", description="Author of the job") 
    date_created: Optional[datetime] = Field(default=None, description="Date when job was created", alias="dateCreated")
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="Description of this job") 
    docker_image:  Optional[StrictStr] = Field(default=None,alias="dockerImage", description="Information about the docker image in the format “image_source/image_name:image_tag”") 
    ttl: Optional[StrictInt] = Field(default=None, description="Time To Live of the job run in seconds Defaults to 5 minutes(300)")
    min_cpu:  Optional[StrictStr] = Field(default=None,alias="minCpu", description="Specifies  minimum number of CPUs to be allocated for the job Default to 2") 
    max_cpu:  Optional[StrictStr] = Field(default=None,alias="maxCpu", description="Specifies  maximum number of CPUs to be allocated for the job") 
    min_memory:  Optional[StrictStr] = Field(default=None,alias="minMemory", description="Specifies the minimum amount of memory (in GiB) to be allocated for the job") 
    max_memory:  Optional[StrictStr] = Field(default=None,alias="maxMemory", description="Specifies the maximum amount of memory (in GiB) to be allocated for the job") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.min_cpu is None and "min_cpu" in self.model_fields_set:
            _dict['minCpu'] = None
        ...
        # and model_fields_set contains the field
        if self.argument_definitions is None and "argument_definitions" in self.model_fields_set:
            _dict['argumentDefinitions'] = None

        # set to None if command_line_argument_separator (nullable) is None
        # and model_fields_set contains the field
        if self.command_line_argument_separator is None and "command_line_argument_separator" in self.model_fields_set:
