...
class ImageSummary(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.scan_summary:
            _dict['scanSummary'] = self.scan_summary.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of link
        if self.link:
            _dict['link'] = self.link.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.scan_status is None and "scan_status" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> ImageSummary:
        ...
        if not isinstance(obj, dict):
            return ImageSummary.model_validate(obj)

        _obj = ImageSummary.model_validate({
            "name": obj.get("name"),
