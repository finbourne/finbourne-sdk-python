...
class ResourceListOfJobHistory(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfJobHistory:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfJobHistory.model_validate(obj)

        _obj = ResourceListOfJobHistory.model_validate({
            "values": [JobHistory.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfJobHistory.model_rebuild()
