...
class RequestLog(BaseModel):
    ...
    operation:  Optional[StrictStr] = Field(default=None,alias="operation", description="The API operation invoked by the request.") 
    ...
    def from_dict(cls, obj: dict) -> RequestLog:
        ...
        if not isinstance(obj, dict):
            return RequestLog.model_validate(obj)

        _obj = RequestLog.model_validate({
