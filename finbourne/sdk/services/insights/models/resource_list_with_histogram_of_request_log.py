...
class ResourceListWithHistogramOfRequestLog(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListWithHistogramOfRequestLog:
        ...
        if not isinstance(obj, dict):
            return ResourceListWithHistogramOfRequestLog.model_validate(obj)

        _obj = ResourceListWithHistogramOfRequestLog.model_validate({
            "histogram": Histogram.from_dict(_v) if (_v := obj.get("histogram")) is not None else None,
            "values": [RequestLog.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListWithHistogramOfRequestLog.model_rebuild()
