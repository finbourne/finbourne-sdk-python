...
class ResourceListWithHistogramOfAccessEvaluationLog(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListWithHistogramOfAccessEvaluationLog:
        ...
        if not isinstance(obj, dict):
            return ResourceListWithHistogramOfAccessEvaluationLog.model_validate(obj)

        _obj = ResourceListWithHistogramOfAccessEvaluationLog.model_validate({
            "histogram": Histogram.from_dict(_v) if (_v := obj.get("histogram")) is not None else None,
            "values": [AccessEvaluationLog.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListWithHistogramOfAccessEvaluationLog.model_rebuild()
