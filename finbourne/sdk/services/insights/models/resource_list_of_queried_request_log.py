...
class ResourceListOfQueriedRequestLog(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfQueriedRequestLog:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfQueriedRequestLog.model_validate(obj)

        _obj = ResourceListOfQueriedRequestLog.model_validate({
            "values": [QueriedRequestLog.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfQueriedRequestLog.model_rebuild()
