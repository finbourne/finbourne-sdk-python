...
class ResourceListOfQueryableLogType(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfQueryableLogType:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfQueryableLogType.model_validate(obj)

        _obj = ResourceListOfQueryableLogType.model_validate({
            "values": [QueryableLogType.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfQueryableLogType.model_rebuild()
