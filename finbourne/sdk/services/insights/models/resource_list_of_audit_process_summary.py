...
class ResourceListOfAuditProcessSummary(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfAuditProcessSummary:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfAuditProcessSummary.model_validate(obj)

        _obj = ResourceListOfAuditProcessSummary.model_validate({
            "values": [AuditProcessSummary.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfAuditProcessSummary.model_rebuild()
