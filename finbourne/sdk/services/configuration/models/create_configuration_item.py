...
class CreateConfigurationItem(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateConfigurationItem:
        ...
        if not isinstance(obj, dict):
            return CreateConfigurationItem.model_validate(obj)

        _obj = CreateConfigurationItem.model_validate({
            "key": obj.get("key"),
            "value": obj.get("value"),
...
CreateConfigurationItem.model_rebuild()
