...
class ResourceListOfConfigurationSetSummary(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfConfigurationSetSummary:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfConfigurationSetSummary.model_validate(obj)

        _obj = ResourceListOfConfigurationSetSummary.model_validate({
            "values": [ConfigurationSetSummary.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfConfigurationSetSummary.model_rebuild()
