...
class ResourceListOfConfigurationItem(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfConfigurationItem:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfConfigurationItem.model_validate(obj)

        _obj = ResourceListOfConfigurationItem.model_validate({
            "values": [ConfigurationItem.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfConfigurationItem.model_rebuild()
