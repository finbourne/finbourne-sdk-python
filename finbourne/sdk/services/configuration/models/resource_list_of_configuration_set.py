...
class ResourceListOfConfigurationSet(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfConfigurationSet:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfConfigurationSet.model_validate(obj)

        _obj = ResourceListOfConfigurationSet.model_validate({
            "values": [ConfigurationSet.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfConfigurationSet.model_rebuild()
