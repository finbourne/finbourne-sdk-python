...
class ConfigurationItem(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="Describes the configuration item") 
    ...
    __properties: ClassVar[List[str]] = ["createdAt", "createdBy", "lastModifiedAt", "lastModifiedBy", "description", "key", "value", "valueType", "isSecret", "ref", "blockReveal", "links"]
    ...
    def from_dict(cls, obj: dict) -> ConfigurationItem:
        ...
        if not isinstance(obj, dict):
            return ConfigurationItem.model_validate(obj)

        _obj = ConfigurationItem.model_validate({
