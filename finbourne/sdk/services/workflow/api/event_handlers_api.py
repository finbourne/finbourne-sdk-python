...
class EventHandlersApi:
    ...
    @validate_call
    def create_event_handler(self, create_event_handler_request: CreateEventHandlerRequest, **kwargs) -> EventHandler:
    ...
    def create_event_handler_with_http_info(self, create_event_handler_request: CreateEventHandlerRequest, **kwargs) -> ApiResponse[EventHandler]:
        ...
        return self.sync_api_client.call_api(
            '/workflow/api/eventhandlers', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_event_handler(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
    ...
    def delete_event_handler_with_http_info(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        return self.sync_api_client.call_api(
            '/workflow/api/eventhandlers/{scope}/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_event_handler(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> EventHandler:
    ...
    def get_event_handler_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> ApiResponse[EventHandler]:
        ...
        return self.sync_api_client.call_api(
            '/workflow/api/eventhandlers/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_event_handlers(self, as_at: Optional[datetime] = None, filter: Optional[StrictStr] = None, limit: Optional[int] = None, page: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfEventHandler:
    ...
    def list_event_handlers_with_http_info(self, as_at: Optional[datetime] = None, filter: Optional[StrictStr] = None, limit: Optional[int] = None, page: Optional[StrictStr] = None, **kwargs) -> ApiResponse[PagedResourceListOfEventHandler]:
        ...
        return self.sync_api_client.call_api(
            '/workflow/api/eventhandlers', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def update_event_handler(self, scope: StrictStr, code: StrictStr, update_event_handler_request: UpdateEventHandlerRequest, **kwargs) -> EventHandler:
    ...
    def update_event_handler_with_http_info(self, scope: StrictStr, code: StrictStr, update_event_handler_request: UpdateEventHandlerRequest, **kwargs) -> ApiResponse[EventHandler]:
        ...
        return self.sync_api_client.call_api(
            '/workflow/api/eventhandlers/{scope}/{code}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def create_event_handler_async(self, create_event_handler_request: CreateEventHandlerRequest, **kwargs) -> EventHandler:
            """CreateEventHandler: Create a new Event Handler  # noqa: E501
    ...
    @validate_call
    async def delete_event_handler_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            """DeleteEventHandler: Delete an Event Handler  # noqa: E501
            If the Event Handler does not exist a failure will be returned  # noqa: E501
    ...
    @validate_call
    async def get_event_handler_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> EventHandler:
            """GetEventHandler: Get an Event Handler  # noqa: E501
            Will return a NotFound failure if the event handler does not exist  # noqa: E501
    ...
    @validate_call
    async def list_event_handlers_async(self, as_at: Optional[datetime] = None, filter: Optional[StrictStr] = None, limit: Optional[int] = None, page: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfEventHandler:
            """ListEventHandlers: List Event Handlers  # noqa: E501
    ...
    @validate_call
    async def update_event_handler_async(self, scope: StrictStr, code: StrictStr, update_event_handler_request: UpdateEventHandlerRequest, **kwargs) -> EventHandler:
            """UpdateEventHandler: Update an existing Event handler  # noqa: E501
