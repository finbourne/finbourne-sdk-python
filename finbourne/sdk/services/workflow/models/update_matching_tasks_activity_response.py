...
class UpdateMatchingTasksActivityResponse(BaseModel):
    ...
    """
    type:  Optional[StrictStr] = Field(default=None,alias="type", description="The type of task activity") 
    filter:  Optional[StrictStr] = Field(default=None,alias="filter", description="The filter that matches on existing tasks") 
    trigger:  Optional[StrictStr] = Field(default=None,alias="trigger", description="Trigger to supply to all tasks that have been matched") 
    ...
    __properties: ClassVar[List[str]] = ["type", "filter", "trigger", "correlationIds", "taskFields", "scheduleDependentTaskFields"]
    ...
    def from_dict(cls, obj: dict) -> UpdateMatchingTasksActivityResponse:
        ...
        if not isinstance(obj, dict):
            return UpdateMatchingTasksActivityResponse.model_validate(obj)

        _obj = UpdateMatchingTasksActivityResponse.model_validate({
            "type": obj.get("type"),
...
UpdateMatchingTasksActivityResponse.model_rebuild()
