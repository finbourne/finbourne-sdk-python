...
class GroupReconciliationResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationResponse:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationResponse.model_validate(obj)

        _obj = GroupReconciliationResponse.model_validate({
            "type": obj.get("type")
        })
        return _obj

GroupReconciliationResponse.model_rebuild()
