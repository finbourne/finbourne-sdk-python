...
class TriggerParentTaskActionResponse(BaseModel):
    ...
    trigger:  Optional[StrictStr] = Field(default=None,alias="trigger", description="Trigger on parent task to be invoked") 
    ...
    def from_dict(cls, obj: dict) -> TriggerParentTaskActionResponse:
        ...
        if not isinstance(obj, dict):
            return TriggerParentTaskActionResponse.model_validate(obj)

        _obj = TriggerParentTaskActionResponse.model_validate({
            "type": obj.get("type"),
            "trigger": obj.get("trigger")
        })
        return _obj

TriggerParentTaskActionResponse.model_rebuild()
