...
class RunWorkerResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["runId", "statusDetail"]
    ...
    def from_dict(cls, obj: dict) -> RunWorkerResponse:
        ...
        if not isinstance(obj, dict):
            return RunWorkerResponse.model_validate(obj)

        _obj = RunWorkerResponse.model_validate({
            "run_id": obj.get("runId"),
            "status_detail": obj.get("statusDetail")
        })
        return _obj

RunWorkerResponse.model_rebuild()
