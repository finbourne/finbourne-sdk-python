...
class SpecificMonthRegularity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["frequency", "daysOfMonth", "type"]
    ...
    def from_dict(cls, obj: dict) -> SpecificMonthRegularity:
        ...
        if not isinstance(obj, dict):
            return SpecificMonthRegularity.model_validate(obj)

        _obj = SpecificMonthRegularity.model_validate({
...
SpecificMonthRegularity.model_rebuild()
