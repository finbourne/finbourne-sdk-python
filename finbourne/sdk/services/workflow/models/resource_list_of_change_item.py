...
class ResourceListOfChangeItem(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfChangeItem:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfChangeItem.model_validate(obj)

        _obj = ResourceListOfChangeItem.model_validate({
            "values": [ChangeItem.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfChangeItem.model_rebuild()
