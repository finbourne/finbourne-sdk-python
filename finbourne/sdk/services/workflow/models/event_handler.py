...
class EventHandler(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "version", "displayName", "description", "status", "eventMatchingPattern", "scheduleMatchingPattern", "runAsUserId", "taskDefinitionId", "taskDefinitionAsAt", "taskActivity"]
    ...
    def from_dict(cls, obj: dict) -> EventHandler:
        ...
        _obj = EventHandler.model_validate({
            ...
            "task_activity": TaskActivityResponse.from_dict(_v) if (_v := obj.get("taskActivity")) is not None else None
        })
        return _obj
