...
class RunWorkerActionResponse(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.worker_id:
            _dict['workerId'] = self.worker_id.to_dict(by_alias=by_alias)
        ...
        if self.worker_parameters:
            for _key in self.worker_parameters:
                if self.worker_parameters[_key]:
                    _field_dict[_key] = self.worker_parameters[_key].to_dict(by_alias=by_alias)
        ...
        if self.worker_status_triggers:
            _dict['workerStatusTriggers'] = self.worker_status_triggers.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> RunWorkerActionResponse:
        ...
        if not isinstance(obj, dict):
            return RunWorkerActionResponse.model_validate(obj)

        _obj = RunWorkerActionResponse.model_validate({
            "type": obj.get("type"),
...
RunWorkerActionResponse.model_rebuild()
