...
class HealthCheckResponse(BaseModel):
    ...
    url:  Optional[StrictStr] = Field(default=None,alias="url", description="The URL to check, eg: https://www.google.com/") 
    ...
    def from_dict(cls, obj: dict) -> HealthCheckResponse:
        ...
        if not isinstance(obj, dict):
            return HealthCheckResponse.model_validate(obj)

        _obj = HealthCheckResponse.model_validate({
            "type": obj.get("type"),
            "url": obj.get("url")
        })
        return _obj
