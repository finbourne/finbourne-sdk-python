...
class TriggerChildTasksAction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> TriggerChildTasksAction:
        ...
        if not isinstance(obj, dict):
            return TriggerChildTasksAction.model_validate(obj)

        _obj = TriggerChildTasksAction.model_validate({
            "type": obj.get("type"),
...
TriggerChildTasksAction.model_rebuild()
