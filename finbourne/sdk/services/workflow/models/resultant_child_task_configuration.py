...
class ResultantChildTaskConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resultMatchingPattern", "taskDefinitionId", "taskDefinitionAsAt", "initialTrigger", "childTaskFields", "mapStackingKeyFrom"]
    ...
    def from_dict(cls, obj: dict) -> ResultantChildTaskConfiguration:
        ...
        _obj = ResultantChildTaskConfiguration.model_validate({
            "result_matching_pattern": ResultMatchingPattern.from_dict(_v) if (_v := obj.get("resultMatchingPattern")) is not None else None,
