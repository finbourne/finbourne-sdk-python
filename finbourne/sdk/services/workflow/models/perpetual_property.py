...
class PerpetualProperty(BaseModel):
    """
    A perpetual property (i.e. without effective dates) on a Workflow. A property is deleted by supplying a null Finbourne.Workflow.WebApi.Common.Dto.Json.Properties.PerpetualProperty.Value.  # noqa: E501
    """
    key:  StrictStr = Field(...,alias="key", description="The property key in the form {domain}/{scope}/{code}. The domain must be 'Workflow'.") 
