...
class ResourceListOfEventTypeSchema(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfEventTypeSchema:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfEventTypeSchema.model_validate(obj)

        _obj = ResourceListOfEventTypeSchema.model_validate({
            "values": [EventTypeSchema.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfEventTypeSchema.model_rebuild()
