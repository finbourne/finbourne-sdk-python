...
class ResourceListOfNotification(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfNotification:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfNotification.model_validate(obj)

        _obj = ResourceListOfNotification.model_validate({
            "values": [Notification.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfNotification.model_rebuild()
