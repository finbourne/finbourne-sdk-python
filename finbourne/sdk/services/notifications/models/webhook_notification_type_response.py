...
class WebhookNotificationTypeResponse(BaseModel):
    ...
    http_method:  Optional[StrictStr] = Field(default=None,alias="httpMethod", description="The HTTP method such as GET, POST, etc. to use on the request") 
    url:  Optional[StrictStr] = Field(default=None,alias="url", description="The URL to send the request to") 
    authentication_type:  Optional[StrictStr] = Field(default=None,alias="authenticationType", description="The type of authentication to use on the request") 
    ...
    def from_dict(cls, obj: dict) -> WebhookNotificationTypeResponse:
        ...
        if not isinstance(obj, dict):
            return WebhookNotificationTypeResponse.model_validate(obj)

        _obj = WebhookNotificationTypeResponse.model_validate({
            "type": obj.get("type"),
...
WebhookNotificationTypeResponse.model_rebuild()
