...
class UpdateNotificationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "notificationType"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.notification_type:
            _dict['notificationType'] = self.notification_type.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> UpdateNotificationRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateNotificationRequest.model_validate(obj)

        _obj = UpdateNotificationRequest.model_validate({
...
UpdateNotificationRequest.model_rebuild()
