...
class ResourceListOfDelivery(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfDelivery:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfDelivery.model_validate(obj)

        _obj = ResourceListOfDelivery.model_validate({
            "values": [Delivery.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfDelivery.model_rebuild()
