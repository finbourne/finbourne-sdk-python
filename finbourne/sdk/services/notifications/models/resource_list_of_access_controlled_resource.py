...
class ResourceListOfAccessControlledResource(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfAccessControlledResource:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfAccessControlledResource.model_validate(obj)

        _obj = ResourceListOfAccessControlledResource.model_validate({
            "values": [AccessControlledResource.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfAccessControlledResource.model_rebuild()
