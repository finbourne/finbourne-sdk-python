...
class NotificationTypeResponse(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    one_of_schemas: ClassVar[List[str]] = NOTIFICATIONTYPERESPONSE_ONE_OF_SCHEMAS
    ...
    def actual_instance_must_validate_oneof(cls, v):
        _instance = NotificationTypeResponse.model_construct()
        error_messages = []
        match = 0
        matchclass = ""
    ...
    def from_json(cls, json_str: str) -> NotificationTypeResponse:
        ...
        instance = NotificationTypeResponse.model_construct()
        error_messages = []
        match = 0
        matchclass = ""
