...
class ResourceListOfSubscription(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfSubscription:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfSubscription.model_validate(obj)

        _obj = ResourceListOfSubscription.model_validate({
            "values": [Subscription.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfSubscription.model_rebuild()
