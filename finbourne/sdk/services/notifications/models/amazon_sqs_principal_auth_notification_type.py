...
class AmazonSqsPrincipalAuthNotificationType(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> AmazonSqsPrincipalAuthNotificationType:
        ...
        if not isinstance(obj, dict):
            return AmazonSqsPrincipalAuthNotificationType.model_validate(obj)

        _obj = AmazonSqsPrincipalAuthNotificationType.model_validate({
            "type": obj.get("type"),
            "body": obj.get("body"),
...
AmazonSqsPrincipalAuthNotificationType.model_rebuild()
