...
class ManualEventApi:
    ...
    @validate_call
    def trigger_manual_event(self, manual_event_request: ManualEventRequest, **kwargs) -> ManualEvent:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def trigger_manual_event_async(self, manual_event_request: ManualEventRequest, **kwargs) -> ManualEvent:
            """TriggerManualEvent: Trigger a manual event.  # noqa: E501
