...
class SupportAccessResponse(BaseModel):
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.terminated_by is None and "terminated_by" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> SupportAccessResponse:
        ...
        if not isinstance(obj, dict):
            return SupportAccessResponse.model_validate(obj)

        _obj = SupportAccessResponse.model_validate({
            "id": obj.get("id"),
...
SupportAccessResponse.model_rebuild()
