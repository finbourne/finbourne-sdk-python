...
class NetworkZonesApplyRules(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sessionType", "userRoles"]
    ...
    def from_dict(cls, obj: dict) -> NetworkZonesApplyRules:
        ...
        if not isinstance(obj, dict):
            return NetworkZonesApplyRules.model_validate(obj)

        _obj = NetworkZonesApplyRules.model_validate({
            "session_type": obj.get("sessionType"),
            "user_roles": obj.get("userRoles")
        })
        return _obj

NetworkZonesApplyRules.model_rebuild()
