...
class UpdatePasswordPolicyRequestComplexity(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdatePasswordPolicyRequestComplexity:
        ...
        if not isinstance(obj, dict):
            return UpdatePasswordPolicyRequestComplexity.model_validate(obj)

        _obj = UpdatePasswordPolicyRequestComplexity.model_validate({
...
UpdatePasswordPolicyRequestComplexity.model_rebuild()
