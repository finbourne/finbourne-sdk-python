...
class CreatedApiKey(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["key", "id", "displayName", "createdDate", "deactivationDate"]
    ...
    def from_dict(cls, obj: dict) -> CreatedApiKey:
        ...
        if not isinstance(obj, dict):
            return CreatedApiKey.model_validate(obj)

        _obj = CreatedApiKey.model_validate({
            "key": obj.get("key"),
            "id": obj.get("id"),
