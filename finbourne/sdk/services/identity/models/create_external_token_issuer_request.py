...
class CreateExternalTokenIssuerRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateExternalTokenIssuerRequest:
        ...
        if not isinstance(obj, dict):
            return CreateExternalTokenIssuerRequest.model_validate(obj)

        _obj = CreateExternalTokenIssuerRequest.model_validate({
            "code": obj.get("code"),
...
CreateExternalTokenIssuerRequest.model_rebuild()
