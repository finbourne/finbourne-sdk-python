...
class PasswordPolicyResponseComplexity(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PasswordPolicyResponseComplexity:
        ...
        if not isinstance(obj, dict):
            return PasswordPolicyResponseComplexity.model_validate(obj)

        _obj = PasswordPolicyResponseComplexity.model_validate({
...
PasswordPolicyResponseComplexity.model_rebuild()
