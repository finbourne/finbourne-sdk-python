...
class UserResponse(BaseModel):
    ...
    second_email_address:  Optional[StrictStr] = Field(default=None,alias="secondEmailAddress", description="The user's second email address. Only allowed for service users.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.password_changed is None and "password_changed" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> UserResponse:
        ...
        _obj = UserResponse.model_validate({
            "id": obj.get("id"),
