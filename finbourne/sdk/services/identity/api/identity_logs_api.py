...
class IdentityLogsApi:
    ...
    def list_logs_with_http_info(self, okta_since: Optional[datetime] = None, okta_until: Optional[datetime] = None, okta_filter: Optional[StrictStr] = None, okta_query: Optional[StrictStr] = None, okta_limit: Optional[int] = None, okta_sort_order: Optional[StrictStr] = None, okta_after: Optional[StrictStr] = None, **kwargs) -> ApiResponse[ResourceListOfSystemLog]:
        ...
        if _params.get('okta_since') is not None:  # noqa: E501
            if isinstance(_params['okta_since'], datetime):
                _query_params.append(('oktaSince', _params['okta_since'].strftime(self.sync_api_client.configuration.datetime_format)))
            else:
        ...
        if _params.get('okta_until') is not None:  # noqa: E501
            if isinstance(_params['okta_until'], datetime):
                _query_params.append(('oktaUntil', _params['okta_until'].strftime(self.sync_api_client.configuration.datetime_format)))
            else:
    ...
    @validate_call
    def list_user_logs(self, okta_since: Optional[datetime] = None, okta_until: Optional[datetime] = None, okta_limit: Optional[int] = None, okta_sort_order: Optional[StrictStr] = None, okta_after: Optional[StrictStr] = None, **kwargs) -> ResourceListOfSystemLog:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def list_user_logs_async(self, okta_since: Optional[datetime] = None, okta_until: Optional[datetime] = None, okta_limit: Optional[int] = None, okta_sort_order: Optional[StrictStr] = None, okta_after: Optional[StrictStr] = None, **kwargs) -> ResourceListOfSystemLog:
            """ListUserLogs: Lists user logs  # noqa: E501
            Lists account related system logs for the calling user  # noqa: E501
