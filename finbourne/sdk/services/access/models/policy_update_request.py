...
class PolicyUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "applications", "grant", "selectors", "for", "if", "when", "how", "templateMetadata"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.template_metadata:
            _dict['templateMetadata'] = self.template_metadata.to_dict(by_alias=by_alias)
