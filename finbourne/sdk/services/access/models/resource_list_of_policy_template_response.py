...
class ResourceListOfPolicyTemplateResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyTemplateResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPolicyTemplateResponse.model_validate(obj)

        _obj = ResourceListOfPolicyTemplateResponse.model_validate({
            "values": [PolicyTemplateResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPolicyTemplateResponse.model_rebuild()
