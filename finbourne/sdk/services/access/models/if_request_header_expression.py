...
class IfRequestHeaderExpression(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["headerName", "operator", "value"]
    ...
    def from_dict(cls, obj: dict) -> IfRequestHeaderExpression:
        ...
        if not isinstance(obj, dict):
            return IfRequestHeaderExpression.model_validate(obj)

        _obj = IfRequestHeaderExpression.model_validate({
...
IfRequestHeaderExpression.model_rebuild()
