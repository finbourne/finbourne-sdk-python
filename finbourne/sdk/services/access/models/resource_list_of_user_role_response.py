...
class ResourceListOfUserRoleResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfUserRoleResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfUserRoleResponse.model_validate(obj)

        _obj = ResourceListOfUserRoleResponse.model_validate({
            "values": [UserRoleResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfUserRoleResponse.model_rebuild()
