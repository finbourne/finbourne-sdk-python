...
class ResourceListOfPolicyCollectionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyCollectionResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPolicyCollectionResponse.model_validate(obj)

        _obj = ResourceListOfPolicyCollectionResponse.model_validate({
            "values": [PolicyCollectionResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPolicyCollectionResponse.model_rebuild()
