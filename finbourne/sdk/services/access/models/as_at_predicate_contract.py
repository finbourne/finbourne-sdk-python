...
class AsAtPredicateContract(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["value", "dateTimeOffset"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.date_time_offset is None and "date_time_offset" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> AsAtPredicateContract:
        ...
        if not isinstance(obj, dict):
            return AsAtPredicateContract.model_validate(obj)

        _obj = AsAtPredicateContract.model_validate({
            "value": obj.get("value"),
            "date_time_offset": obj.get("dateTimeOffset")
        })
        return _obj

AsAtPredicateContract.model_rebuild()
