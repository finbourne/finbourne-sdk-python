...
class NonTransitiveSupervisorRoleResource(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> NonTransitiveSupervisorRoleResource:
        ...
        if not isinstance(obj, dict):
            return NonTransitiveSupervisorRoleResource.model_validate(obj)

        _obj = NonTransitiveSupervisorRoleResource.model_validate({
            "roles": obj.get("roles")
        })
        return _obj

NonTransitiveSupervisorRoleResource.model_rebuild()
