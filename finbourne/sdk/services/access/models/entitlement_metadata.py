...
class EntitlementMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provider", "value"]
    ...
    def from_dict(cls, obj: dict) -> EntitlementMetadata:
        ...
        if not isinstance(obj, dict):
            return EntitlementMetadata.model_validate(obj)

        _obj = EntitlementMetadata.model_validate({
            "provider": obj.get("provider"),
            "value": obj.get("value")
        })
        return _obj

EntitlementMetadata.model_rebuild()
