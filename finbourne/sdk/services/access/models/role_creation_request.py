...
class RoleCreationRequest(BaseModel):
    ...
    when: WhenSpec
    __properties: ClassVar[List[str]] = ["code", "description", "resource", "when"]
    ...
    def from_dict(cls, obj: dict) -> RoleCreationRequest:
        ...
        if not isinstance(obj, dict):
            return RoleCreationRequest.model_validate(obj)

        _obj = RoleCreationRequest.model_validate({
            "code": obj.get("code"),
...
RoleCreationRequest.model_rebuild()
