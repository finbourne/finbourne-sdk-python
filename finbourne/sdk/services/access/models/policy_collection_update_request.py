...
class PolicyCollectionUpdateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["policies", "metadata", "policyCollections", "description"]
    ...
    def from_dict(cls, obj: dict) -> PolicyCollectionUpdateRequest:
        ...
        if not isinstance(obj, dict):
            return PolicyCollectionUpdateRequest.model_validate(obj)

        _obj = PolicyCollectionUpdateRequest.model_validate({
...
PolicyCollectionUpdateRequest.model_rebuild()
