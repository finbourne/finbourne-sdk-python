...
class IfIdentityScopeExpression(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scopeName"]
    ...
    def from_dict(cls, obj: dict) -> IfIdentityScopeExpression:
        ...
        if not isinstance(obj, dict):
            return IfIdentityScopeExpression.model_validate(obj)

        _obj = IfIdentityScopeExpression.model_validate({
            "scope_name": obj.get("scopeName")
        })
        return _obj

IfIdentityScopeExpression.model_rebuild()
