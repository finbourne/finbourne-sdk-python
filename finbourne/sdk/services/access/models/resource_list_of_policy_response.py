...
class ResourceListOfPolicyResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPolicyResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPolicyResponse.model_validate(obj)

        _obj = ResourceListOfPolicyResponse.model_validate({
            "values": [PolicyResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPolicyResponse.model_rebuild()
