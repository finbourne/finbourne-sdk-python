...
class PolicyTemplateCreationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "displayName", "description", "templatedSelectors"]
    ...
    def from_dict(cls, obj: dict) -> PolicyTemplateCreationRequest:
        ...
        if not isinstance(obj, dict):
            return PolicyTemplateCreationRequest.model_validate(obj)

        _obj = PolicyTemplateCreationRequest.model_validate({
            "code": obj.get("code"),
...
PolicyTemplateCreationRequest.model_rebuild()
