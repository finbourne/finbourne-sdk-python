...
class TransactionPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["transactionId", "columns", "values", "rawCsvRow"]
    ...
    def from_dict(cls, obj: dict) -> TransactionPayload:
        ...
        if not isinstance(obj, dict):
            return TransactionPayload.model_validate(obj)

        _obj = TransactionPayload.model_validate({
