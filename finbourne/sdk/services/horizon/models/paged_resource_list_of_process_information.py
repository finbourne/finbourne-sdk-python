...
class PagedResourceListOfProcessInformation(BaseModel):
    ...
    values: List[ProcessInformation]
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfProcessInformation:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfProcessInformation.model_validate(obj)

        _obj = PagedResourceListOfProcessInformation.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ProcessInformation.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfProcessInformation.model_rebuild()
