...
class IntegrationCancellationResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> IntegrationCancellationResponse:
        ...
        if not isinstance(obj, dict):
            return IntegrationCancellationResponse.model_validate(obj)

        _obj = IntegrationCancellationResponse.model_validate({
            "response": obj.get("response")
        })
        return _obj

IntegrationCancellationResponse.model_rebuild()
