...
class UpdateInstanceRequest(BaseModel):
    """
    A request to update an existing integration instance.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> UpdateInstanceRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateInstanceRequest.model_validate(obj)

        _obj = UpdateInstanceRequest.model_validate({
            "id": obj.get("id"),
...
UpdateInstanceRequest.model_rebuild()
