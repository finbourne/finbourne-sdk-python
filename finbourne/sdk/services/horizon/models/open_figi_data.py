...
class OpenFigiData(BaseModel):
    ...
    name:  Optional[StrictStr] = Field(default=None,alias="name", description="Various attributes of the instrument") 
    ticker:  Optional[StrictStr] = Field(default=None,alias="ticker", description="Various attributes of the instrument") 
    exchange_code:  Optional[StrictStr] = Field(default=None,alias="exchangeCode", description="Exchange code of the desired instrument(s)") 
    mic:  Optional[StrictStr] = Field(default=None,alias="mic", description="ISO market identification code(MIC) of the desired instrument(s)") 
    exchange_name:  Optional[StrictStr] = Field(default=None,alias="exchangeName", description="Exchange name of the desired instrument(s)") 
    market_sector:  Optional[StrictStr] = Field(default=None,alias="marketSector", description="Market sector description of the desired instrument(s)") 
    general_security_type:  Optional[StrictStr] = Field(default=None,alias="generalSecurityType", description="Enum-like attributes of the instrument") 
    security_type:  Optional[StrictStr] = Field(default=None,alias="securityType", description="Enum-like attributes of the instrument") 
    security_description:  Optional[StrictStr] = Field(default=None,alias="securityDescription", description="Various attributes of the instrument") 
    composite_figi:  Optional[StrictStr] = Field(default=None,alias="compositeFigi", description="Various attributes of the instrument") 
    share_class_figi:  Optional[StrictStr] = Field(default=None,alias="shareClassFigi", description="Various attributes of the instrument") 
    match_type:  Optional[StrictStr] = Field(default=None,alias="matchType", description="Type that the instrument matched against") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.exchange_code is None and "exchange_code" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.market_sector is None and "market_sector" in self.model_fields_set:
            _dict['marketSector'] = None

        # set to None if general_security_type (nullable) is None
        # and model_fields_set contains the field
        if self.general_security_type is None and "general_security_type" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.security_description is None and "security_description" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.search_input is None and "search_input" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.lusid_instrument_scope is None and "lusid_instrument_scope" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> OpenFigiData:
        ...
        if not isinstance(obj, dict):
            return OpenFigiData.model_validate(obj)

        _obj = OpenFigiData.model_validate({
            "figi": obj.get("figi"),
            "name": obj.get("name"),
