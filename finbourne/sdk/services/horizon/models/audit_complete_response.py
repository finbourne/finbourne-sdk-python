...
class AuditCompleteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["processName"]
    ...
    def from_dict(cls, obj: dict) -> AuditCompleteResponse:
        ...
        if not isinstance(obj, dict):
            return AuditCompleteResponse.model_validate(obj)

        _obj = AuditCompleteResponse.model_validate({
            "process_name": obj.get("processName")
        })
        return _obj

AuditCompleteResponse.model_rebuild()
