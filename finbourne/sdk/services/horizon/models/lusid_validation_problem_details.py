...
class LusidValidationProblemDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "errorDetails", "code", "errors", "type", "title", "status", "detail", "instance"]
    ...
    def from_dict(cls, obj: dict) -> LusidValidationProblemDetails:
        ...
        if not isinstance(obj, dict):
            return LusidValidationProblemDetails.model_validate(obj)

        _obj = LusidValidationProblemDetails.model_validate({
            "name": obj.get("name"),
...
LusidValidationProblemDetails.model_rebuild()
