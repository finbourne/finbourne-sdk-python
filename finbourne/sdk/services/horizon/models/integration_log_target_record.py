...
class IntegrationLogTargetRecord(BaseModel):
    ...
    """
    record_action:  Optional[StrictStr] = Field(default=None,alias="recordAction") 
    ...
    __properties: ClassVar[List[str]] = ["recordAction", "recordType", "idType", "idValue", "attributeName", "attributeValue"]
    ...
    def to_dict(self):
        ...
        if self.record_action is None and "record_action" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> IntegrationLogTargetRecord:
        ...
        if not isinstance(obj, dict):
            return IntegrationLogTargetRecord.model_validate(obj)

        _obj = IntegrationLogTargetRecord.model_validate({
...
IntegrationLogTargetRecord.model_rebuild()
