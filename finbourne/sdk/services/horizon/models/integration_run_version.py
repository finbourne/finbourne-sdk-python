...
class IntegrationRunVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asAtCreated", "asAtModified"]
    ...
    def from_dict(cls, obj: dict) -> IntegrationRunVersion:
        ...
        if not isinstance(obj, dict):
            return IntegrationRunVersion.model_validate(obj)

        _obj = IntegrationRunVersion.model_validate({
            "as_at_created": obj.get("asAtCreated"),
            "as_at_modified": obj.get("asAtModified")
        })
        return _obj

IntegrationRunVersion.model_rebuild()
