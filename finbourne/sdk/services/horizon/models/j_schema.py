...
class JSchema(BaseModel):
    ...
    recursive_reference:  Optional[StrictStr] = Field(default=None,alias="recursiveReference") 
    recursive_anchor: Optional[StrictBool] = Field(default=None, alias="recursiveAnchor")
    id:  Optional[StrictStr] = Field(default=None,alias="id") 
    anchor:  Optional[StrictStr] = Field(default=None,alias="anchor") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.recursive_reference is None and "recursive_reference" in self.model_fields_set:
            _dict['recursiveReference'] = None

        # set to None if recursive_anchor (nullable) is None
        # and model_fields_set contains the field
        if self.recursive_anchor is None and "recursive_anchor" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.minimum_length is None and "minimum_length" in self.model_fields_set:
            _dict['minimumLength'] = None

        # set to None if maximum_length (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_length is None and "maximum_length" in self.model_fields_set:
            _dict['maximumLength'] = None

        # set to None if minimum_items (nullable) is None
        # and model_fields_set contains the field
        if self.minimum_items is None and "minimum_items" in self.model_fields_set:
            _dict['minimumItems'] = None

        # set to None if maximum_items (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_items is None and "maximum_items" in self.model_fields_set:
            _dict['maximumItems'] = None

        # set to None if minimum_properties (nullable) is None
        # and model_fields_set contains the field
        if self.minimum_properties is None and "minimum_properties" in self.model_fields_set:
            _dict['minimumProperties'] = None

        # set to None if maximum_properties (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_properties is None and "maximum_properties" in self.model_fields_set:
            _dict['maximumProperties'] = None

        # set to None if minimum_contains (nullable) is None
        # and model_fields_set contains the field
        if self.minimum_contains is None and "minimum_contains" in self.model_fields_set:
            _dict['minimumContains'] = None

        # set to None if maximum_contains (nullable) is None
        # and model_fields_set contains the field
        if self.maximum_contains is None and "maximum_contains" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.content_media_type is None and "content_media_type" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.allow_unevaluated_properties is None and "allow_unevaluated_properties" in self.model_fields_set:
            _dict['allowUnevaluatedProperties'] = None

        # set to None if allow_unevaluated_items (nullable) is None
        # and model_fields_set contains the field
        if self.allow_unevaluated_items is None and "allow_unevaluated_items" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> JSchema:
        ...
        if not isinstance(obj, dict):
            return JSchema.model_validate(obj)

        _obj = JSchema.model_validate({
