...
class IPropertyMapping(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.var_property:
            _dict['property'] = self.var_property.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> IPropertyMapping:
        ...
        if not isinstance(obj, dict):
            return IPropertyMapping.model_validate(obj)

        _obj = IPropertyMapping.model_validate({
...
IPropertyMapping.model_rebuild()
