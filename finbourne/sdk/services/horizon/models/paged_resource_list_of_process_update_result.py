...
class PagedResourceListOfProcessUpdateResult(BaseModel):
    ...
    values: List[ProcessUpdateResult]
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfProcessUpdateResult:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfProcessUpdateResult.model_validate(obj)

        _obj = PagedResourceListOfProcessUpdateResult.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ProcessUpdateResult.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfProcessUpdateResult.model_rebuild()
