...
class IntegrationInstance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "integrationType", "name", "description", "enabled", "triggers", "details"]
    ...
    def from_dict(cls, obj: dict) -> IntegrationInstance:
        ...
        if not isinstance(obj, dict):
            return IntegrationInstance.model_validate(obj)

        _obj = IntegrationInstance.model_validate({
            "id": obj.get("id"),
...
IntegrationInstance.model_rebuild()
