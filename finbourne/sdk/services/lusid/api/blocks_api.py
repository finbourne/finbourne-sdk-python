...
class BlocksApi:
    ...
    @validate_call
    def delete_block(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
        ...
        response = self.delete_block_with_http_info(scope, code, **kwargs)
        return response.data

    @validate_call
    def delete_block_with_http_info(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        """[EARLY ACCESS] DeleteBlock: Delete block  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/blocks/{scope}/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_block(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Block:
        ...
        response = self.get_block_with_http_info(scope, code, as_at, property_keys, **kwargs)
        return response.data

    @validate_call
    def get_block_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[Block]:
        """[EARLY ACCESS] GetBlock: Get Block  # noqa: E501
    ...
    @validate_call
    def list_blocks(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfBlock:
        ...
        response = self.list_blocks_with_http_info(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
        return response.data

    @validate_call
    def list_blocks_with_http_info(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfBlock]:
        """[EARLY ACCESS] ListBlocks: List Blocks  # noqa: E501
    ...
    @validate_call
    def upsert_blocks(self, block_set_request: Optional[BlockSetRequest] = None, **kwargs) -> ResourceListOfBlock:
        ...
        response = self.upsert_blocks_with_http_info(block_set_request, **kwargs)
        return response.data

    @validate_call
    def upsert_blocks_with_http_info(self, block_set_request: Optional[BlockSetRequest] = None, **kwargs) -> ApiResponse[ResourceListOfBlock]:
        """[EARLY ACCESS] UpsertBlocks: Upsert Block  # noqa: E501
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def delete_block_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            """[EARLY ACCESS] DeleteBlock: Delete block  # noqa: E501
            Delete an block. Deletion will be valid from the block's creation datetime.  This means that the block will no longer exist at any effective datetime from the asAt datetime of deletion.  # noqa: E501
            ...
            response = await self.delete_block_with_http_info_async(scope, code, **kwargs)
            return response.data

    @validate_call
    async def delete_block_with_http_info_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
            """[EARLY ACCESS] DeleteBlock: Delete block  # noqa: E501
    ...
    @validate_call
    async def get_block_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Block:
            """[EARLY ACCESS] GetBlock: Get Block  # noqa: E501
            Fetch a Block that matches the specified identifier  # noqa: E501
            ...
            response = await self.get_block_with_http_info_async(scope, code, as_at, property_keys, **kwargs)
            return response.data

    @validate_call
    async def get_block_with_http_info_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[Block]:
            """[EARLY ACCESS] GetBlock: Get Block  # noqa: E501
    ...
    @validate_call
    async def list_blocks_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfBlock:
            """[EARLY ACCESS] ListBlocks: List Blocks  # noqa: E501
            Fetch the last pre-AsAt date version of each block in scope (does not fetch the entire history).  # noqa: E501
            ...
            response = await self.list_blocks_with_http_info_async(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
            return response.data

    @validate_call
    async def list_blocks_with_http_info_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfBlock]:
            """[EARLY ACCESS] ListBlocks: List Blocks  # noqa: E501
    ...
    @validate_call
    async def upsert_blocks_async(self, block_set_request: Optional[BlockSetRequest] = None, **kwargs) -> ResourceListOfBlock:
            """[EARLY ACCESS] UpsertBlocks: Upsert Block  # noqa: E501
            Upsert; update existing blocks with given ids, or create new blocks otherwise.  # noqa: E501
            ...
            response = await self.upsert_blocks_with_http_info_async(block_set_request, **kwargs)
            return response.data

    @validate_call
    async def upsert_blocks_with_http_info_async(self, block_set_request: Optional[BlockSetRequest] = None, **kwargs) -> ApiResponse[ResourceListOfBlock]:
            """[EARLY ACCESS] UpsertBlocks: Upsert Block  # noqa: E501
