...
class TransactionFeesApi:
    ...
    @validate_call
    def delete_transaction_fee_rule(self, code: StrictStr, **kwargs) -> DeletedEntityResponse:
    ...
    def delete_transaction_fee_rule_with_http_info(self, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/fees/rules/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_applicable_transaction_fees_with_http_info(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, instrument_identifier_type: Optional[StrictStr] = None, instrument_identifier: Optional[StrictStr] = None, portfolio_scope: Optional[StrictStr] = None, portfolio_code: Optional[StrictStr] = None, request_body: Optional[Dict[str, str]] = None, **kwargs) -> ApiResponse[ResourceListOfFeeRule]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/fees/$GetApplicableFees', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_transaction_fee_rule(self, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, **kwargs) -> FeeRule:
    ...
    def get_transaction_fee_rule_with_http_info(self, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, **kwargs) -> ApiResponse[FeeRule]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/fees/rules/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def list_transaction_fee_rules_with_http_info(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, page: Optional[StrictStr] = None, **kwargs) -> ApiResponse[ResourceListOfFeeRule]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/fees/rules', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def upsert_transaction_fee_rules(self, request_body: Dict[str, FeeRuleUpsertRequest], effective_at: Optional[StrictStr] = None, **kwargs) -> FeeRuleUpsertResponse:
    ...
    def upsert_transaction_fee_rules_with_http_info(self, request_body: Dict[str, FeeRuleUpsertRequest], effective_at: Optional[StrictStr] = None, **kwargs) -> ApiResponse[FeeRuleUpsertResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/fees/rules', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def delete_transaction_fee_rule_async(self, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            """DeleteTransactionFeeRule: Deletes a fee rule.  # noqa: E501
            Deletes the rule for all effective time.    The rule will remain viewable at previous as at times, but it will no longer be considered by  GetApplicableFees.    This cannot be undone.  # noqa: E501
    ...
    @validate_call
    async def get_applicable_transaction_fees_async(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, instrument_identifier_type: Optional[StrictStr] = None, instrument_identifier: Optional[StrictStr] = None, portfolio_scope: Optional[StrictStr] = None, portfolio_code: Optional[StrictStr] = None, request_body: Optional[Dict[str, str]] = None, **kwargs) -> ResourceListOfFeeRule:
            """GetApplicableTransactionFees: Get the Fees and Commissions that may be applicable to a transaction.  # noqa: E501
            Additionally, matching can be based on the instrument's properties, its portfolio properties, and any additional property keys present in the data file.  # noqa: E501
    ...
    @validate_call
    async def get_transaction_fee_rule_async(self, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, **kwargs) -> FeeRule:
            """GetTransactionFeeRule: Retrieve the definition of single fee rule.  # noqa: E501
            Retrieves the fee rule definition at the given effective and as at times.  # noqa: E501
    ...
    @validate_call
    async def upsert_transaction_fee_rules_async(self, request_body: Dict[str, FeeRuleUpsertRequest], effective_at: Optional[StrictStr] = None, **kwargs) -> FeeRuleUpsertResponse:
            """UpsertTransactionFeeRules: Upsert fee rules.  # noqa: E501
            To upsert a new rule, the code field must be left empty, a code will then be assigned and returned as part  of the response. To update an existing rule, include the fee code. It is possible to both create and update  fee rules in the same request.    The upsert is transactional - either all create/update operations will succeed or none of them will.  # noqa: E501
