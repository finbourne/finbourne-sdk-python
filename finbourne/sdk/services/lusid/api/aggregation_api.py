...
class AggregationApi:
    ...
    @validate_call
    def generate_configuration_recipe(self, scope: StrictStr, code: StrictStr, create_recipe_request: Optional[CreateRecipeRequest] = None, **kwargs) -> ConfigurationRecipe:
    ...
    def generate_configuration_recipe_with_http_info(self, scope: StrictStr, code: StrictStr, create_recipe_request: Optional[CreateRecipeRequest] = None, **kwargs) -> ApiResponse[ConfigurationRecipe]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/aggregation/{scope}/{code}/$generateconfigurationrecipe', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_queryable_keys(self, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> ResourceListOfAggregationQuery:
    ...
    def get_queryable_keys_with_http_info(self, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> ApiResponse[ResourceListOfAggregationQuery]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/results/queryable/keys', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_valuation(self, valuation_request: Optional[ValuationRequest] = None, **kwargs) -> ListAggregationResponse:
    ...
    def get_valuation_with_http_info(self, valuation_request: Optional[ValuationRequest] = None, **kwargs) -> ApiResponse[ListAggregationResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/aggregation/$valuation', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_valuation_of_weighted_instruments(self, inline_valuation_request: Optional[InlineValuationRequest] = None, **kwargs) -> ListAggregationResponse:
    ...
    def get_valuation_of_weighted_instruments_with_http_info(self, inline_valuation_request: Optional[InlineValuationRequest] = None, **kwargs) -> ApiResponse[ListAggregationResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/aggregation/$valuationinlined', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def generate_configuration_recipe_async(self, scope: StrictStr, code: StrictStr, create_recipe_request: Optional[CreateRecipeRequest] = None, **kwargs) -> ConfigurationRecipe:
            """[EXPERIMENTAL] GenerateConfigurationRecipe: Generates a recipe sufficient to perform valuations for the given portfolio.  # noqa: E501
            Given a set of scopes, a portfolio Id and a basic recipe, this endpoint generates a configuration recipe with relevant rules that can value the instruments in the portfolio.  # noqa: E501
    ...
    @validate_call
    async def get_queryable_keys_async(self, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> ResourceListOfAggregationQuery:
            """GetQueryableKeys: Query the set of supported \"addresses\" that can be queried from the aggregation endpoint.  # noqa: E501
            When a request is made for aggregation, the user needs to know what keys can be passed to it for queryable data. This endpoint allows to queries to provide the set of keys,  what they are and what they return.  # noqa: E501
    ...
    @validate_call
    async def get_valuation_async(self, valuation_request: Optional[ValuationRequest] = None, **kwargs) -> ListAggregationResponse:
            """GetValuation: Perform valuation for a list of portfolios and/or portfolio groups  # noqa: E501
            Perform valuation on specified list of portfolio and/or portfolio groups for a set of dates.  # noqa: E501
    ...
    @validate_call
    async def get_valuation_of_weighted_instruments_async(self, inline_valuation_request: Optional[InlineValuationRequest] = None, **kwargs) -> ListAggregationResponse:
            """GetValuationOfWeightedInstruments: Perform valuation for an inlined portfolio  # noqa: E501
            Perform valuation on the portfolio that is defined by the weighted set of instruments passed to the request.  # noqa: E501
