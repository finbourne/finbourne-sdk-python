...
class OrderGraphApi:
    ...
    @validate_call
    def list_order_graph_placement_children(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfOrderGraphPlacement:
    ...
    def list_order_graph_placement_children_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfOrderGraphPlacement]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/ordergraph/placementchildren/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_order_graph_placements(self, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfOrderGraphPlacement:
    ...
    def list_order_graph_placements_with_http_info(self, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfOrderGraphPlacement]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/ordergraph/placements', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def list_order_graph_blocks_async(self, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, use_compliance_v2: Optional[bool] = None, **kwargs) -> PagedResourceListOfOrderGraphBlock:
            """ListOrderGraphBlocks: Lists blocks that pass the filter provided, and builds a summary picture of the state of their associated order entities.  # noqa: E501
            Lists all blocks of orders, subject to the filter, along with the IDs of orders, placements, allocations and  executions in the block, the total quantities of each, and a simple text field describing the overall state.  # noqa: E501
    ...
    @validate_call
    async def list_order_graph_placement_children_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfOrderGraphPlacement:
            """[EARLY ACCESS] ListOrderGraphPlacementChildren: Lists all placements for the parent placement specified by the scope and code, and builds a summary picture of the state of their associated order entities.  # noqa: E501
            Lists all child order placements, for the specified parent placement, along with the IDs of the block and order that the  placement is for, each placement's quantity, the IDs of all allocations and executions in the placement  and the total quantities of those, and a simple text field describing the overall state of the placement.  # noqa: E501
    ...
    @validate_call
    async def list_order_graph_placements_async(self, as_at: Optional[datetime] = None, pagination_token: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfOrderGraphPlacement:
            """ListOrderGraphPlacements: Lists placements that pass the filter provided, and builds a summary picture of the state of their associated order entities.  # noqa: E501
            Lists all order placements, subject to the filter, along with the IDs of the block and order that the  placement is for, each placement's quantity, the IDs of all allocations and executions in the placement  and the total quantities of those, and a simple text field describing the overall state of the placement.  # noqa: E501
