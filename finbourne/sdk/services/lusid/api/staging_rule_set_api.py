...
class StagingRuleSetApi:
    ...
    def create_staging_rule_set_with_http_info(self, entity_type: StrictStr, create_staging_rule_set_request: CreateStagingRuleSetRequest, **kwargs) -> ApiResponse[StagingRuleSet]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/stagingrulesets/{entityType}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_staging_rule_set(self, entity_type: StrictStr, **kwargs) -> DeletedEntityResponse:
    ...
    def delete_staging_rule_set_with_http_info(self, entity_type: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/stagingrulesets/{entityType}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_staging_rule_set(self, entity_type: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> StagingRuleSet:
    ...
    def get_staging_rule_set_with_http_info(self, entity_type: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> ApiResponse[StagingRuleSet]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/stagingrulesets/{entityType}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_staging_rule_sets(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfStagingRuleSet:
    ...
    @validate_call
    def update_staging_rule_set(self, entity_type: StrictStr, update_staging_rule_set_request: UpdateStagingRuleSetRequest, **kwargs) -> StagingRuleSet:
    ...
    def update_staging_rule_set_with_http_info(self, entity_type: StrictStr, update_staging_rule_set_request: UpdateStagingRuleSetRequest, **kwargs) -> ApiResponse[StagingRuleSet]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/stagingrulesets/{entityType}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def create_staging_rule_set_async(self, entity_type: StrictStr, create_staging_rule_set_request: CreateStagingRuleSetRequest, **kwargs) -> StagingRuleSet:
            """CreateStagingRuleSet: Create a StagingRuleSet  # noqa: E501
            Create a new staging rule set.  # noqa: E501
    ...
    @validate_call
    async def delete_staging_rule_set_async(self, entity_type: StrictStr, **kwargs) -> DeletedEntityResponse:
            """DeleteStagingRuleSet: Delete a StagingRuleSet  # noqa: E501
            Delete a staging rule set of a specific entity type. Deletion will be valid from the staging rule set's creation datetime.  This means that the staging rule set will no longer exist at any effective datetime from the asAt datetime of deletion.  # noqa: E501
    ...
    @validate_call
    async def get_staging_rule_set_async(self, entity_type: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> StagingRuleSet:
            """GetStagingRuleSet: Get a StagingRuleSet  # noqa: E501
            Get the staging rule set for the given entity type at the specific asAt time.  # noqa: E501
    ...
    @validate_call
    async def list_staging_rule_sets_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfStagingRuleSet:
            """ListStagingRuleSets: List StagingRuleSets  # noqa: E501
            List all the staging rule sets matching particular criteria.  # noqa: E501
    ...
    @validate_call
    async def update_staging_rule_set_async(self, entity_type: StrictStr, update_staging_rule_set_request: UpdateStagingRuleSetRequest, **kwargs) -> StagingRuleSet:
            """UpdateStagingRuleSet: Update a StagingRuleSet  # noqa: E501
            Update an existing staging rule set.  # noqa: E501
