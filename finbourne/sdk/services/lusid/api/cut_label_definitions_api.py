...
class CutLabelDefinitionsApi:
    ...
    def create_cut_label_definition_with_http_info(self, create_cut_label_definition_request: Optional[CreateCutLabelDefinitionRequest] = None, **kwargs) -> ApiResponse[CutLabelDefinition]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/systemconfiguration/cutlabels', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_cut_label_definition(self, code: StrictStr, **kwargs) -> datetime:
    ...
    def delete_cut_label_definition_with_http_info(self, code: StrictStr, **kwargs) -> ApiResponse[datetime]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/systemconfiguration/cutlabels/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_cut_label_definition(self, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> CutLabelDefinition:
    ...
    def get_cut_label_definition_with_http_info(self, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> ApiResponse[CutLabelDefinition]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/systemconfiguration/cutlabels/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_cut_label_definitions(self, as_at: Optional[datetime] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, page: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfCutLabelDefinition:
    ...
    def list_cut_label_definitions_with_http_info(self, as_at: Optional[datetime] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, page: Optional[StrictStr] = None, **kwargs) -> ApiResponse[PagedResourceListOfCutLabelDefinition]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/systemconfiguration/cutlabels', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def update_cut_label_definition(self, code: StrictStr, update_cut_label_definition_request: Optional[UpdateCutLabelDefinitionRequest] = None, **kwargs) -> CutLabelDefinition:
    ...
    def update_cut_label_definition_with_http_info(self, code: StrictStr, update_cut_label_definition_request: Optional[UpdateCutLabelDefinitionRequest] = None, **kwargs) -> ApiResponse[CutLabelDefinition]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/systemconfiguration/cutlabels/{code}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def create_cut_label_definition_async(self, create_cut_label_definition_request: Optional[CreateCutLabelDefinitionRequest] = None, **kwargs) -> CutLabelDefinition:
            """CreateCutLabelDefinition: Create a Cut Label  # noqa: E501
            Create a Cut Label valid in all scopes  # noqa: E501
    ...
    @validate_call
    async def delete_cut_label_definition_async(self, code: StrictStr, **kwargs) -> datetime:
            """DeleteCutLabelDefinition: Delete a Cut Label  # noqa: E501
            Delete a specified cut label  # noqa: E501
    ...
    @validate_call
    async def get_cut_label_definition_async(self, code: StrictStr, as_at: Optional[datetime] = None, **kwargs) -> CutLabelDefinition:
            """GetCutLabelDefinition: Get a Cut Label  # noqa: E501
            Get a specified cut label at a given time  # noqa: E501
    ...
    @validate_call
    async def list_cut_label_definitions_async(self, as_at: Optional[datetime] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, page: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfCutLabelDefinition:
            """ListCutLabelDefinitions: List Existing Cut Labels  # noqa: E501
            List all the Cut Label Definitions that are valid at the given AsAt time  # noqa: E501
    ...
    @validate_call
    async def update_cut_label_definition_async(self, code: StrictStr, update_cut_label_definition_request: Optional[UpdateCutLabelDefinitionRequest] = None, **kwargs) -> CutLabelDefinition:
            """UpdateCutLabelDefinition: Update a Cut Label  # noqa: E501
            Update a specified cut label  # noqa: E501
