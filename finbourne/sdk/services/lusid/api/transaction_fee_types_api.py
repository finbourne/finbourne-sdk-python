...
class TransactionFeeTypesApi:
    ...
    def create_transaction_fee_type(self, scope: StrictStr, code: StrictStr, create_transaction_fee_type_request: CreateTransactionFeeTypeRequest, **kwargs) -> TransactionFeeType:
        ...
        :type code: str
        :param create_transaction_fee_type_request: The contents of the transaction fee type. (required)
        :type create_transaction_fee_type_request: CreateTransactionFeeTypeRequest
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        :type opts: ConfigurationOptions, optional
        :return: Returns the result object.
        :rtype: TransactionFeeType
        """
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_transaction_fee_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        response = self.create_transaction_fee_type_with_http_info(scope, code, create_transaction_fee_type_request, **kwargs)
    ...
    def create_transaction_fee_type_with_http_info(self, scope: StrictStr, code: StrictStr, create_transaction_fee_type_request: CreateTransactionFeeTypeRequest, **kwargs) -> ApiResponse[TransactionFeeType]:
        ...
        :return: Returns the result object.
        :rtype: tuple(TransactionFeeType, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        _all_params = [
            'scope',
            'code',
            'create_transaction_fee_type_request'
        ]
        _all_params.extend(
            [
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_transaction_fee_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _body_params = None
        if _params['create_transaction_fee_type_request'] is not None:
            _body_params = _params['create_transaction_fee_type_request']
        ...
        _response_types_map = {
            '201': "TransactionFeeType",
            '400': "LusidValidationProblemDetails",
        }

        return self.sync_api_client.call_api(
            '/api/api/transactions/transactionfeetypes/{scope}/{code}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def delete_transaction_fee_type(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
        ...
        """
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_transaction_fee_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        response = self.delete_transaction_fee_type_with_http_info(scope, code, **kwargs)
        return response.data
    ...
    def delete_transaction_fee_type_with_http_info(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_transaction_fee_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/transactionfeetypes/{scope}/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_transaction_fee_type(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> TransactionFeeType:
        ...
        :param code: The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
        :type code: str
        :param effective_at: The effective datetime at which to retrieve the transaction fee type properties.              Defaults to the current LUSID system datetime if not specified.
        :type effective_at: str
        :param as_at: The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified.
        :type as_at: datetime
        :param property_keys: The collection of `PropertyKey`s that we want to decorate on the transaction fee type.
        ...
        """
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_transaction_fee_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        response = self.get_transaction_fee_type_with_http_info(scope, code, effective_at, as_at, property_keys, **kwargs)
        return response.data
    ...
    def get_transaction_fee_type_with_http_info(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[TransactionFeeType]:
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_transaction_fee_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "TransactionFeeType",
            '400': "LusidValidationProblemDetails",
        }

        return self.sync_api_client.call_api(
            '/api/api/transactions/transactionfeetypes/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def list_transaction_fee_types(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ResourceListOfTransactionFeeType:
        ...
        :type opts: ConfigurationOptions, optional
        :return: Returns the result object.
        :rtype: ResourceListOfTransactionFeeType
        """
        if '_preload_content' in kwargs:
            message = "Error! Please call the list_transaction_fee_types_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        response = self.list_transaction_fee_types_with_http_info(effective_at, as_at, page, limit, filter, sort_by, property_keys, **kwargs)
        return response.data
    ...
    def list_transaction_fee_types_with_http_info(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[ResourceListOfTransactionFeeType]:
        ...
        :type _content_type: string, optional: force content-type for the request
        :return: Returns the result object.
        :rtype: tuple(ResourceListOfTransactionFeeType, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_transaction_fee_types" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ResourceListOfTransactionFeeType",
            '400': "LusidValidationProblemDetails",
        }

        return self.sync_api_client.call_api(
            '/api/api/transactions/transactionfeetypes', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def update_transaction_fee_type(self, scope: StrictStr, code: StrictStr, update_transaction_fee_type_request: UpdateTransactionFeeTypeRequest, **kwargs) -> TransactionFeeType:
        ...
        :param code: The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type. (required)
        :type code: str
        :param update_transaction_fee_type_request: The updated contents of the transaction fee type. (required)
        :type update_transaction_fee_type_request: UpdateTransactionFeeTypeRequest
        :param _request_timeout: Timeout setting. Do not use - use the opts parameter instead
        :param opts: Configuration options for this request
        :type opts: ConfigurationOptions, optional
        :return: Returns the result object.
        ...
        """
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_transaction_fee_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        response = self.update_transaction_fee_type_with_http_info(scope, code, update_transaction_fee_type_request, **kwargs)
        return response.data
    ...
    def update_transaction_fee_type_with_http_info(self, scope: StrictStr, code: StrictStr, update_transaction_fee_type_request: UpdateTransactionFeeTypeRequest, **kwargs) -> ApiResponse[TransactionFeeType]:
        ...
        _all_params = [
            'scope',
            'code',
            'update_transaction_fee_type_request'
        ]
        _all_params.extend(
            [
                '_return_http_data_only',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_transaction_fee_type" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['update_transaction_fee_type_request'] is not None:
            _body_params = _params['update_transaction_fee_type_request']
        ...
        return self.sync_api_client.call_api(
            '/api/api/transactions/transactionfeetypes/{scope}/{code}', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    async def create_transaction_fee_type_async(self, scope: StrictStr, code: StrictStr, create_transaction_fee_type_request: CreateTransactionFeeTypeRequest, **kwargs) -> TransactionFeeType:
            ...
            response = await self.create_transaction_fee_type_with_http_info_async(scope, code, create_transaction_fee_type_request, **kwargs)
            return response.data
    ...
    async def delete_transaction_fee_type_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            ...
            response = await self.delete_transaction_fee_type_with_http_info_async(scope, code, **kwargs)
            return response.data
    ...
    async def get_transaction_fee_type_async(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> TransactionFeeType:
            ...
            response = await self.get_transaction_fee_type_with_http_info_async(scope, code, effective_at, as_at, property_keys, **kwargs)
            return response.data
    ...
    async def list_transaction_fee_types_async(self, effective_at: Optional[StrictStr] = None, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ResourceListOfTransactionFeeType:
            ...
            response = await self.list_transaction_fee_types_with_http_info_async(effective_at, as_at, page, limit, filter, sort_by, property_keys, **kwargs)
            return response.data
    ...
    async def update_transaction_fee_type_async(self, scope: StrictStr, code: StrictStr, update_transaction_fee_type_request: UpdateTransactionFeeTypeRequest, **kwargs) -> TransactionFeeType:
            ...
            response = await self.update_transaction_fee_type_with_http_info_async(scope, code, update_transaction_fee_type_request, **kwargs)
            return response.data
