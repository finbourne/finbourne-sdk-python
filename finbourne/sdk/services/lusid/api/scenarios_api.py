...
class ScenariosApi:
    ...
    @validate_call
    def list_scenario_templates(self, **kwargs) -> ResourceListOfScenarioTemplateDefinition:
        ...
        response = self.list_scenario_templates_with_http_info(**kwargs)
        return response.data

    @validate_call
    def list_scenario_templates_with_http_info(self, **kwargs) -> ApiResponse[ResourceListOfScenarioTemplateDefinition]:
        """[EARLY ACCESS] ListScenarioTemplates: [EARLY ACCESS] ListScenarioTemplates: List the pre-built scenario templates.  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/scenarios/$templates', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def solve_reverse_stress(self, reverse_stress_request: ReverseStressRequest, **kwargs) -> ReverseStressResponse:
        ...
        response = self.solve_reverse_stress_with_http_info(reverse_stress_request, **kwargs)
        return response.data

    @validate_call
    def solve_reverse_stress_with_http_info(self, reverse_stress_request: ReverseStressRequest, **kwargs) -> ApiResponse[ReverseStressResponse]:
        """[EARLY ACCESS] SolveReverseStress: Solve a reverse stress test  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/scenarios/$reversestress', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def list_scenario_templates_async(self, **kwargs) -> ResourceListOfScenarioTemplateDefinition:
            """[EARLY ACCESS] ListScenarioTemplates: [EARLY ACCESS] ListScenarioTemplates: List the pre-built scenario templates.  # noqa: E501
            Lists every template CreateScenarioFromTemplate accepts, with each template's parameters: the  parameter's name (case-sensitive), whether it is required, what it means, the default used when  it is omitted and the unit a numeric value is read in. The units differ between templates -  basis points, percentage points or a fraction - so read them per template rather than assuming  one convention. The list is static application metadata: it does not vary by tenant, scope or  date, so the endpoint takes no parameters.  # noqa: E501
            ...
            response = await self.list_scenario_templates_with_http_info_async(**kwargs)
            return response.data

    @validate_call
    async def list_scenario_templates_with_http_info_async(self, **kwargs) -> ApiResponse[ResourceListOfScenarioTemplateDefinition]:
            """[EARLY ACCESS] ListScenarioTemplates: [EARLY ACCESS] ListScenarioTemplates: List the pre-built scenario templates.  # noqa: E501
    ...
    @validate_call
    async def solve_reverse_stress_async(self, reverse_stress_request: ReverseStressRequest, **kwargs) -> ReverseStressResponse:
            """[EARLY ACCESS] SolveReverseStress: Solve a reverse stress test  # noqa: E501
            Solve for how far the market has to move to produce a given change in portfolio value.                A scenario supplies the direction the market moves in: which risk factors move, and in what  proportion to each other. The solve is over a single factor its shifts are multiplied by, so the  answer is a multiple of the scenario rather than a set of shifts in its own right - a factor of  two means twice every shift the scenario states.                A ladder of factors is valued first, all in one valuation so the rungs share market data  resolution, then the bracketing pair is interpolated and the interpolated factor valued again to  confirm it. The whole ladder is returned: a reverse stress is only meaningful where the change in  value moves in one direction with the factor, and the ladder is what shows whether it does.                The solve is refused rather than approximated where it cannot be trusted: a scenario carrying a  shift with no size to scale (a model option, or a market data routing override), a measure that  cannot be computed under a scenario, or a valuation that could not price every holding.  # noqa: E501
            ...
            response = await self.solve_reverse_stress_with_http_info_async(reverse_stress_request, **kwargs)
            return response.data

    @validate_call
    async def solve_reverse_stress_with_http_info_async(self, reverse_stress_request: ReverseStressRequest, **kwargs) -> ApiResponse[ReverseStressResponse]:
            """[EARLY ACCESS] SolveReverseStress: Solve a reverse stress test  # noqa: E501
