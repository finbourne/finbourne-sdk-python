...
class ExecutionsApi:
    ...
    @validate_call
    def delete_execution(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
    ...
    def delete_execution_with_http_info(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/executions/{scope}/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_execution(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Execution:
    ...
    def get_execution_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[Execution]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/executions/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_executions(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfExecution:
    ...
    @validate_call
    def upsert_executions(self, execution_set_request: Optional[ExecutionSetRequest] = None, **kwargs) -> ResourceListOfExecution:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def delete_execution_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            """[EARLY ACCESS] DeleteExecution: Delete execution  # noqa: E501
            Delete an execution. Deletion will be valid from the execution's creation datetime.  This means that the execution will no longer exist at any effective datetime from the asAt datetime of deletion.  # noqa: E501
    ...
    @validate_call
    async def get_execution_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Execution:
            """[EARLY ACCESS] GetExecution: Get Execution  # noqa: E501
            Fetch a Execution that matches the specified identifier  # noqa: E501
    ...
    @validate_call
    async def list_executions_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfExecution:
            """ListExecutions: List Executions  # noqa: E501
            Fetch the last pre-AsAt date version of each execution in scope (does not fetch the entire history).  # noqa: E501
    ...
    @validate_call
    async def upsert_executions_async(self, execution_set_request: Optional[ExecutionSetRequest] = None, **kwargs) -> ResourceListOfExecution:
            """UpsertExecutions: Upsert Execution  # noqa: E501
            Upsert; update existing executions with given ids, or create new executions otherwise.  # noqa: E501
