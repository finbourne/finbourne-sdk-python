...
class DerivedTransactionPortfoliosApi:
    ...
    @validate_call
    def create_derived_portfolio(self, scope: StrictStr, create_derived_transaction_portfolio_request: Optional[CreateDerivedTransactionPortfolioRequest] = None, **kwargs) -> Portfolio:
    ...
    def create_derived_portfolio_with_http_info(self, scope: StrictStr, create_derived_transaction_portfolio_request: Optional[CreateDerivedTransactionPortfolioRequest] = None, **kwargs) -> ApiResponse[Portfolio]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/derivedtransactionportfolios/{scope}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_derived_portfolio_details(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, **kwargs) -> DeletedEntityResponse:
    ...
    def delete_derived_portfolio_details_with_http_info(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/derivedtransactionportfolios/{scope}/{code}/details', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def create_derived_portfolio_async(self, scope: StrictStr, create_derived_transaction_portfolio_request: Optional[CreateDerivedTransactionPortfolioRequest] = None, **kwargs) -> Portfolio:
            """CreateDerivedPortfolio: Create derived portfolio  # noqa: E501
            Create a derived transaction portfolio from a parent transaction portfolio (which may itself be derived).  # noqa: E501
    ...
    @validate_call
    async def delete_derived_portfolio_details_async(self, scope: StrictStr, code: StrictStr, effective_at: Optional[StrictStr] = None, **kwargs) -> DeletedEntityResponse:
            """[EARLY ACCESS] DeleteDerivedPortfolioDetails: Delete derived portfolio details  # noqa: E501
            Delete all the portfolio details for a derived transaction portfolio.  # noqa: E501
