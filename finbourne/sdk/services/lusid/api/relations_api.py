...
class RelationsApi:
    ...
    def create_relation(self, scope: StrictStr, code: StrictStr, create_relation_request: CreateRelationRequest, effective_at: Optional[StrictStr] = None, **kwargs) -> CompleteRelation:
        ...
        response = self.create_relation_with_http_info(scope, code, create_relation_request, effective_at, **kwargs)
    ...
    def delete_relation(self, scope: StrictStr, code: StrictStr, delete_relation_request: DeleteRelationRequest, effective_at: Optional[StrictStr] = None, **kwargs) -> DeletedEntityResponse:
        ...
        response = self.delete_relation_with_http_info(scope, code, delete_relation_request, effective_at, **kwargs)
        return response.data
  ...
  # --- ASYNC API METHODS ---
    ...
    async def create_relation_async(self, scope: StrictStr, code: StrictStr, create_relation_request: CreateRelationRequest, effective_at: Optional[StrictStr] = None, **kwargs) -> CompleteRelation:
            ...
            response = await self.create_relation_with_http_info_async(scope, code, create_relation_request, effective_at, **kwargs)
            return response.data
    ...
    async def delete_relation_async(self, scope: StrictStr, code: StrictStr, delete_relation_request: DeleteRelationRequest, effective_at: Optional[StrictStr] = None, **kwargs) -> DeletedEntityResponse:
            ...
            response = await self.delete_relation_with_http_info_async(scope, code, delete_relation_request, effective_at, **kwargs)
            return response.data
