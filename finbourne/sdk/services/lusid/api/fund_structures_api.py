...
class FundStructuresApi:
    ...
    def create_fund_structure(self, scope: StrictStr, fund_structure_request: FundStructureRequest, **kwargs) -> FundStructure:
        ...
        response = self.create_fund_structure_with_http_info(scope, fund_structure_request, **kwargs)
        return response.data

    @validate_call
    def create_fund_structure_with_http_info(self, scope: StrictStr, fund_structure_request: FundStructureRequest, **kwargs) -> ApiResponse[FundStructure]:
        """[EXPERIMENTAL] CreateFundStructure: Create a Fund Structure.  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/fundstructures/{scope}', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    def get_fund_structure_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[FundStructure]:
        ...
        return self.sync_api_client.call_api(
            '/api/api/fundstructures/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
  ...
  # --- ASYNC API METHODS ---
    ...
    async def create_fund_structure_async(self, scope: StrictStr, fund_structure_request: FundStructureRequest, **kwargs) -> FundStructure:
            ...
            response = await self.create_fund_structure_with_http_info_async(scope, fund_structure_request, **kwargs)
            return response.data

    @validate_call
    async def create_fund_structure_with_http_info_async(self, scope: StrictStr, fund_structure_request: FundStructureRequest, **kwargs) -> ApiResponse[FundStructure]:
            """[EXPERIMENTAL] CreateFundStructure: Create a Fund Structure.  # noqa: E501
