...
class TransactionPortfoliosApi:
    ...
    @validate_call
    def override_virtual_transactions(self, scope: StrictStr, code: StrictStr, instrument_event_id: StrictStr, transaction_request: List[TransactionRequest], portfolio_effective_at: Optional[StrictStr] = None, preserve_properties: Optional[bool] = None, data_model_scope: Optional[StrictStr] = None, data_model_code: Optional[StrictStr] = None, **kwargs) -> OverrideVirtualTransactionsResponse:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def override_virtual_transactions_async(self, scope: StrictStr, code: StrictStr, instrument_event_id: StrictStr, transaction_request: List[TransactionRequest], portfolio_effective_at: Optional[StrictStr] = None, preserve_properties: Optional[bool] = None, data_model_scope: Optional[StrictStr] = None, data_model_code: Optional[StrictStr] = None, **kwargs) -> OverrideVirtualTransactionsResponse:
            """[EARLY ACCESS] OverrideVirtualTransactions: [EARLY ACCESS] Override virtual transactions  # noqa: E501
            Override virtual transactions generated by an instrument event with manually provided input transactions.  This will cancel the specified instrument event and upsert the provided transactions as replacements.  The replacement transactions will have the OverrideOfInstrumentEvent system property set and a source type of OverriddenVirtualTransaction.  # noqa: E501
