...
class ParticipationsApi:
    ...
    @validate_call
    def delete_participation(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
        ...
        response = self.delete_participation_with_http_info(scope, code, **kwargs)
        return response.data

    @validate_call
    def delete_participation_with_http_info(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
        """[EARLY ACCESS] DeleteParticipation: Delete participation  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/participations/{scope}/{code}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_participation(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Participation:
        ...
        response = self.get_participation_with_http_info(scope, code, as_at, property_keys, **kwargs)
        return response.data

    @validate_call
    def get_participation_with_http_info(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[Participation]:
        """[EARLY ACCESS] GetParticipation: Get Participation  # noqa: E501
        ...
        return self.sync_api_client.call_api(
            '/api/api/participations/{scope}/{code}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def list_participations(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfParticipation:
        ...
        response = self.list_participations_with_http_info(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
        return response.data

    @validate_call
    def list_participations_with_http_info(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfParticipation]:
        """[EARLY ACCESS] ListParticipations: List Participations  # noqa: E501
    ...
    @validate_call
    def upsert_participations(self, participation_set_request: Optional[ParticipationSetRequest] = None, **kwargs) -> ResourceListOfParticipation:
        ...
        response = self.upsert_participations_with_http_info(participation_set_request, **kwargs)
        return response.data

    @validate_call
    def upsert_participations_with_http_info(self, participation_set_request: Optional[ParticipationSetRequest] = None, **kwargs) -> ApiResponse[ResourceListOfParticipation]:
        """[EARLY ACCESS] UpsertParticipations: Upsert Participation  # noqa: E501
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def delete_participation_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            """[EARLY ACCESS] DeleteParticipation: Delete participation  # noqa: E501
            Delete an participation. Deletion will be valid from the participation's creation datetime.  This means that the participation will no longer exist at any effective datetime from the asAt datetime of deletion.  # noqa: E501
            ...
            response = await self.delete_participation_with_http_info_async(scope, code, **kwargs)
            return response.data

    @validate_call
    async def delete_participation_with_http_info_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> ApiResponse[DeletedEntityResponse]:
            """[EARLY ACCESS] DeleteParticipation: Delete participation  # noqa: E501
    ...
    @validate_call
    async def get_participation_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Participation:
            """[EARLY ACCESS] GetParticipation: Get Participation  # noqa: E501
            Fetch a Participation that matches the specified identifier  # noqa: E501
            ...
            response = await self.get_participation_with_http_info_async(scope, code, as_at, property_keys, **kwargs)
            return response.data

    @validate_call
    async def get_participation_with_http_info_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[Participation]:
            """[EARLY ACCESS] GetParticipation: Get Participation  # noqa: E501
    ...
    @validate_call
    async def list_participations_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfParticipation:
            """[EARLY ACCESS] ListParticipations: List Participations  # noqa: E501
            Fetch the last pre-AsAt date version of each Participation in scope (does not fetch the entire history).  # noqa: E501
            ...
            response = await self.list_participations_with_http_info_async(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
            return response.data

    @validate_call
    async def list_participations_with_http_info_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> ApiResponse[PagedResourceListOfParticipation]:
            """[EARLY ACCESS] ListParticipations: List Participations  # noqa: E501
    ...
    @validate_call
    async def upsert_participations_async(self, participation_set_request: Optional[ParticipationSetRequest] = None, **kwargs) -> ResourceListOfParticipation:
            """[EARLY ACCESS] UpsertParticipations: Upsert Participation  # noqa: E501
            Upsert; update existing participations with given ids, or create new participations otherwise.  # noqa: E501
            ...
            response = await self.upsert_participations_with_http_info_async(participation_set_request, **kwargs)
            return response.data

    @validate_call
    async def upsert_participations_with_http_info_async(self, participation_set_request: Optional[ParticipationSetRequest] = None, **kwargs) -> ApiResponse[ResourceListOfParticipation]:
            """[EARLY ACCESS] UpsertParticipations: Upsert Participation  # noqa: E501
