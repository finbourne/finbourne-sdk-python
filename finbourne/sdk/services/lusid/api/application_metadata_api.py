...
class ApplicationMetadataApi:
    ...
    @validate_call
    def get_latest_as_at(self, **kwargs) -> LatestAsAt:
        ...
        response = self.get_latest_as_at_with_http_info(**kwargs)
        return response.data

    @validate_call
    def get_latest_as_at_with_http_info(self, **kwargs) -> ApiResponse[LatestAsAt]:
        """[EXPERIMENTAL] GetLatestAsAt: Get latest AsAt  # noqa: E501
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def get_latest_as_at_async(self, **kwargs) -> LatestAsAt:
            """[EXPERIMENTAL] GetLatestAsAt: Get latest AsAt  # noqa: E501
            Get the latest asAt datetime of the system, i.e. the asAt datetime of the most recent write.  This is the asAt datetime that a request made without an explicit asAt resolves to.  # noqa: E501
            ...
            response = await self.get_latest_as_at_with_http_info_async(**kwargs)
            return response.data

    @validate_call
    async def get_latest_as_at_with_http_info_async(self, **kwargs) -> ApiResponse[LatestAsAt]:
            """[EXPERIMENTAL] GetLatestAsAt: Get latest AsAt  # noqa: E501
