...
class PlacementsApi:
    ...
    def delete_placement(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
        ...
        response = self.delete_placement_with_http_info(scope, code, **kwargs)
    ...
    def get_placement(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Placement:
        ...
        response = self.get_placement_with_http_info(scope, code, as_at, property_keys, **kwargs)
        return response.data
    ...
    def list_placements(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfPlacement:
        ...
        response = self.list_placements_with_http_info(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
        return response.data
    ...
    def upsert_placements(self, placement_set_request: Optional[PlacementSetRequest] = None, **kwargs) -> ResourceListOfPlacement:
        ...
        response = self.upsert_placements_with_http_info(placement_set_request, **kwargs)
        return response.data
  ...
  # --- ASYNC API METHODS ---
    ...
    async def delete_placement_async(self, scope: StrictStr, code: StrictStr, **kwargs) -> DeletedEntityResponse:
            ...
            response = await self.delete_placement_with_http_info_async(scope, code, **kwargs)
            return response.data
    ...
    async def get_placement_async(self, scope: StrictStr, code: StrictStr, as_at: Optional[datetime] = None, property_keys: Optional[List[str]] = None, **kwargs) -> Placement:
            ...
            response = await self.get_placement_with_http_info_async(scope, code, as_at, property_keys, **kwargs)
            return response.data
    ...
    async def list_placements_async(self, as_at: Optional[datetime] = None, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, property_keys: Optional[List[str]] = None, **kwargs) -> PagedResourceListOfPlacement:
            ...
            response = await self.list_placements_with_http_info_async(as_at, page, sort_by, limit, filter, property_keys, **kwargs)
            return response.data
    ...
    async def upsert_placements_async(self, placement_set_request: Optional[PlacementSetRequest] = None, **kwargs) -> ResourceListOfPlacement:
            ...
            response = await self.upsert_placements_with_http_info_async(placement_set_request, **kwargs)
            return response.data
