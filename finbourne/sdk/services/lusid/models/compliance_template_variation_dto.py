...
class ComplianceTemplateVariationDto(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ComplianceTemplateVariationDto:
        ...
        if not isinstance(obj, dict):
            return ComplianceTemplateVariationDto.model_validate(obj)

        _obj = ComplianceTemplateVariationDto.model_validate({
            "label": obj.get("label"),
...
ComplianceTemplateVariationDto.model_rebuild()
