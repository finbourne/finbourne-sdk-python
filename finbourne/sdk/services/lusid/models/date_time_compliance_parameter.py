...
class DateTimeComplianceParameter(ComplianceParameter):
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'DateTimeComplianceParameter' not in [ 
    ...
    def from_dict(cls, obj: dict) -> DateTimeComplianceParameter:
        ...
        if not isinstance(obj, dict):
            return DateTimeComplianceParameter.model_validate(obj)

        _obj = DateTimeComplianceParameter.model_validate({
...
DateTimeComplianceParameter.model_rebuild()
