...
class FinalisedValuationPoint(FundCalendarEntries):
    ...
    finalised_from_variant:  Optional[StrictStr] = Field(default=None,alias="finalisedFromVariant", description="The variant of the Estimate Valuation Point that was finalised to create the Finalised Valuation Point.") 
    ...
    __properties: ClassVar[List[str]] = ["fundCalendarEntriesType", "code", "finalisedFromVariant", "displayName", "description", "navTypeCode", "timelineId", "previousEntry", "effectiveAt", "asAt", "entryType", "status", "applyClearDown", "holdingsAsAtOverride", "valuationsAsAtOverride", "properties", "version", "href", "leaderNavTypeCode", "dateOfLastPcaScan"]
    ...
    def entry_type_validate_enum(cls, value):
        ...
        _allowed = ['FinalisedValuationPoint', 'FundEstimateValuationPoint', 'FundBookmark']
        if len(_allowed) != 1:
            return value
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.finalised_from_variant is None and "finalised_from_variant" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FinalisedValuationPoint:
        ...
        if not isinstance(obj, dict):
            return FinalisedValuationPoint.model_validate(obj)

        _obj = FinalisedValuationPoint.model_validate({
...
FinalisedValuationPoint.model_rebuild()
