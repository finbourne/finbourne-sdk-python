...
class ResourceListOfPortfolioCashFlow(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPortfolioCashFlow:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPortfolioCashFlow.model_validate(obj)

        _obj = ResourceListOfPortfolioCashFlow.model_validate({
            "values": [PortfolioCashFlow.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPortfolioCashFlow.model_rebuild()
