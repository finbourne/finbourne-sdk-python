...
class EquitySwap(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "code", "equityFlowConventions", "fundingLeg", "includeDividends", "initialPrice", "notionalReset", "quantity", "underlyingIdentifier", "equitySwapDividendPaymentTiming", "additionalPayments", "timeZoneConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.equity_flow_conventions:
            _dict['equityFlowConventions'] = self.equity_flow_conventions.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of funding_leg
        if self.funding_leg:
            _dict['fundingLeg'] = self.funding_leg.to_dict(by_alias=by_alias)
        ...
        if self.equity_swap_dividend_payment_timing is None and "equity_swap_dividend_payment_timing" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> EquitySwap:
        ...
        if not isinstance(obj, dict):
            return EquitySwap.model_validate(obj)

        _obj = EquitySwap.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "code": obj.get("code"),
            "equity_flow_conventions": FlowConventions.from_dict(_v) if (_v := obj.get("equityFlowConventions")) is not None else None,
            "funding_leg": InstrumentLeg.from_dict(_v) if (_v := obj.get("fundingLeg")) is not None else None,
