...
class TriggerEvent(InstrumentEvent):
    ...
    trigger_date: datetime = Field(description="The date the trigger happens at.", alias="triggerDate")
    maturity_date: datetime = Field(description="The date the trigger takes effect.", alias="maturityDate")
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "level", "triggerType", "triggerDirection", "triggerDate", "maturityDate"]
    ...
    def from_dict(cls, obj: dict) -> TriggerEvent:
        ...
        if not isinstance(obj, dict):
            return TriggerEvent.model_validate(obj)

        _obj = TriggerEvent.model_validate({
