...
class OptionExercisePhysicalEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "exerciseDate", "deliveryDate", "exerciseType", "maturityDate", "moneyness", "newInstrument", "optionExerciseElections", "optionType", "startDate", "strikeCurrency", "strikePerUnit", "underlyingValuePerUnit", "unitsRatio"]
    ...
    def from_dict(cls, obj: dict) -> OptionExercisePhysicalEvent:
        ...
        if not isinstance(obj, dict):
            return OptionExercisePhysicalEvent.model_validate(obj)

        _obj = OptionExercisePhysicalEvent.model_validate({
...
OptionExercisePhysicalEvent.model_rebuild()
