...
class ResourceListOfProcessedCommand(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfProcessedCommand:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfProcessedCommand.model_validate(obj)

        _obj = ResourceListOfProcessedCommand.model_validate({
            "values": [ProcessedCommand.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfProcessedCommand.model_rebuild()
