...
class DecimalListComplianceParameter(ComplianceParameter):
    ...
    def from_dict(cls, obj: dict) -> DecimalListComplianceParameter:
        ...
        if not isinstance(obj, dict):
            return DecimalListComplianceParameter.model_validate(obj)

        _obj = DecimalListComplianceParameter.model_validate({
...
DecimalListComplianceParameter.model_rebuild()
