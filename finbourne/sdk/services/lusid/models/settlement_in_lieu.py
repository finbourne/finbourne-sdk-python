...
class SettlementInLieu(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["originalSettlementCurrency", "amount"]
    ...
    def from_dict(cls, obj: dict) -> SettlementInLieu:
        ...
        if not isinstance(obj, dict):
            return SettlementInLieu.model_validate(obj)

        _obj = SettlementInLieu.model_validate({
            "original_settlement_currency": obj.get("originalSettlementCurrency"),
            "amount": obj.get("amount")
        })
        return _obj

SettlementInLieu.model_rebuild()
