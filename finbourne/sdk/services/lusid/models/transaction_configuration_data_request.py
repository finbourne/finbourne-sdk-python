...
class TransactionConfigurationDataRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> TransactionConfigurationDataRequest:
        ...
        if not isinstance(obj, dict):
            return TransactionConfigurationDataRequest.model_validate(obj)

        _obj = TransactionConfigurationDataRequest.model_validate({
...
TransactionConfigurationDataRequest.model_rebuild()
