...
class StagedModificationsRequestedChangeInterval(BaseModel):
    ...
    """
    attribute_name:  Optional[StrictStr] = Field(default=None,alias="attributeName", description="Name of the property the change applies to.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.as_at_basis is None and "as_at_basis" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> StagedModificationsRequestedChangeInterval:
        ...
        if not isinstance(obj, dict):
            return StagedModificationsRequestedChangeInterval.model_validate(obj)
...
StagedModificationsRequestedChangeInterval.model_rebuild()
