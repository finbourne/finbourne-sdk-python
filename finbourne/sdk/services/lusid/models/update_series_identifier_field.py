...
class UpdateSeriesIdentifierField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fieldName", "displayName", "description", "dataTypeId", "required"]
    ...
    def from_dict(cls, obj: dict) -> UpdateSeriesIdentifierField:
        ...
        if not isinstance(obj, dict):
            return UpdateSeriesIdentifierField.model_validate(obj)

        _obj = UpdateSeriesIdentifierField.model_validate({
...
UpdateSeriesIdentifierField.model_rebuild()
