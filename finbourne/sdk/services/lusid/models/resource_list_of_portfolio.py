...
class ResourceListOfPortfolio(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPortfolio:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPortfolio.model_validate(obj)

        _obj = ResourceListOfPortfolio.model_validate({
            "values": [Portfolio.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPortfolio.model_rebuild()
