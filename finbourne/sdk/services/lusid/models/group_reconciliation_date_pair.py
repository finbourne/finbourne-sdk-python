...
class GroupReconciliationDatePair(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["effectiveAt", "asAt"]
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationDatePair:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationDatePair.model_validate(obj)

        _obj = GroupReconciliationDatePair.model_validate({
            "effective_at": obj.get("effectiveAt"),
            "as_at": obj.get("asAt")
        })
        return _obj

GroupReconciliationDatePair.model_rebuild()
