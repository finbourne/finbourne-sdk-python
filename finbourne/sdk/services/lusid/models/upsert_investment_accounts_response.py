...
class UpsertInvestmentAccountsResponse(BaseModel):
    ...
    values: Optional[Dict[str, InvestmentAccount]] = Field(default=None, description="The investment accounts which have been successfully updated or created.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The investment accounts that could not be updated or created or were left unchanged without error along with a reason for their failure.")
    ...
    def from_dict(cls, obj: dict) -> UpsertInvestmentAccountsResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertInvestmentAccountsResponse.model_validate(obj)

        _obj = UpsertInvestmentAccountsResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
UpsertInvestmentAccountsResponse.model_rebuild()
