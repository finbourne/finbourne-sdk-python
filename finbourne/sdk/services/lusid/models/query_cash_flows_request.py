...
class QueryCashFlowsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asAt", "windowStart", "windowEnd", "portfolioEntityIds", "recipeId", "effectiveAt", "cashFlowCalculationVersion"]
    ...
    def from_dict(cls, obj: dict) -> QueryCashFlowsRequest:
        ...
        if not isinstance(obj, dict):
            return QueryCashFlowsRequest.model_validate(obj)

        _obj = QueryCashFlowsRequest.model_validate({
            "as_at": obj.get("asAt"),
...
QueryCashFlowsRequest.model_rebuild()
