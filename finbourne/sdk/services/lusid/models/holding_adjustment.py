...
class HoldingAdjustment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instrumentIdentifiers", "instrumentScope", "instrumentUid", "subHoldingKeys", "properties", "taxLots", "currency", "custodianAccountId"]
    ...
    def from_dict(cls, obj: dict) -> HoldingAdjustment:
        ...
        if not isinstance(obj, dict):
            return HoldingAdjustment.model_validate(obj)

        _obj = HoldingAdjustment.model_validate({
...
HoldingAdjustment.model_rebuild()
