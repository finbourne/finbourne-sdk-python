...
class UpsertTransactionPropertiesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "version", "properties", "metadata", "links"]
    ...
    def from_dict(cls, obj: dict) -> UpsertTransactionPropertiesResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertTransactionPropertiesResponse.model_validate(obj)

        _obj = UpsertTransactionPropertiesResponse.model_validate({
            "href": obj.get("href"),
...
UpsertTransactionPropertiesResponse.model_rebuild()
