...
class CalendarDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "calendars"]
    ...
    def from_dict(cls, obj: dict) -> CalendarDependency:
        ...
        if not isinstance(obj, dict):
            return CalendarDependency.model_validate(obj)

        _obj = CalendarDependency.model_validate({
...
CalendarDependency.model_rebuild()
