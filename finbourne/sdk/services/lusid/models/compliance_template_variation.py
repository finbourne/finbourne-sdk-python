...
class ComplianceTemplateVariation(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.accepted_address_keys:
            _dict['acceptedAddressKeys'] = self.accepted_address_keys.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> ComplianceTemplateVariation:
        ...
        if not isinstance(obj, dict):
            return ComplianceTemplateVariation.model_validate(obj)
...
ComplianceTemplateVariation.model_rebuild()
