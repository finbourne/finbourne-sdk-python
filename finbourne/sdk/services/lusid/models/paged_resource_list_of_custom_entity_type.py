...
class PagedResourceListOfCustomEntityType(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfCustomEntityType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfCustomEntityType:
        """Create an instance of PagedResourceListOfCustomEntityType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfCustomEntityType.model_validate(obj)

        _obj = PagedResourceListOfCustomEntityType.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [CustomEntityType.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

PagedResourceListOfCustomEntityType.model_rebuild()
