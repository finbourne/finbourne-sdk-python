...
class CdsIndex(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "flowConventions", "couponRate", "identifiers", "basket", "conventionName", "notional", "isNonStandard", "additionalPayments", "timeZoneConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.basket:
            _dict['basket'] = self.basket.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CdsIndex:
        ...
        if not isinstance(obj, dict):
            return CdsIndex.model_validate(obj)

        _obj = CdsIndex.model_validate({
            ...
            "basket": Basket.from_dict(_v) if (_v := obj.get("basket")) is not None else None,
