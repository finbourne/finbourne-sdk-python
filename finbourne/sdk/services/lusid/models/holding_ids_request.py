...
class HoldingIdsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["holdingIds"]
    ...
    def from_dict(cls, obj: dict) -> HoldingIdsRequest:
        ...
        if not isinstance(obj, dict):
            return HoldingIdsRequest.model_validate(obj)

        _obj = HoldingIdsRequest.model_validate({
            "holding_ids": obj.get("holdingIds")
        })
        return _obj

HoldingIdsRequest.model_rebuild()
