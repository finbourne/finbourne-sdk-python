...
class RoundingConvention(BaseModel):
    ...
    rounding_target:  Optional[StrictStr] = Field(default=None,alias="roundingTarget", description="The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows.") 
    rounding_type:  Optional[StrictStr] = Field(default=None,alias="roundingType", description="The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest.") 
    __properties: ClassVar[List[str]] = ["faceValue", "precision", "roundingTarget", "roundingType"]
