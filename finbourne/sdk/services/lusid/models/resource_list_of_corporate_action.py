...
class ResourceListOfCorporateAction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfCorporateAction:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfCorporateAction.model_validate(obj)

        _obj = ResourceListOfCorporateAction.model_validate({
            "values": [CorporateAction.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfCorporateAction.model_rebuild()
