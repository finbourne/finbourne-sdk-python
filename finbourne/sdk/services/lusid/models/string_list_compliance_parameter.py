...
class StringListComplianceParameter(ComplianceParameter):
    """
    ...
    def compliance_parameter_type_validate_enum(cls, value):
        ...
        if 'StringListComplianceParameter' not in [ 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StringListComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StringListComplianceParameter:
        """Create an instance of StringListComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StringListComplianceParameter.model_validate(obj)

        _obj = StringListComplianceParameter.model_validate({
...
StringListComplianceParameter.model_rebuild()
