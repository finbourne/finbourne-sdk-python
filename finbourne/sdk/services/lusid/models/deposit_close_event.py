...
class DepositCloseEvent(InstrumentEvent):
    ...
    """
    effective_date: Optional[datetime] = Field(default=None, description="Date on which the deposit is terminated.", alias="effectiveDate")
    ...
    def from_dict(cls, obj: dict) -> DepositCloseEvent:
        ...
        if not isinstance(obj, dict):
            return DepositCloseEvent.model_validate(obj)

        _obj = DepositCloseEvent.model_validate({
...
DepositCloseEvent.model_rebuild()
