...
class OptionExerciseCashEvent(InstrumentEvent):
    ...
    moneyness:  Optional[StrictStr] = Field(default=None,alias="moneyness", description="The moneyness of the option e.g. InTheMoney, OutOfTheMoney.    Supported string (enumeration) values are: [InTheMoney, OutOfTheMoney, AtTheMoney].") 
