...
if TYPE_CHECKING:
    ...
    from finbourne.sdk.services.lusid.models import (
        AccumulationEvent, AdjustGlobalCommitmentEvent, AmendCommitmentEvent, AmortisationEvent, BankruptcyEvent, BondCouponEvent, BondDefaultEvent, BondForwardCashSettlementEvent, BondForwardTerminationEvent, BondOptionTerminationEvent, BondPrincipalEvent, BonusIssueEvent, CallOnIntermediateSecuritiesEvent, CancelSwapEvent, CapitalCallEvent, CapitalDistributionEvent, CapitalGainsDistributionEvent, CapletFloorletCashFlowEvent, CashDividendEvent, CashFlowEvent, CdsCreditEvent, CdxCreditEvent, ChangeEvent, ClassActionEvent, CloseEvent, CommodityCalendarSwapCashFlowEvent, CommodityForwardCashSettlementEvent, CommodityForwardPhysicalSettlementEvent, ConsentEvent, ContractInitialisationEvent, ConversionEvent, CreditPremiumCashFlowEvent, DelistingEvent, DepositCloseEvent, DepositInterestPaymentEvent, DepositRollEvent, DepositSweepEvent, DividendOptionEvent, DividendReinvestmentEvent, DividendSuspensionEvent, DrawdownEvent, DrawingEvent, DutchAuctionEvent, EarlyCloseOutEvent, EarlyRedemptionEvent, ExchangeOfferEvent, ExerciseEvent, ExpiryEvent, FlexibleRepoCashFlowEvent, FlexibleRepoCollateralEvent, FlexibleRepoFullClosureEvent, FlexibleRepoInterestPaymentEvent, FlexibleRepoPartialClosureEvent, FundDistributionEvent, FutureExpiryEvent, FutureMarkToMarketEvent, FxForwardSettlementEvent, InformationalErrorEvent, InformationalEvent, InterestPaymentEvent, IntermediateSecuritiesDistributionEvent, LiquidationPaymentEvent, LoanFacilityContractRolloverEvent, LoanFacilityDelayedCompensationPaymentEvent, LoanInterestCapitalisationEvent, LoanInterestRepaymentEvent, LoanPrincipalRepaymentEvent, MaturityEvent, MbsCouponEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, MbsPrincipalEvent, MbsPrincipalWriteOffEvent, MergerEvent, NavReportEvent, OpenEvent, OptionExerciseCashEvent, OptionExercisePhysicalEvent, PariPassuEvent, PartialDefeasanceEvent, PaymentInKindEvent, PikBondCashCouponEvent, PikBondCouponEvent, PikBondInterestCapitalisationEvent, PikBondInterestEvent, PikBondPrincipalEvent, PriorityIssueEvent, ProtectionPayoutCashFlowEvent, PutRedemptionEvent, RawVendorEvent, RepoCashFlowEvent, RepoPartialClosureEvent, RepurchaseOfferEvent, ResetEvent, ReverseStockSplitEvent, ScripDividendEvent, SecurityWriteOffEvent, SpinOffEvent, StockDividendEvent, StockSplitEvent, SwapCashFlowEvent, SwapPrincipalEvent, TenderEvent, TermDepositInterestEvent, TermDepositPrincipalEvent, TerminationEvent, TransitionEvent, TriggerEvent, UpdateDepositAmountEvent, WarrantsExerciseEvent, WorthlessEvent)
...
class InstrumentEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType"]
    ...
    __discriminator_property_name: ClassVar[str] = 'instrumentEventType'
