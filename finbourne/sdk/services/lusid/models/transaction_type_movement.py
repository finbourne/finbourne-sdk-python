...
class TransactionTypeMovement(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["movementTypes", "side", "direction", "properties", "mappings", "name", "movementOptions", "settlementDateOverride", "condition", "settlementMode", "calculateTradeDateToSettlementFxPnL"]
