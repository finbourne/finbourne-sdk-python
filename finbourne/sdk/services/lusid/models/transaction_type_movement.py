...
class TransactionTypeMovement(BaseModel):
    ...
    account_selector:  Optional[StrictStr] = Field(default=None,alias="accountSelector", description="An optional selector expression used to identify the specific account this movement targets. E.g. From/To. Available values: From, To.") 
    ...
    def from_dict(cls, obj: dict) -> TransactionTypeMovement:
        ...
        _obj = TransactionTypeMovement.model_validate({
            ...
            "mappings": [TransactionTypePropertyMapping.from_dict(_item) for _item in _v] if (_v := obj.get("mappings")) is not None else None,
            "name": obj.get("name"),
