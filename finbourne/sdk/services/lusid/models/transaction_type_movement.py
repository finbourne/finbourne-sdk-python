...
class TransactionTypeMovement(BaseModel):
    ...
    account_selector:  Optional[StrictStr] = Field(default=None,alias="accountSelector", description="An optional selector expression used to identify the specific account this movement targets. E.g. From/To.") 
