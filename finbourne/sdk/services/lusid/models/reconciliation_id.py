...
class ReconciliationId(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.scope:
            _dict['scope'] = self.scope.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> ReconciliationId:
        ...
        if not isinstance(obj, dict):
            return ReconciliationId.model_validate(obj)

        _obj = ReconciliationId.model_validate({
            "scope": DataScope.from_dict(_v) if (_v := obj.get("scope")) is not None else None,
            "identifier": obj.get("identifier")
        })
        return _obj

ReconciliationId.model_rebuild()
