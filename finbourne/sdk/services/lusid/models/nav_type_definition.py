...
class NavTypeDefinition(BaseModel):
    ...
    leader_nav_type_code:  Optional[StrictStr] = Field(default=None,alias="leaderNavTypeCode") 
    transaction_template_scope:  Optional[StrictStr] = Field(default=None,alias="transactionTemplateScope") 
