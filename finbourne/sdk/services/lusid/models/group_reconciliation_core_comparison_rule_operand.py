...
class GroupReconciliationCoreComparisonRuleOperand(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationCoreComparisonRuleOperand:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationCoreComparisonRuleOperand.model_validate(obj)

        _obj = GroupReconciliationCoreComparisonRuleOperand.model_validate({
            "key": obj.get("key"),
            "operation": obj.get("operation")
        })
        return _obj

GroupReconciliationCoreComparisonRuleOperand.model_rebuild()
