...
class StagedModificationStagingRule(BaseModel):
    ...
    """
    staging_rule_set_id:  Optional[StrictStr] = Field(default=None,alias="stagingRuleSetId", description="System generated unique id for the staging rule set.") 
    ...
    def to_dict(self):
        ...
        if self.staging_rule_set_id is None and "staging_rule_set_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> StagedModificationStagingRule:
        ...
        if not isinstance(obj, dict):
            return StagedModificationStagingRule.model_validate(obj)

        _obj = StagedModificationStagingRule.model_validate({
...
StagedModificationStagingRule.model_rebuild()
