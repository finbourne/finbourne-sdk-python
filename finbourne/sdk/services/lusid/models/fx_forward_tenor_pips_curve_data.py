...
class FxForwardTenorPipsCurveData(ComplexMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "baseDate", "domCcy", "fgnCcy", "tenors", "pipRates", "lineage", "marketDataOptions", "calendars", "spotDaysCalculationType", "version"]
    ...
    def from_dict(cls, obj: dict) -> FxForwardTenorPipsCurveData:
        ...
        _obj = FxForwardTenorPipsCurveData.model_validate({
            ...
            "calendars": [FxTenorConvention.from_dict(_item) for _item in _v] if (_v := obj.get("calendars")) is not None else None,
