...
class UpdateAmortisationRuleSetDetailsRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdateAmortisationRuleSetDetailsRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateAmortisationRuleSetDetailsRequest.model_validate(obj)

        _obj = UpdateAmortisationRuleSetDetailsRequest.model_validate({
            "display_name": obj.get("displayName"),
            "description": obj.get("description")
        })
        return _obj

UpdateAmortisationRuleSetDetailsRequest.model_rebuild()
