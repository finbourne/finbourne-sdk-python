...
class PagedResourceListOfComplianceRunInfoV2(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfComplianceRunInfoV2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfComplianceRunInfoV2:
        """Create an instance of PagedResourceListOfComplianceRunInfoV2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfComplianceRunInfoV2.model_validate(obj)

        _obj = PagedResourceListOfComplianceRunInfoV2.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ComplianceRunInfoV2.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

PagedResourceListOfComplianceRunInfoV2.model_rebuild()
