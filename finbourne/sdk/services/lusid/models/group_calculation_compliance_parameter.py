...
class GroupCalculationComplianceParameter(ComplianceParameter):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupCalculationComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupCalculationComplianceParameter:
        """Create an instance of GroupCalculationComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupCalculationComplianceParameter.model_validate(obj)

        _obj = GroupCalculationComplianceParameter.model_validate({
...
GroupCalculationComplianceParameter.model_rebuild()
