...
class StockDividendEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "announcementDate", "exDate", "paymentDate", "recordDate", "fractionalUnitsCashPrice", "fractionalUnitsCashCurrency", "fractionalUnitsRoundingConvention", "fractionalUnitsDecimalPlaces", "unitsRatio"]
    ...
    def from_dict(cls, obj: dict) -> StockDividendEvent:
        ...
        if not isinstance(obj, dict):
            return StockDividendEvent.model_validate(obj)

        _obj = StockDividendEvent.model_validate({
...
StockDividendEvent.model_rebuild()
