...
class InformationalErrorEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "errorDetail", "errorReason", "effectiveAt"]
    ...
    def from_dict(cls, obj: dict) -> InformationalErrorEvent:
        ...
        if not isinstance(obj, dict):
            return InformationalErrorEvent.model_validate(obj)

        _obj = InformationalErrorEvent.model_validate({
...
InformationalErrorEvent.model_rebuild()
