...
class BatchUpsertPropertyDefinitionPropertiesResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> BatchUpsertPropertyDefinitionPropertiesResponse:
        ...
        if not isinstance(obj, dict):
            return BatchUpsertPropertyDefinitionPropertiesResponse.model_validate(obj)

        _obj = BatchUpsertPropertyDefinitionPropertiesResponse.model_validate({
            "values": dict(
...
BatchUpsertPropertyDefinitionPropertiesResponse.model_rebuild()
