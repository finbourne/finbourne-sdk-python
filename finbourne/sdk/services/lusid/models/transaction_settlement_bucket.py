...
class TransactionSettlementBucket(BaseModel):
    ...
    configured_settlement:  Optional[StrictStr] = Field(default=None,alias="configuredSettlement", description="The effective method of settlement for the settlement bucket. This reflects any transaction-level settlement method overrides, falling back to the portfolio's SettlementConfiguration if no override applies. Available values: Automatic, Instructed, NotApplicable.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.configured_settlement is None and "configured_settlement" in self.model_fields_set:
            _dict['configuredSettlement'] = None

        # set to None if settlement_instructions (nullable) is None
        # and model_fields_set contains the field
        if self.settlement_instructions is None and "settlement_instructions" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> TransactionSettlementBucket:
        ...
        if not isinstance(obj, dict):
            return TransactionSettlementBucket.model_validate(obj)

        _obj = TransactionSettlementBucket.model_validate({
...
TransactionSettlementBucket.model_rebuild()
