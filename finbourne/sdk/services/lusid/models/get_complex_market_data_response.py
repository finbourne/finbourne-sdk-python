...
class GetComplexMarketDataResponse(BaseModel):
    ...
    values: Optional[Dict[str, ComplexMarketData]] = Field(default=None, description="The set of values that were successfully retrieved.")
    ...
    def from_dict(cls, obj: dict) -> GetComplexMarketDataResponse:
        ...
        if not isinstance(obj, dict):
            return GetComplexMarketDataResponse.model_validate(obj)

        _obj = GetComplexMarketDataResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
                (_k, ComplexMarketData.from_dict(_v))
...
GetComplexMarketDataResponse.model_rebuild()
