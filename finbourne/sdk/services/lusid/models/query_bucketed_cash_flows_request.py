...
class QueryBucketedCashFlowsRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.border_configuration:
            _dict['borderConfiguration'] = self.border_configuration.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.bucketing_tenors is None and "bucketing_tenors" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> QueryBucketedCashFlowsRequest:
        ...
        if not isinstance(obj, dict):
            return QueryBucketedCashFlowsRequest.model_validate(obj)

        _obj = QueryBucketedCashFlowsRequest.model_validate({
            "as_at": obj.get("asAt"),
            ...
            "border_configuration": BucketBorderConfiguration.from_dict(_v) if (_v := obj.get("borderConfiguration")) is not None else None,
            "starting_balance": obj.get("startingBalance")
        })
        return _obj

QueryBucketedCashFlowsRequest.model_rebuild()
