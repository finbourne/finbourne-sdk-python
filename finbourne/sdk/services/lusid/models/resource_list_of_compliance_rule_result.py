...
class ResourceListOfComplianceRuleResult(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfComplianceRuleResult:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfComplianceRuleResult.model_validate(obj)

        _obj = ResourceListOfComplianceRuleResult.model_validate({
            "values": [ComplianceRuleResult.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfComplianceRuleResult.model_rebuild()
