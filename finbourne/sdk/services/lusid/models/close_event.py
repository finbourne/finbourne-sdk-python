...
class CloseEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "startDate", "endDate"]
    ...
    def from_dict(cls, obj: dict) -> CloseEvent:
        ...
        if not isinstance(obj, dict):
            return CloseEvent.model_validate(obj)

        _obj = CloseEvent.model_validate({
