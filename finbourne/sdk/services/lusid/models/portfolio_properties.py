...
class PortfolioProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "properties", "version", "stagedModifications", "links"]
    ...
    def from_dict(cls, obj: dict) -> PortfolioProperties:
        ...
        if not isinstance(obj, dict):
            return PortfolioProperties.model_validate(obj)

        _obj = PortfolioProperties.model_validate({
            "href": obj.get("href"),
            "properties": dict(
...
PortfolioProperties.model_rebuild()
