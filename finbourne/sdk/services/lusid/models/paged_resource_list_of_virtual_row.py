...
class PagedResourceListOfVirtualRow(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfVirtualRow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfVirtualRow:
        """Create an instance of PagedResourceListOfVirtualRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfVirtualRow.model_validate(obj)

        _obj = PagedResourceListOfVirtualRow.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [VirtualRow.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

PagedResourceListOfVirtualRow.model_rebuild()
