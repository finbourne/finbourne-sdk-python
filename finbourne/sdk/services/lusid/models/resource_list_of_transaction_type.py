...
class ResourceListOfTransactionType(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfTransactionType:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfTransactionType.model_validate(obj)

        _obj = ResourceListOfTransactionType.model_validate({
            "values": [TransactionType.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfTransactionType.model_rebuild()
