...
class CreateTransactionPortfolioRequest(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="A description for the transaction portfolio.") 
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "code", "created", "baseCurrency", "corporateActionSourceId", "accountingMethod", "subHoldingKeys", "properties", "instrumentScopes", "amortisationMethod", "transactionTypeScope", "cashGainLossCalculationDate", "instrumentEventConfiguration", "amortisationRuleSetId", "taxRuleSetScope", "settlementConfiguration"]
    ...
    def from_dict(cls, obj: dict) -> CreateTransactionPortfolioRequest:
        ...
        if not isinstance(obj, dict):
            return CreateTransactionPortfolioRequest.model_validate(obj)

        _obj = CreateTransactionPortfolioRequest.model_validate({
...
CreateTransactionPortfolioRequest.model_rebuild()
