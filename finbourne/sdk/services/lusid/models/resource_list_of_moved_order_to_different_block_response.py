...
class ResourceListOfMovedOrderToDifferentBlockResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfMovedOrderToDifferentBlockResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfMovedOrderToDifferentBlockResponse.model_validate(obj)

        _obj = ResourceListOfMovedOrderToDifferentBlockResponse.model_validate({
            "values": [MovedOrderToDifferentBlockResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfMovedOrderToDifferentBlockResponse.model_rebuild()
