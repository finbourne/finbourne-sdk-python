...
class CorporateActionTransitionComponentRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CorporateActionTransitionComponentRequest:
        ...
        if not isinstance(obj, dict):
            return CorporateActionTransitionComponentRequest.model_validate(obj)

        _obj = CorporateActionTransitionComponentRequest.model_validate({
...
CorporateActionTransitionComponentRequest.model_rebuild()
