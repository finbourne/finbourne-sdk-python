...
class GroupFilterStep(ComplianceStep):
    ...
    __properties: ClassVar[List[str]] = ["complianceStepType", "label", "limitCheckParameters"]
    ...
    def from_dict(cls, obj: dict) -> GroupFilterStep:
        ...
        if not isinstance(obj, dict):
            return GroupFilterStep.model_validate(obj)

        _obj = GroupFilterStep.model_validate({
