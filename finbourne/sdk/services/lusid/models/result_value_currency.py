...
class ResultValueCurrency(ResultValue):
    ...
    """
    value:  Optional[StrictStr] = Field(default=None,alias="value", description="The value itself") 
    ...
    __properties: ClassVar[List[str]] = ["resultValueType", "value"]
    ...
    def from_dict(cls, obj: dict) -> ResultValueCurrency:
        ...
        if not isinstance(obj, dict):
            return ResultValueCurrency.model_validate(obj)

        _obj = ResultValueCurrency.model_validate({
...
ResultValueCurrency.model_rebuild()
