...
class ComplexMarketDataId(BaseModel):
    ...
    price_source:  Optional[StrictStr] = Field(default=None,alias="priceSource", description="The source or originator of the complex market data, e.g. a bank or financial institution.") 
    ...
    def from_dict(cls, obj: dict) -> ComplexMarketDataId:
        ...
        if not isinstance(obj, dict):
            return ComplexMarketDataId.model_validate(obj)

        _obj = ComplexMarketDataId.model_validate({
...
ComplexMarketDataId.model_rebuild()
