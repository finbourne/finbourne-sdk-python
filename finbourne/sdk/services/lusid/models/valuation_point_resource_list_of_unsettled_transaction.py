...
class ValuationPointResourceListOfUnsettledTransaction(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationPointResourceListOfUnsettledTransaction:
        """Create an instance of ValuationPointResourceListOfUnsettledTransaction from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfUnsettledTransaction:
        """Create an instance of ValuationPointResourceListOfUnsettledTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValuationPointResourceListOfUnsettledTransaction.model_validate(obj)

        _obj = ValuationPointResourceListOfUnsettledTransaction.model_validate({
            "start_valuation_point": DiaryEntry.from_dict(_v) if (_v := obj.get("startValuationPoint")) is not None else None,
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [UnsettledTransaction.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfUnsettledTransaction.model_rebuild()
