...
class AppendFxForwardTenorPipsCurveData(AppendMarketData):
    ...
    def from_dict(cls, obj: dict) -> AppendFxForwardTenorPipsCurveData:
        ...
        if not isinstance(obj, dict):
            return AppendFxForwardTenorPipsCurveData.model_validate(obj)

        _obj = AppendFxForwardTenorPipsCurveData.model_validate({
...
AppendFxForwardTenorPipsCurveData.model_rebuild()
