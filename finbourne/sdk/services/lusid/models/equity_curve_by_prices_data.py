...
class EquityCurveByPricesData(ComplexMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "baseDate", "dates", "lineage", "prices", "marketDataOptions", "version"]
    ...
    def from_dict(cls, obj: dict) -> EquityCurveByPricesData:
        ...
        if not isinstance(obj, dict):
            return EquityCurveByPricesData.model_validate(obj)

        _obj = EquityCurveByPricesData.model_validate({
...
EquityCurveByPricesData.model_rebuild()
