...
class AmortisationRuleSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "id", "displayName", "description", "rulesInterval", "version", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.rules_interval:
            _dict['rulesInterval'] = self.rules_interval.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> AmortisationRuleSet:
        ...
        _obj = AmortisationRuleSet.model_validate({
            ...
            "rules_interval": RulesInterval.from_dict(_v) if (_v := obj.get("rulesInterval")) is not None else None,
