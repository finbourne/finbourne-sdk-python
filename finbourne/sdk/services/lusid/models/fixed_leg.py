...
class FixedLeg(InstrumentLeg):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "legDefinition", "notional", "overrides", "timeZoneConventions"]
    ...
    def from_dict(cls, obj: dict) -> FixedLeg:
        ...
        if not isinstance(obj, dict):
            return FixedLeg.model_validate(obj)

        _obj = FixedLeg.model_validate({
