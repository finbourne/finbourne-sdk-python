...
class UpdateRelationalDatasetDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "applicableEntityTypes", "fieldSchema"]
    ...
    def from_dict(cls, obj: dict) -> UpdateRelationalDatasetDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateRelationalDatasetDefinitionRequest.model_validate(obj)

        _obj = UpdateRelationalDatasetDefinitionRequest.model_validate({
...
UpdateRelationalDatasetDefinitionRequest.model_rebuild()
