...
class ConsentAndExchangeElection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["electionKey", "isDefault", "isChosen", "unitsRatio"]
    ...
    def from_dict(cls, obj: dict) -> ConsentAndExchangeElection:
        ...
        if not isinstance(obj, dict):
            return ConsentAndExchangeElection.model_validate(obj)

        _obj = ConsentAndExchangeElection.model_validate({
...
ConsentAndExchangeElection.model_rebuild()
