...
class ConsentDeniedElection(BaseModel):
    """
    Election to deny consent to the proposed action (CONN).  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConsentDeniedElection:
        """Create an instance of ConsentDeniedElection from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConsentDeniedElection:
        """Create an instance of ConsentDeniedElection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsentDeniedElection.model_validate(obj)

        _obj = ConsentDeniedElection.model_validate({
...
ConsentDeniedElection.model_rebuild()
