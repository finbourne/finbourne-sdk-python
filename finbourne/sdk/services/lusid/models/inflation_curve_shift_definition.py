...
class InflationCurveShiftDefinition(ScenarioShiftDefinition):
    ...
    __properties: ClassVar[List[str]] = ["scenarioShiftType", "index", "amount", "startTenor", "endTenor", "shiftType", "scale", "pivotTenor", "windowBounds", "minimumAmountBps", "applyWhenValue"]
