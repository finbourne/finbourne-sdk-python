...
class InstrumentEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingInstrument", "deletedInstrument", "previewedStatus", "previewedInstrument", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.prevailing_instrument:
            _dict['prevailingInstrument'] = self.prevailing_instrument.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of deleted_instrument
        if self.deleted_instrument:
            _dict['deletedInstrument'] = self.deleted_instrument.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of previewed_instrument
        if self.previewed_instrument:
            _dict['previewedInstrument'] = self.previewed_instrument.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> InstrumentEntity:
        ...
        _obj = InstrumentEntity.model_validate({
            ...
            "prevailing_instrument": Instrument.from_dict(_v) if (_v := obj.get("prevailingInstrument")) is not None else None,
            "deleted_instrument": Instrument.from_dict(_v) if (_v := obj.get("deletedInstrument")) is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_instrument": Instrument.from_dict(_v) if (_v := obj.get("previewedInstrument")) is not None else None,
