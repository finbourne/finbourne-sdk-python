...
class RecommendedSortBy(BaseModel):
    ...
    sort_order:  Optional[StrictStr] = Field(default=None,alias="sortOrder", description="The sorting direction. Either ascending (ASC) or descending (DESC).") 
    __properties: ClassVar[List[str]] = ["attributeName", "sortOrder"]
    ...
    def from_dict(cls, obj: dict) -> RecommendedSortBy:
        ...
        if not isinstance(obj, dict):
            return RecommendedSortBy.model_validate(obj)

        _obj = RecommendedSortBy.model_validate({
            "attribute_name": obj.get("attributeName"),
            "sort_order": obj.get("sortOrder")
        })
        return _obj

RecommendedSortBy.model_rebuild()
