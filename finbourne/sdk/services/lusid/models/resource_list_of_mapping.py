...
class ResourceListOfMapping(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfMapping:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfMapping.model_validate(obj)

        _obj = ResourceListOfMapping.model_validate({
            "values": [Mapping.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfMapping.model_rebuild()
