...
class UpdateDepositAmountEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "date", "amount"]
    ...
    def from_dict(cls, obj: dict) -> UpdateDepositAmountEvent:
        ...
        if not isinstance(obj, dict):
            return UpdateDepositAmountEvent.model_validate(obj)

        _obj = UpdateDepositAmountEvent.model_validate({
...
UpdateDepositAmountEvent.model_rebuild()
