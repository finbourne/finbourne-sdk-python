...
class RepurchaseOfferEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "paymentDate", "marketDeadlineDate", "repurchaseQuantity", "cashOfferElections", "lapseElections", "tenderOfferElections", "prorationRate", "responseDeadlineDate"]
    ...
    def from_dict(cls, obj: dict) -> RepurchaseOfferEvent:
        ...
        if not isinstance(obj, dict):
            return RepurchaseOfferEvent.model_validate(obj)

        _obj = RepurchaseOfferEvent.model_validate({
...
RepurchaseOfferEvent.model_rebuild()
