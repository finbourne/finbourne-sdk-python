...
class IndexProjectionDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "currency", "tenor", "indexName", "date"]
    ...
    def from_dict(cls, obj: dict) -> IndexProjectionDependency:
        ...
        if not isinstance(obj, dict):
            return IndexProjectionDependency.model_validate(obj)

        _obj = IndexProjectionDependency.model_validate({
...
IndexProjectionDependency.model_rebuild()
