...
class OrderGraphBlockTransactionDetail(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> OrderGraphBlockTransactionDetail:
        ...
        if not isinstance(obj, dict):
            return OrderGraphBlockTransactionDetail.model_validate(obj)

        _obj = OrderGraphBlockTransactionDetail.model_validate({
            "id": obj.get("id")
        })
        return _obj

OrderGraphBlockTransactionDetail.model_rebuild()
