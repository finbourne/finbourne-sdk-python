...
class FxForwardPipsCurveData(ComplexMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "baseDate", "domCcy", "fgnCcy", "dates", "pipRates", "lineage", "marketDataOptions", "version"]
    ...
    def from_dict(cls, obj: dict) -> FxForwardPipsCurveData:
        ...
        if not isinstance(obj, dict):
            return FxForwardPipsCurveData.model_validate(obj)

        _obj = FxForwardPipsCurveData.model_validate({
...
FxForwardPipsCurveData.model_rebuild()
