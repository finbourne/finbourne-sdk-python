...
class FxForwardCurveData(ComplexMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "baseDate", "domCcy", "fgnCcy", "dates", "rates", "lineage", "marketDataOptions", "version"]
    ...
    def from_dict(cls, obj: dict) -> FxForwardCurveData:
        ...
        if not isinstance(obj, dict):
            return FxForwardCurveData.model_validate(obj)

        _obj = FxForwardCurveData.model_validate({
...
FxForwardCurveData.model_rebuild()
