...
class ValuationRequest(BaseModel):
    ...
    report_currency:  Optional[StrictStr] = Field(default=None,alias="reportCurrency", description="Three letter ISO currency string indicating what currency to report in for ReportCurrency denominated queries.  If not present, then the currency of the relevant portfolio will be used in its place.") 
