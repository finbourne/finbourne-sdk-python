...
class ValuationRequest(BaseModel):
    ...
    report_currency:  Optional[StrictStr] = Field(default=None,alias="reportCurrency", description="Three to five letter currency string indicating what currency to report in for ReportCurrency denominated queries.  If not present, then the currency of the relevant portfolio will be used in its place.") 
    ...
    portfolio_entity_ids: List[PortfolioEntityId] = Field(description="The set of portfolio or portfolio group identifier(s) that is to be valued.", alias="portfolioEntityIds")
...
ValuationRequest.model_rebuild()
