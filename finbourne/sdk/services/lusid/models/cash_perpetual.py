...
class CashPerpetual(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "domCcy", "principal"]
    ...
    def from_dict(cls, obj: dict) -> CashPerpetual:
        ...
        if not isinstance(obj, dict):
            return CashPerpetual.model_validate(obj)

        _obj = CashPerpetual.model_validate({
