...
class GroupReconciliationAggregateComparisonRuleOperand(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationAggregateComparisonRuleOperand:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationAggregateComparisonRuleOperand.model_validate(obj)

        _obj = GroupReconciliationAggregateComparisonRuleOperand.model_validate({
            "key": obj.get("key"),
            "operation": obj.get("operation")
        })
        return _obj

GroupReconciliationAggregateComparisonRuleOperand.model_rebuild()
