...
class CreateIdentifierDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["domain", "identifierScope", "identifierType", "lifeTime", "hierarchyUsage", "hierarchyLevel", "displayName", "description", "properties"]
    ...
    def from_dict(cls, obj: dict) -> CreateIdentifierDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return CreateIdentifierDefinitionRequest.model_validate(obj)

        _obj = CreateIdentifierDefinitionRequest.model_validate({
...
CreateIdentifierDefinitionRequest.model_rebuild()
