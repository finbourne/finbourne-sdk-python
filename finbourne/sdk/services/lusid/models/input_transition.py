...
class InputTransition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["unitsFactor", "costFactor"]
    ...
    def from_dict(cls, obj: dict) -> InputTransition:
        ...
        if not isinstance(obj, dict):
            return InputTransition.model_validate(obj)

        _obj = InputTransition.model_validate({
            "units_factor": obj.get("unitsFactor"),
            "cost_factor": obj.get("costFactor")
        })
        return _obj

InputTransition.model_rebuild()
