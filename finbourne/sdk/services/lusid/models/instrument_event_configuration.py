...
class InstrumentEventConfiguration(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.transaction_template_scopes is None and "transaction_template_scopes" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InstrumentEventConfiguration:
        ...
        if not isinstance(obj, dict):
            return InstrumentEventConfiguration.model_validate(obj)
...
InstrumentEventConfiguration.model_rebuild()
