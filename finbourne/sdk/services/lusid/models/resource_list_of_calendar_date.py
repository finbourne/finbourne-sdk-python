...
class ResourceListOfCalendarDate(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfCalendarDate:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfCalendarDate.model_validate(obj)

        _obj = ResourceListOfCalendarDate.model_validate({
            "values": [CalendarDate.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfCalendarDate.model_rebuild()
