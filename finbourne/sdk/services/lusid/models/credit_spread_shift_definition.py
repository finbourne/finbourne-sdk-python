...
class CreditSpreadShiftDefinition(ScenarioShiftDefinition):
    ...
    start_tenor:  Optional[StrictStr] = Field(default=None,alias="startTenor", description="The near end of the tenor window the shift applies over, resolved against the valuation  date. A whole number of units, in any case: BD (business day), D, W, M, Q or Qtr, SA  (semi-annual), Y or A - for example \"1BD\", \"3m\", \"6M\", \"1Qtr\", \"5y\". Omitted, the window  is open at this end and every point up to EndTenor is in it.") 
    end_tenor:  Optional[StrictStr] = Field(default=None,alias="endTenor", description="The far end of the tenor window, in the same units as StartTenor. Omitted, the window is  open at this end.") 
