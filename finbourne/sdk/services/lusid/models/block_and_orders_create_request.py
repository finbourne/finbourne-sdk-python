...
class BlockAndOrdersCreateRequest(BaseModel):
    ...
    """
    requests: List[BlockAndOrdersRequest] = Field(description="A collection of BlockAndOrdersRequest.")
    ...
    def from_dict(cls, obj: dict) -> BlockAndOrdersCreateRequest:
        ...
        if not isinstance(obj, dict):
            return BlockAndOrdersCreateRequest.model_validate(obj)

        _obj = BlockAndOrdersCreateRequest.model_validate({
            "requests": [BlockAndOrdersRequest.from_dict(_item) for _item in _v] if (_v := obj.get("requests")) is not None else None
        })
        return _obj

BlockAndOrdersCreateRequest.model_rebuild()
