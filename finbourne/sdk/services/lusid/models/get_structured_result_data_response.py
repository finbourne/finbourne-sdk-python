...
class GetStructuredResultDataResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetStructuredResultDataResponse:
        ...
        if not isinstance(obj, dict):
            return GetStructuredResultDataResponse.model_validate(obj)

        _obj = GetStructuredResultDataResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
GetStructuredResultDataResponse.model_rebuild()
