...
class ComplexBond(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "identifiers", "calculationType", "schedules", "originalIssuePrice", "issueDate", "roundingConventions", "assetBacked", "assetPoolIdentifier", "tradingConventions", "timeZoneConventions"]
