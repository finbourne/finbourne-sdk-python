...
class ComplexBond(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "identifiers", "calculationType", "schedules", "originalIssuePrice", "roundingConventions", "assetBacked", "assetPoolIdentifier", "tradingConventions", "timeZoneConventions"]
