...
class ComplexBond(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "identifiers", "calculationType", "schedules", "originalIssuePrice", "parPerUnit", "issueDate", "roundingConventions", "assetBacked", "assetPoolIdentifier", "tradingConventions", "timeZoneConventions"]
