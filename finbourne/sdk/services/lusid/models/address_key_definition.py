...
class AddressKeyDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["addressKey", "type", "version", "links"]
    ...
    def from_dict(cls, obj: dict) -> AddressKeyDefinition:
        ...
        if not isinstance(obj, dict):
            return AddressKeyDefinition.model_validate(obj)

        _obj = AddressKeyDefinition.model_validate({
...
AddressKeyDefinition.model_rebuild()
