...
class FundA2BDataRecord(BaseModel):
    """
    Fund A2B Data Record - shows values on, and changes between two dates: A and B  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FundA2BDataRecord:
        """Create an instance of FundA2BDataRecord from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FundA2BDataRecord:
        """Create an instance of FundA2BDataRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundA2BDataRecord.model_validate(obj)

        _obj = FundA2BDataRecord.model_validate({
...
FundA2BDataRecord.model_rebuild()
