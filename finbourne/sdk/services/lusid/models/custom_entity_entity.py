...
class CustomEntityEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingCustomEntity", "deletedCustomEntity", "previewedStatus", "previewedCustomEntity", "links"]
    ...
    def from_dict(cls, obj: dict) -> CustomEntityEntity:
        ...
        if not isinstance(obj, dict):
            return CustomEntityEntity.model_validate(obj)

        _obj = CustomEntityEntity.model_validate({
            "href": obj.get("href"),
            ...
            "prevailing_custom_entity": CustomEntityResponse.from_dict(_v) if (_v := obj.get("prevailingCustomEntity")) is not None else None,
            "deleted_custom_entity": CustomEntityResponse.from_dict(_v) if (_v := obj.get("deletedCustomEntity")) is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_custom_entity": CustomEntityResponse.from_dict(_v) if (_v := obj.get("previewedCustomEntity")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

CustomEntityEntity.model_rebuild()
