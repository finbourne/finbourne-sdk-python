...
class PortfolioGroupIdComplianceParameter(ComplianceParameter):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PortfolioGroupIdComplianceParameter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PortfolioGroupIdComplianceParameter:
        """Create an instance of PortfolioGroupIdComplianceParameter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PortfolioGroupIdComplianceParameter.model_validate(obj)

        _obj = PortfolioGroupIdComplianceParameter.model_validate({
...
PortfolioGroupIdComplianceParameter.model_rebuild()
