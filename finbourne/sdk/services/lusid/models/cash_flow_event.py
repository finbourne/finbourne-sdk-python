...
class CashFlowEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "cashFlowValue", "eventType"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.cash_flow_value:
            _dict['cashFlowValue'] = self.cash_flow_value.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CashFlowEvent:
        ...
        if not isinstance(obj, dict):
            return CashFlowEvent.model_validate(obj)

        _obj = CashFlowEvent.model_validate({
            "instrument_event_type": obj.get("instrumentEventType"),
            "cash_flow_value": CashFlowValue.from_dict(_v) if (_v := obj.get("cashFlowValue")) is not None else None,
