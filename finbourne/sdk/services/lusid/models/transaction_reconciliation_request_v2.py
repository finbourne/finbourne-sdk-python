...
class TransactionReconciliationRequestV2(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.comparison_rules is None and "comparison_rules" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> TransactionReconciliationRequestV2:
        ...
        if not isinstance(obj, dict):
            return TransactionReconciliationRequestV2.model_validate(obj)

        _obj = TransactionReconciliationRequestV2.model_validate({
            "left": AggregatedTransactionsRequest.from_dict(_v) if (_v := obj.get("left")) is not None else None,
            "right": AggregatedTransactionsRequest.from_dict(_v) if (_v := obj.get("right")) is not None else None,
...
TransactionReconciliationRequestV2.model_rebuild()
