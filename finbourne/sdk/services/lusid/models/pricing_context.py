...
class PricingContext(BaseModel):
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.model_choice is None and "model_choice" in self.model_fields_set:
            _dict['modelChoice'] = None

        # set to None if result_data_rules (nullable) is None
        # and model_fields_set contains the field
        if self.result_data_rules is None and "result_data_rules" in self.model_fields_set:
            _dict['resultDataRules'] = None

        # set to None if accrual_definition (nullable) is None
        # and model_fields_set contains the field
        if self.accrual_definition is None and "accrual_definition" in self.model_fields_set:
