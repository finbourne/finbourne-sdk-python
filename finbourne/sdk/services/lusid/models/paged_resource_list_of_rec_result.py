...
class PagedResourceListOfRecResult(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfRecResult:
        """Create an instance of PagedResourceListOfRecResult from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfRecResult:
        """Create an instance of PagedResourceListOfRecResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfRecResult.model_validate(obj)

        _obj = PagedResourceListOfRecResult.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [RecResult.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfRecResult.model_rebuild()
