...
class StagedModification(BaseModel):
    ...
    StagedModification
    """
    id:  Optional[StrictStr] = Field(default=None,alias="id", description="The unique Id for the staged modification") 
    as_at_staged: Optional[datetime] = Field(default=None, description="Time at which the modification was staged.", alias="asAtStaged")
    user_id_staged:  Optional[StrictStr] = Field(default=None,alias="userIdStaged", description="Id of the user who created the stage modification request.") 
    requested_id_staged:  Optional[StrictStr] = Field(default=None,alias="requestedIdStaged", description="The Request Id that initiated this staged modification.") 
    request_reason:  Optional[StrictStr] = Field(default=None,alias="requestReason", description="The Request Reason from the context that initiated this staged modification.") 
    action:  Optional[StrictStr] = Field(default=None,alias="action", description="Type of action of the staged modification, either create, update or delete.") 
    staging_rule: Optional[StagedModificationStagingRule] = Field(default=None, alias="stagingRule")
    decisions: Optional[List[StagedModificationDecision]] = Field(default=None, description="Object containing information relating to the decision on the staged modification.")
    decisions_count: Optional[StrictInt] = Field(default=None, description="Number of decisions made.", alias="decisionsCount")
    status:  Optional[StrictStr] = Field(default=None,alias="status", description="The status of the staged modification.") 
    as_at_closed: Optional[datetime] = Field(default=None, description="Time at which the modification was closed by either rejection or approval.", alias="asAtClosed")
    entity_type:  Optional[StrictStr] = Field(default=None,alias="entityType", description="The type of the entity that the staged modification applies to.") 
    scope:  Optional[StrictStr] = Field(default=None,alias="scope", description="The scope of the entity that this staged modification applies to.") 
    entity_unique_id:  Optional[StrictStr] = Field(default=None,alias="entityUniqueId", description="The unique Id of the entity the staged modification applies to.") 
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.staging_rule:
            _dict['stagingRule'] = self.staging_rule.to_dict(by_alias=by_alias)
        ...
        if self.requested_changes:
            _dict['requestedChanges'] = self.requested_changes.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of entity_hrefs
        if self.entity_hrefs:
            _dict['entityHrefs'] = self.entity_hrefs.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.user_id_staged is None and "user_id_staged" in self.model_fields_set:
            _dict['userIdStaged'] = None

        # set to None if requested_id_staged (nullable) is None
        # and model_fields_set contains the field
        if self.requested_id_staged is None and "requested_id_staged" in self.model_fields_set:
            _dict['requestedIdStaged'] = None

        # set to None if request_reason (nullable) is None
        # and model_fields_set contains the field
        if self.request_reason is None and "request_reason" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> StagedModification:
        ...
        if not isinstance(obj, dict):
            return StagedModification.model_validate(obj)

        _obj = StagedModification.model_validate({
            "id": obj.get("id"),
...
StagedModification.model_rebuild()
