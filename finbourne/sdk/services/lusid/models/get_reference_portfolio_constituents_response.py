...
class GetReferencePortfolioConstituentsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetReferencePortfolioConstituentsResponse:
        ...
        if not isinstance(obj, dict):
            return GetReferencePortfolioConstituentsResponse.model_validate(obj)

        _obj = GetReferencePortfolioConstituentsResponse.model_validate({
...
GetReferencePortfolioConstituentsResponse.model_rebuild()
