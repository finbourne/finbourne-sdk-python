...
class ResourceListOfFeeRule(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfFeeRule:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfFeeRule.model_validate(obj)

        _obj = ResourceListOfFeeRule.model_validate({
            "values": [FeeRule.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfFeeRule.model_rebuild()
