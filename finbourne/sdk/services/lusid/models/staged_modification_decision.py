...
class StagedModificationDecision(BaseModel):
    ...
    user_id:  Optional[StrictStr] = Field(default=None,alias="userId", description="ID of user that approved the request.") 
    ...
    def from_dict(cls, obj: dict) -> StagedModificationDecision:
        ...
        if not isinstance(obj, dict):
            return StagedModificationDecision.model_validate(obj)

        _obj = StagedModificationDecision.model_validate({
            "as_at": obj.get("asAt"),
...
StagedModificationDecision.model_rebuild()
