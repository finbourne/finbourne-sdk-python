...
class UpdateReconciliationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "isPortfolioGroup", "left", "right", "transactions", "positions", "valuations", "properties"]
    ...
    def from_dict(cls, obj: dict) -> UpdateReconciliationRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateReconciliationRequest.model_validate(obj)

        _obj = UpdateReconciliationRequest.model_validate({
            "name": obj.get("name"),
...
UpdateReconciliationRequest.model_rebuild()
