...
class ComplianceSummaryRuleResult(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ComplianceSummaryRuleResult:
        ...
        if not isinstance(obj, dict):
            return ComplianceSummaryRuleResult.model_validate(obj)

        _obj = ComplianceSummaryRuleResult.model_validate({
            ...
            "rule_breakdown": [ComplianceRuleBreakdown.from_dict(_item) for _item in _v] if (_v := obj.get("ruleBreakdown")) is not None else None
        })
        return _obj

ComplianceSummaryRuleResult.model_rebuild()
