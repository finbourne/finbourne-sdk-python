...
class TransactionConfigurationMovementDataRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> TransactionConfigurationMovementDataRequest:
        ...
        if not isinstance(obj, dict):
            return TransactionConfigurationMovementDataRequest.model_validate(obj)

        _obj = TransactionConfigurationMovementDataRequest.model_validate({
...
TransactionConfigurationMovementDataRequest.model_rebuild()
