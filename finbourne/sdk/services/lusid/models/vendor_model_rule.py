...
class VendorModelRule(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.model_options:
            _dict['modelOptions'] = self.model_options.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> VendorModelRule:
        ...
        if not isinstance(obj, dict):
            return VendorModelRule.model_validate(obj)

        _obj = VendorModelRule.model_validate({
