...
class InstrumentActivity(NavActivityAdjustment):
    ...
    __properties: ClassVar[List[str]] = ["navActivityAdjustmentType", "asAt", "scope", "lusidInstrumentId"]
    ...
    def from_dict(cls, obj: dict) -> InstrumentActivity:
        ...
        if not isinstance(obj, dict):
            return InstrumentActivity.model_validate(obj)

        _obj = InstrumentActivity.model_validate({
...
InstrumentActivity.model_rebuild()
