...
class VersionedResourceListOfJournalEntryLine(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfJournalEntryLine:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfJournalEntryLine.model_validate(obj)

        _obj = VersionedResourceListOfJournalEntryLine.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [JournalEntryLine.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfJournalEntryLine.model_rebuild()
