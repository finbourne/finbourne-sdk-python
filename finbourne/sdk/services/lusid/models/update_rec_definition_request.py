...
class UpdateRecDefinitionRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRecDefinitionRequest:
        """Create an instance of UpdateRecDefinitionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRecDefinitionRequest:
        """Create an instance of UpdateRecDefinitionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateRecDefinitionRequest.model_validate(obj)

        _obj = UpdateRecDefinitionRequest.model_validate({
...
UpdateRecDefinitionRequest.model_rebuild()
