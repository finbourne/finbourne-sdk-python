...
class ExoticInstrument(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "instrumentFormat", "content"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.instrument_format:
            _dict['instrumentFormat'] = self.instrument_format.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> ExoticInstrument:
        ...
        if not isinstance(obj, dict):
            return ExoticInstrument.model_validate(obj)

        _obj = ExoticInstrument.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "instrument_format": InstrumentDefinitionFormat.from_dict(_v) if (_v := obj.get("instrumentFormat")) is not None else None,
...
ExoticInstrument.model_rebuild()
