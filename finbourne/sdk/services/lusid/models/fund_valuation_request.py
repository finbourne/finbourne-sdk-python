...
class FundValuationRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.fund_valuation_schedule:
            _dict['fundValuationSchedule'] = self.fund_valuation_schedule.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> FundValuationRequest:
        ...
        if not isinstance(obj, dict):
            return FundValuationRequest.model_validate(obj)
...
FundValuationRequest.model_rebuild()
