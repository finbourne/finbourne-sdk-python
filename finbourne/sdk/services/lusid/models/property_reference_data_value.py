...
class PropertyReferenceDataValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["stringValue", "numericValue"]
    ...
    def from_dict(cls, obj: dict) -> PropertyReferenceDataValue:
        ...
        if not isinstance(obj, dict):
            return PropertyReferenceDataValue.model_validate(obj)

        _obj = PropertyReferenceDataValue.model_validate({
            "string_value": obj.get("stringValue"),
            "numeric_value": obj.get("numericValue")
        })
        return _obj

PropertyReferenceDataValue.model_rebuild()
