...
class TransactionTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "componentTransactions"]
    ...
    def from_dict(cls, obj: dict) -> TransactionTemplateRequest:
        ...
        if not isinstance(obj, dict):
            return TransactionTemplateRequest.model_validate(obj)

        _obj = TransactionTemplateRequest.model_validate({
...
TransactionTemplateRequest.model_rebuild()
