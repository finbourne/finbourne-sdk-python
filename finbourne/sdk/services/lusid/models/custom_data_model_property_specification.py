...
class CustomDataModelPropertySpecification(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CustomDataModelPropertySpecification:
        ...
        if not isinstance(obj, dict):
            return CustomDataModelPropertySpecification.model_validate(obj)

        _obj = CustomDataModelPropertySpecification.model_validate({
            "property_key": obj.get("propertyKey"),
            "required": obj.get("required")
        })
        return _obj

CustomDataModelPropertySpecification.model_rebuild()
