...
class TargetTaxLot(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["units", "cost", "portfolioCost", "price", "purchaseDate", "settlementDate", "notionalCost", "variationMargin", "variationMarginPortfolioCcy", "amortisedCost"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.amortised_cost is None and "amortised_cost" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> TargetTaxLot:
        ...
        if not isinstance(obj, dict):
            return TargetTaxLot.model_validate(obj)

        _obj = TargetTaxLot.model_validate({
            "units": obj.get("units"),
