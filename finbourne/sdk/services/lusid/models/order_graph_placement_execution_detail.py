...
class OrderGraphPlacementExecutionDetail(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> OrderGraphPlacementExecutionDetail:
        ...
        if not isinstance(obj, dict):
            return OrderGraphPlacementExecutionDetail.model_validate(obj)

        _obj = OrderGraphPlacementExecutionDetail.model_validate({
            "id": ResourceId.from_dict(obj.get("id")) if obj.get("id") is not None else None
        })
        return _obj

OrderGraphPlacementExecutionDetail.model_rebuild()
