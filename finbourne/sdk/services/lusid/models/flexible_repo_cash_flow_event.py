...
class FlexibleRepoCashFlowEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "settlementDate", "entitlementDate", "currency", "cashFlowPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> FlexibleRepoCashFlowEvent:
        ...
        if not isinstance(obj, dict):
            return FlexibleRepoCashFlowEvent.model_validate(obj)

        _obj = FlexibleRepoCashFlowEvent.model_validate({
...
FlexibleRepoCashFlowEvent.model_rebuild()
