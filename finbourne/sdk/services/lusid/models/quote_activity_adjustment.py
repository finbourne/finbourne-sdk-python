...
class QuoteActivityAdjustment(NavActivityAdjustmentResponse):
    ...
    __properties: ClassVar[List[str]] = ["navActivityAdjustmentType", "navActivityAdjustmentSource", "asAt", "effectiveAt", "entityUniqueId", "instrumentId"]
    ...
    def from_dict(cls, obj: dict) -> QuoteActivityAdjustment:
        ...
        if not isinstance(obj, dict):
            return QuoteActivityAdjustment.model_validate(obj)

        _obj = QuoteActivityAdjustment.model_validate({
...
QuoteActivityAdjustment.model_rebuild()
