...
class RelationalDatasetFieldsToAdd(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> RelationalDatasetFieldsToAdd:
        ...
        if not isinstance(obj, dict):
            return RelationalDatasetFieldsToAdd.model_validate(obj)

        _obj = RelationalDatasetFieldsToAdd.model_validate({
            "series_identifiers": [CreateSeriesIdentifierField.from_dict(_item) for _item in _v] if (_v := obj.get("seriesIdentifiers")) is not None else None,
...
RelationalDatasetFieldsToAdd.model_rebuild()
