...
class PagedResourceListOfFee(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfFee:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfFee.model_validate(obj)

        _obj = PagedResourceListOfFee.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [Fee.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfFee.model_rebuild()
