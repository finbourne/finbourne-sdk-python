...
class VolSurfaceShiftDefinition(ScenarioShiftDefinition):
    ...
    expiry:  Optional[StrictStr] = Field(default=None,alias="expiry", description="The expiry of the surface points the shift applies to, resolved against the valuation  date. A whole number of units, in any case: BD (business day), D, W, M, Q or Qtr, SA  (semi-annual), Y or A - for example \"1BD\", \"3m\", \"6M\", \"1Qtr\", \"5y\". Omitted, every  expiry on the surface is shifted.") 
    ...
    def from_dict(cls, obj: dict) -> VolSurfaceShiftDefinition:
        ...
        if not isinstance(obj, dict):
            return VolSurfaceShiftDefinition.model_validate(obj)

        _obj = VolSurfaceShiftDefinition.model_validate({
...
VolSurfaceShiftDefinition.model_rebuild()
