...
class ResourceListOfValueType(BaseModel):
    ...
    """
    values: conlist(StrictStr) = Field(...,alias="values")
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfValueType:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfValueType.model_validate(obj)

        _obj = ResourceListOfValueType.model_validate({
...
ResourceListOfValueType.model_rebuild()
