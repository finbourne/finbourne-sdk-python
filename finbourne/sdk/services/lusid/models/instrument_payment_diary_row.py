...
class InstrumentPaymentDiaryRow(BaseModel):
    ...
    currency:  Optional[StrictStr] = Field(default=None,alias="currency", description="The payment currency of the cash flow.") 
    ...
    pay_or_receive:  Optional[StrictStr] = Field(default=None,alias="payOrReceive", description="Does the cash flow belong to the Pay or Receive leg.") 
    ...
    cash_flow_type:  Optional[StrictStr] = Field(default=None,alias="cashFlowType", description="The type of cashflow.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.pay_or_receive is None and "pay_or_receive" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.day_count_fraction is None and "day_count_fraction" in self.model_fields_set:
            _dict['dayCountFraction'] = None

        # set to None if forward_rate (nullable) is None
        # and model_fields_set contains the field
        if self.forward_rate is None and "forward_rate" in self.model_fields_set:
            _dict['forwardRate'] = None

        # set to None if reset_rate (nullable) is None
        # and model_fields_set contains the field
        if self.reset_rate is None and "reset_rate" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InstrumentPaymentDiaryRow:
        ...
        if not isinstance(obj, dict):
            return InstrumentPaymentDiaryRow.model_validate(obj)

        _obj = InstrumentPaymentDiaryRow.model_validate({
...
InstrumentPaymentDiaryRow.model_rebuild()
