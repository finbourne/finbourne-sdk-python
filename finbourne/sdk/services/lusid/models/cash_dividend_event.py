...
class CashDividendEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "paymentDate", "exDate", "cashElections", "announcementDate", "recordDate"]
    ...
    def from_dict(cls, obj: dict) -> CashDividendEvent:
        ...
        if not isinstance(obj, dict):
            return CashDividendEvent.model_validate(obj)

        _obj = CashDividendEvent.model_validate({
...
CashDividendEvent.model_rebuild()
