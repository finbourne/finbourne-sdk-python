...
class GroupReconciliationComparisonRuleTolerance(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationComparisonRuleTolerance:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationComparisonRuleTolerance.model_validate(obj)

        _obj = GroupReconciliationComparisonRuleTolerance.model_validate({
            "type": obj.get("type"),
            "value": obj.get("value")
        })
        return _obj

GroupReconciliationComparisonRuleTolerance.model_rebuild()
