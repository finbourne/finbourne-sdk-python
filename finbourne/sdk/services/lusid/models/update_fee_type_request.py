...
class UpdateFeeTypeRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "componentTransactions"]
    ...
    def from_dict(cls, obj: dict) -> UpdateFeeTypeRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateFeeTypeRequest.model_validate(obj)

        _obj = UpdateFeeTypeRequest.model_validate({
...
UpdateFeeTypeRequest.model_rebuild()
