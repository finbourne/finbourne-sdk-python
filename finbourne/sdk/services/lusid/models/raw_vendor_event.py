...
class RawVendorEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "effectiveAt", "eventValue", "eventType"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.event_value:
            _dict['eventValue'] = self.event_value.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> RawVendorEvent:
        ...
        if not isinstance(obj, dict):
            return RawVendorEvent.model_validate(obj)

        _obj = RawVendorEvent.model_validate({
            "instrument_event_type": obj.get("instrumentEventType"),
            "effective_at": obj.get("effectiveAt"),
            "event_value": LifeCycleEventValue.from_dict(_v) if (_v := obj.get("eventValue")) is not None else None,
