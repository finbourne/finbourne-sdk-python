...
class ResourceListOfSideDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfSideDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfSideDefinition.model_validate(obj)

        _obj = ResourceListOfSideDefinition.model_validate({
            "values": [SideDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfSideDefinition.model_rebuild()
