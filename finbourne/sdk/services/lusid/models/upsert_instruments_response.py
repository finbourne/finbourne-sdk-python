...
class UpsertInstrumentsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "values", "staged", "failed", "metadata", "links"]
    ...
    def from_dict(cls, obj: dict) -> UpsertInstrumentsResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertInstrumentsResponse.model_validate(obj)

        _obj = UpsertInstrumentsResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
UpsertInstrumentsResponse.model_rebuild()
