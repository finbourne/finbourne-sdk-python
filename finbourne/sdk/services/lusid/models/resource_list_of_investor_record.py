...
class ResourceListOfInvestorRecord(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfInvestorRecord:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfInvestorRecord.model_validate(obj)

        _obj = ResourceListOfInvestorRecord.model_validate({
            "values": [InvestorRecord.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfInvestorRecord.model_rebuild()
