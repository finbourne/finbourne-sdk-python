...
class PikBondInterestCapitalisationEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "exDate", "paymentDate", "currency", "couponPerUnit", "faceRoundingConvention", "faceRoundingDecimalPlaces"]
    ...
    def from_dict(cls, obj: dict) -> PikBondInterestCapitalisationEvent:
        ...
        if not isinstance(obj, dict):
            return PikBondInterestCapitalisationEvent.model_validate(obj)

        _obj = PikBondInterestCapitalisationEvent.model_validate({
...
PikBondInterestCapitalisationEvent.model_rebuild()
