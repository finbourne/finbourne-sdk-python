...
class Repo(LusidInstrument):
    ...
    collateral: Optional[List[LusidInstrument]] = Field(default=None, description="The actual collateral in the Repo.  This property is for informational purposes only, Lusid pricing is not affected.")
    collateral_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The full market value of the collateral in domestic currency, before any margin or haircut is applied.", alias="collateralValue")
    haircut: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The haircut (or margin percentage) applied to the collateral, this should be a number between 0 and 1, i.e. for a 5% haircut this should be 0.05.  This is defined as (CollateralValue - PurchasePrice) / CollateralValue.  If this property is specified, so too must CollateralValue.  While this property is optional, one, and only one, of PurchasePrice, Margin and Haircut must be specified.")
    margin: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The initial margin (or margin ratio) applied to the collateral, this should be a number greater than or equal to 1.0,  i.e. for a 102% margin this should be 1.02. A value of 1.0 means no margin (100%).  This is defined as CollateralValue / PurchasePrice.  If this property is specified, so too must CollateralValue.  While this property is optional, one, and only one, of PurchasePrice, Margin and Haircut must be specified.")
    purchase_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price the collateral is initially purchased for, this property can be used to explicitly set the purchase price and not require  collateral value and a margin or haircut.  While this property is optional, one, and only one, of PurchasePrice, Margin and Haircut must be specified.", alias="purchasePrice")
    repo_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The rate at which interest is to be accrue and be paid upon redemption of the collateral at maturity.  This field is used to calculate the Repurchase price.  While this property is optional, one, and only one, of the RepoRate and RepurchasePrice must be specified.", alias="repoRate")
    repurchase_price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price at which the collateral is repurchased, this field is optional and can be explicitly set here or will be calculated  from the PurchasePrice and RepoRate.  One, and only one, of the RepoRate and RepurchasePrice must be specified.", alias="repurchasePrice")
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "domCcy", "accrualBasis", "collateral", "collateralValue", "haircut", "margin", "purchasePrice", "repoRate", "repurchasePrice", "timeZoneConventions"]
    ...
    def to_dict(self):
        ...
        if self.collateral is None and "collateral" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.repo_rate is None and "repo_rate" in self.model_fields_set:
            _dict['repoRate'] = None
    ...
    def from_dict(cls, obj: dict) -> Repo:
        ...
        if not isinstance(obj, dict):
            return Repo.model_validate(obj)

        _obj = Repo.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "dom_ccy": obj.get("domCcy"),
            "accrual_basis": obj.get("accrualBasis"),
            "collateral": [LusidInstrument.from_dict(_item) for _item in _v] if (_v := obj.get("collateral")) is not None else None,
