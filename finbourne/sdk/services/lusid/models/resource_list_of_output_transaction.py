...
class ResourceListOfOutputTransaction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfOutputTransaction:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfOutputTransaction.model_validate(obj)

        _obj = ResourceListOfOutputTransaction.model_validate({
...
ResourceListOfOutputTransaction.model_rebuild()
