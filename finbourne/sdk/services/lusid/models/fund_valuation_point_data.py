...
class FundValuationPointData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backOut", "dealing", "pnL", "gav", "fees", "nav", "miscellaneous", "previousValuationPointData"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.dealing:
            for _key in self.dealing:
                if self.dealing[_key]:
                    _field_dict[_key] = self.dealing[_key].to_dict(by_alias=by_alias)
        ...
        if self.previous_valuation_point_data:
            _dict['previousValuationPointData'] = self.previous_valuation_point_data.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> FundValuationPointData:
        ...
        if not isinstance(obj, dict):
            return FundValuationPointData.model_validate(obj)

        _obj = FundValuationPointData.model_validate({
            "back_out": dict(
            ...
            if (_val := obj.get("dealing")) is not None
            else None,
            "pn_l": FundPnlBreakdown.from_dict(_v) if (_v := obj.get("pnL")) is not None else None,
            "gav": obj.get("gav"),
            "fees": dict(
            ...
            "previous_valuation_point_data": PreviousFundValuationPointData.from_dict(_v) if (_v := obj.get("previousValuationPointData")) is not None else None
        })
        return _obj

FundValuationPointData.model_rebuild()
