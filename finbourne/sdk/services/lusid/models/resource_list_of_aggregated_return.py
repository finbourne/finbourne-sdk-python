...
class ResourceListOfAggregatedReturn(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfAggregatedReturn:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfAggregatedReturn.model_validate(obj)

        _obj = ResourceListOfAggregatedReturn.model_validate({
            "values": [AggregatedReturn.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfAggregatedReturn.model_rebuild()
