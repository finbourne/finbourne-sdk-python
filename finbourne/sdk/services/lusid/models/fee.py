...
class Fee(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "feeCode", "feeTypeId", "displayName", "description", "origin", "calculationBase", "accrualCurrency", "treatment", "totalAnnualAccrualAmount", "feeRatePercentage", "payableFrequency", "businessDayConvention", "startDate", "endDate", "anchorDate", "properties", "version", "portfolioId", "shareClasses", "navTypeCode", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.fee_type_id:
            _dict['feeTypeId'] = self.fee_type_id.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of anchor_date
        if self.anchor_date:
            _dict['anchorDate'] = self.anchor_date.to_dict(by_alias=by_alias)
