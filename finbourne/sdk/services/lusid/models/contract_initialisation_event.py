...
class ContractInitialisationEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "limit", "date", "contractDetails"]
    ...
    def from_dict(cls, obj: dict) -> ContractInitialisationEvent:
        ...
        if not isinstance(obj, dict):
            return ContractInitialisationEvent.model_validate(obj)

        _obj = ContractInitialisationEvent.model_validate({
...
ContractInitialisationEvent.model_rebuild()
