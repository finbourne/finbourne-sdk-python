...
class RelationalDatasetFieldDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fieldName", "displayName", "description", "dataTypeId", "required", "category"]
    ...
    def from_dict(cls, obj: dict) -> RelationalDatasetFieldDefinition:
        ...
        if not isinstance(obj, dict):
            return RelationalDatasetFieldDefinition.model_validate(obj)

        _obj = RelationalDatasetFieldDefinition.model_validate({
...
RelationalDatasetFieldDefinition.model_rebuild()
