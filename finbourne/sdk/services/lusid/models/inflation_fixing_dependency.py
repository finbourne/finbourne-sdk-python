...
class InflationFixingDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "type", "code", "date"]
    ...
    def from_dict(cls, obj: dict) -> InflationFixingDependency:
        ...
        if not isinstance(obj, dict):
            return InflationFixingDependency.model_validate(obj)

        _obj = InflationFixingDependency.model_validate({
...
InflationFixingDependency.model_rebuild()
