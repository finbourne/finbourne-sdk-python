...
class VersionedResourceListOfTransaction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfTransaction:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfTransaction.model_validate(obj)

        _obj = VersionedResourceListOfTransaction.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [Transaction.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfTransaction.model_rebuild()
