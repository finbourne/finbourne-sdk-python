...
class RelationalDataPointFieldValueResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> RelationalDataPointFieldValueResponse:
        ...
        if not isinstance(obj, dict):
            return RelationalDataPointFieldValueResponse.model_validate(obj)

        _obj = RelationalDataPointFieldValueResponse.model_validate({
            "value": obj.get("value")
        })
        return _obj

RelationalDataPointFieldValueResponse.model_rebuild()
