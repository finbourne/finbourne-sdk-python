...
class ResourceListOfQueryableKey(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfQueryableKey:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfQueryableKey.model_validate(obj)

        _obj = ResourceListOfQueryableKey.model_validate({
            "values": [QueryableKey.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfQueryableKey.model_rebuild()
