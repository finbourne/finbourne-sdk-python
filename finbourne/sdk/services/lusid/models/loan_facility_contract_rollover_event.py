...
class LoanFacilityContractRolloverEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "date", "rolloverConstituents", "withInterest"]
    ...
    def from_dict(cls, obj: dict) -> LoanFacilityContractRolloverEvent:
        ...
        if not isinstance(obj, dict):
            return LoanFacilityContractRolloverEvent.model_validate(obj)

        _obj = LoanFacilityContractRolloverEvent.model_validate({
            "instrument_event_type": obj.get("instrumentEventType"),
            "var_date": obj.get("date"),
            "rollover_constituents": [RolloverConstituent.from_dict(_item) for _item in _v] if (_v := obj.get("rolloverConstituents")) is not None else None,
...
LoanFacilityContractRolloverEvent.model_rebuild()
