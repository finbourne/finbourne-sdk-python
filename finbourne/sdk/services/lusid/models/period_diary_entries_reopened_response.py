...
class PeriodDiaryEntriesReopenedResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PeriodDiaryEntriesReopenedResponse:
        ...
        if not isinstance(obj, dict):
            return PeriodDiaryEntriesReopenedResponse.model_validate(obj)

        _obj = PeriodDiaryEntriesReopenedResponse.model_validate({
            "href": obj.get("href"),
...
PeriodDiaryEntriesReopenedResponse.model_rebuild()
