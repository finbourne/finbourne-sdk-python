...
class UpsertReferencePortfolioConstituentsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertReferencePortfolioConstituentsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertReferencePortfolioConstituentsResponse:
        """Create an instance of UpsertReferencePortfolioConstituentsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertReferencePortfolioConstituentsResponse.model_validate(obj)
...
UpsertReferencePortfolioConstituentsResponse.model_rebuild()
