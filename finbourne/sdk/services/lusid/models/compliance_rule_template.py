...
class ComplianceRuleTemplate(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="The description of the Compliance Template") 
    ...
    def from_dict(cls, obj: dict) -> ComplianceRuleTemplate:
        ...
        if not isinstance(obj, dict):
            return ComplianceRuleTemplate.model_validate(obj)

        _obj = ComplianceRuleTemplate.model_validate({
...
ComplianceRuleTemplate.model_rebuild()
