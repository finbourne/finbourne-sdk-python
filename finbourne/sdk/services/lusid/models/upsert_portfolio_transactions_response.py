...
class UpsertPortfolioTransactionsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["version", "href", "metadata", "links"]
    ...
    def from_dict(cls, obj: dict) -> UpsertPortfolioTransactionsResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertPortfolioTransactionsResponse.model_validate(obj)

        _obj = UpsertPortfolioTransactionsResponse.model_validate({
...
UpsertPortfolioTransactionsResponse.model_rebuild()
