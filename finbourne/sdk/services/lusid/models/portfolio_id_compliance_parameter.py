...
class PortfolioIdComplianceParameter(ComplianceParameter):
    ...
    def from_dict(cls, obj: dict) -> PortfolioIdComplianceParameter:
        ...
        if not isinstance(obj, dict):
            return PortfolioIdComplianceParameter.model_validate(obj)

        _obj = PortfolioIdComplianceParameter.model_validate({
...
PortfolioIdComplianceParameter.model_rebuild()
