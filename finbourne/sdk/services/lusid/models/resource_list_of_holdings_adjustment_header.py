...
class ResourceListOfHoldingsAdjustmentHeader(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfHoldingsAdjustmentHeader:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfHoldingsAdjustmentHeader.model_validate(obj)

        _obj = ResourceListOfHoldingsAdjustmentHeader.model_validate({
            "values": [HoldingsAdjustmentHeader.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfHoldingsAdjustmentHeader.model_rebuild()
