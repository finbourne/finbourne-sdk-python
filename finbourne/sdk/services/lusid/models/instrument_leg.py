...
class InstrumentLeg(LusidInstrument):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[FixedLeg, FloatingLeg, FundingLeg, InstrumentLeg]:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union[FixedLeg, FloatingLeg, FundingLeg, InstrumentLeg]:
