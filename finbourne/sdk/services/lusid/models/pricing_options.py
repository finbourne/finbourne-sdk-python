...
class PricingOptions(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.find_or_calculate is None and "find_or_calculate" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.funding_curve_by_currency is None and "funding_curve_by_currency" in self.model_fields_set:
