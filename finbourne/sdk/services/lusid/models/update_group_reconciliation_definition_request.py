...
class UpdateGroupReconciliationDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "portfolioEntityIds", "recipeIds", "currencies", "transactionDateWindows", "comparisonRulesetIds", "breakCodeSource", "primarySchedule"]
    ...
    def from_dict(cls, obj: dict) -> UpdateGroupReconciliationDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateGroupReconciliationDefinitionRequest.model_validate(obj)

        _obj = UpdateGroupReconciliationDefinitionRequest.model_validate({
...
UpdateGroupReconciliationDefinitionRequest.model_rebuild()
