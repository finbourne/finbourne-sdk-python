...
class MdkrGroupShiftDefinition(ScenarioShiftDefinition):
    ...
    __properties: ClassVar[List[str]] = ["scenarioShiftType", "rules"]
    ...
    def from_dict(cls, obj: dict) -> MdkrGroupShiftDefinition:
        ...
        if not isinstance(obj, dict):
            return MdkrGroupShiftDefinition.model_validate(obj)

        _obj = MdkrGroupShiftDefinition.model_validate({
            "scenario_shift_type": obj.get("scenarioShiftType"),
            "rules": [KeyedMarketDataKeyRule.from_dict(_item) for _item in _v] if (_v := obj.get("rules")) is not None else None
        })
...
MdkrGroupShiftDefinition.model_rebuild()
