...
class StagedModificationEffectiveRange(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fromDate", "untilDate"]
    ...
    def from_dict(cls, obj: dict) -> StagedModificationEffectiveRange:
        ...
        if not isinstance(obj, dict):
            return StagedModificationEffectiveRange.model_validate(obj)

        _obj = StagedModificationEffectiveRange.model_validate({
            "from_date": obj.get("fromDate"),
            "until_date": obj.get("untilDate")
        })
        return _obj

StagedModificationEffectiveRange.model_rebuild()
