...
class BankruptcyEvent(InstrumentEvent):
    ...
    narrative:  Optional[StrictStr] = Field(default=None,alias="narrative", description="Free-text detail: court, jurisdiction, trustee, plan reference. Optional.") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "effectiveDate", "notificationType", "claimFilingDeadline", "narrative"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.claim_filing_deadline is None and "claim_filing_deadline" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> BankruptcyEvent:
        ...
        if not isinstance(obj, dict):
            return BankruptcyEvent.model_validate(obj)

        _obj = BankruptcyEvent.model_validate({
