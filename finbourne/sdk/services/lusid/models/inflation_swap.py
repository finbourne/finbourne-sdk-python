...
class InflationSwap(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "inflationLeg", "fixedLeg", "additionalPayments", "timeZoneConventions"]
    ...
    def from_dict(cls, obj: dict) -> InflationSwap:
        ...
        if not isinstance(obj, dict):
            return InflationSwap.model_validate(obj)

        _obj = InflationSwap.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "inflation_leg": InflationLeg.from_dict(_v) if (_v := obj.get("inflationLeg")) is not None else None,
            "fixed_leg": FixedLeg.from_dict(_v) if (_v := obj.get("fixedLeg")) is not None else None,
