...
class PagedResourceListOfRecDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfRecDefinition:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfRecDefinition.model_validate(obj)

        _obj = PagedResourceListOfRecDefinition.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [RecDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfRecDefinition.model_rebuild()
