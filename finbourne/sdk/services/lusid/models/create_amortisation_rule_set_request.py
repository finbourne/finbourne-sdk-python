...
class CreateAmortisationRuleSetRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "displayName", "description"]
    ...
    def from_dict(cls, obj: dict) -> CreateAmortisationRuleSetRequest:
        ...
        if not isinstance(obj, dict):
            return CreateAmortisationRuleSetRequest.model_validate(obj)

        _obj = CreateAmortisationRuleSetRequest.model_validate({
            "code": obj.get("code"),
...
CreateAmortisationRuleSetRequest.model_rebuild()
