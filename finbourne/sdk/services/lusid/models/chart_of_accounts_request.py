...
class ChartOfAccountsRequest(BaseModel):
    ...
    display_name:  Optional[StrictStr] = Field(default=None,alias="displayName", description="The name of the Chart of Account.") 
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="A description of the Chart of Accounts.") 
    properties: Optional[Dict[str, ModelProperty]] = Field(default=None, description="A set of properties for the Chart of Accounts.")
    __properties: ClassVar[List[str]] = ["code", "displayName", "description", "properties"]
    ...
    def from_dict(cls, obj: dict) -> ChartOfAccountsRequest:
        ...
        if not isinstance(obj, dict):
            return ChartOfAccountsRequest.model_validate(obj)

        _obj = ChartOfAccountsRequest.model_validate({
            "code": obj.get("code"),
...
ChartOfAccountsRequest.model_rebuild()
