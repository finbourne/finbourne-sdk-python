...
class ResourceListOfChangeInterval(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfChangeInterval:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfChangeInterval.model_validate(obj)

        _obj = ResourceListOfChangeInterval.model_validate({
            "values": [ChangeInterval.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfChangeInterval.model_rebuild()
