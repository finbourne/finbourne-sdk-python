...
class ComplexMarketDataActivity(NavActivityAdjustment):
    ...
    __properties: ClassVar[List[str]] = ["navActivityAdjustmentType", "asAt", "effectiveAt", "entityUniqueId"]
    ...
    def from_dict(cls, obj: dict) -> ComplexMarketDataActivity:
        ...
        if not isinstance(obj, dict):
            return ComplexMarketDataActivity.model_validate(obj)

        _obj = ComplexMarketDataActivity.model_validate({
...
ComplexMarketDataActivity.model_rebuild()
