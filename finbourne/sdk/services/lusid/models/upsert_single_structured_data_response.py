...
class UpsertSingleStructuredDataResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertSingleStructuredDataResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertSingleStructuredDataResponse.model_validate(obj)

        _obj = UpsertSingleStructuredDataResponse.model_validate({
            "href": obj.get("href"),
            "value": obj.get("value"),
...
UpsertSingleStructuredDataResponse.model_rebuild()
