...
class LusidTradeTicket(BaseModel):
    ...
    source:  Optional[StrictStr] = Field(default=None,alias="source", description="Transaction Source. Referenced by Transaction Configuration.") 
    ...
    instrument_scope:  Optional[StrictStr] = Field(default=None,alias="instrumentScope", description="Scope of instrument") 
    instrument_name:  Optional[StrictStr] = Field(default=None,alias="instrumentName", description="Name of instrument") 
    ...
    def trade_ticket_type_validate_enum(cls, value):
        ...
        _allowed = ['LusidTradeTicket', 'ExternalTradeTicket']
        if len(_allowed) != 1:
            return value
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.instrument_definition:
            _dict['instrumentDefinition'] = self.instrument_definition.to_dict(by_alias=by_alias)
        ...
        if self.counterparty_agreement_id:
            _dict['counterpartyAgreementId'] = self.counterparty_agreement_id.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.instrument_properties is None and "instrument_properties" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> LusidTradeTicket:
        ...
        if not isinstance(obj, dict):
            return LusidTradeTicket.model_validate(obj)

        _obj = LusidTradeTicket.model_validate({
...
LusidTradeTicket.model_rebuild()
