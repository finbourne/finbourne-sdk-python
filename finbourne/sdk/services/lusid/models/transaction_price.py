...
class TransactionPrice(BaseModel):
    ...
    type:  Optional[StrictStr] = Field(default=None,alias="type", description="The available values are: Price, Yield, Spread, CashFlowPerUnit, CleanPrice, DirtyPrice") 
    ...
    def from_dict(cls, obj: dict) -> TransactionPrice:
        ...
        if not isinstance(obj, dict):
            return TransactionPrice.model_validate(obj)

        _obj = TransactionPrice.model_validate({
            "price": obj.get("price"),
            "type": obj.get("type")
        })
        return _obj

TransactionPrice.model_rebuild()
