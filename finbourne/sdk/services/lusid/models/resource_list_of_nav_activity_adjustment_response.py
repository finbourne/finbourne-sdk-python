...
class ResourceListOfNavActivityAdjustmentResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfNavActivityAdjustmentResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfNavActivityAdjustmentResponse.model_validate(obj)

        _obj = ResourceListOfNavActivityAdjustmentResponse.model_validate({
            "values": [NavActivityAdjustmentResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfNavActivityAdjustmentResponse.model_rebuild()
