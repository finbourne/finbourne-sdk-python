...
class ResourceListOfComplianceBreachedOrderInfo(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfComplianceBreachedOrderInfo:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfComplianceBreachedOrderInfo.model_validate(obj)

        _obj = ResourceListOfComplianceBreachedOrderInfo.model_validate({
            "values": [ComplianceBreachedOrderInfo.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfComplianceBreachedOrderInfo.model_rebuild()
