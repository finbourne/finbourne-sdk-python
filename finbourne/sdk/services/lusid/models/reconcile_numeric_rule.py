...
class ReconcileNumericRule(ReconciliationRule):
    ...
    """
    comparison_type:  StrictStr = Field(...,alias="comparisonType", description="Available values: Exact, AbsoluteDifference, RelativeDifference.") 
    ...
    def comparison_type_validate_enum(cls, value):
        ...
        _allowed = ['Exact', 'AbsoluteDifference', 'RelativeDifference']
        if len(_allowed) != 1:
            return value
    ...
    def from_dict(cls, obj: dict) -> ReconcileNumericRule:
        ...
        if not isinstance(obj, dict):
            return ReconcileNumericRule.model_validate(obj)

        _obj = ReconcileNumericRule.model_validate({
...
ReconcileNumericRule.model_rebuild()
