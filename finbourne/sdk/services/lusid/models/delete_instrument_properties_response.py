...
class DeleteInstrumentPropertiesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asAt", "stagedModifications", "links"]
    ...
    def from_dict(cls, obj: dict) -> DeleteInstrumentPropertiesResponse:
        ...
        if not isinstance(obj, dict):
            return DeleteInstrumentPropertiesResponse.model_validate(obj)

        _obj = DeleteInstrumentPropertiesResponse.model_validate({
            "as_at": obj.get("asAt"),
...
DeleteInstrumentPropertiesResponse.model_rebuild()
