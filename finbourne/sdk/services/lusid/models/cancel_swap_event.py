...
class CancelSwapEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "cancelDate", "noticeDueDate", "subscribeElections"]
    ...
    def from_dict(cls, obj: dict) -> CancelSwapEvent:
        ...
        if not isinstance(obj, dict):
            return CancelSwapEvent.model_validate(obj)

        _obj = CancelSwapEvent.model_validate({
