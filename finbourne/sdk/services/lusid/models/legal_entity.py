...
class LegalEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "href", "lusidLegalEntityId", "identifiers", "properties", "relationships", "counterpartyRiskInformation", "version", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.identifiers:
            for _key in self.identifiers:
                if self.identifiers[_key]:
                    _field_dict[_key] = self.identifiers[_key].to_dict(by_alias=by_alias)
        ...
        if self.counterparty_risk_information:
            _dict['counterpartyRiskInformation'] = self.counterparty_risk_information.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> LegalEntity:
        ...
        _obj = LegalEntity.model_validate({
            ...
            "counterparty_risk_information": CounterpartyRiskInformation.from_dict(_v) if (_v := obj.get("counterpartyRiskInformation")) is not None else None,
