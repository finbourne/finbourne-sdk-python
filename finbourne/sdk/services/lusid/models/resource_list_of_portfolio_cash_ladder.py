...
class ResourceListOfPortfolioCashLadder(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPortfolioCashLadder:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPortfolioCashLadder.model_validate(obj)

        _obj = ResourceListOfPortfolioCashLadder.model_validate({
            "values": [PortfolioCashLadder.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPortfolioCashLadder.model_rebuild()
