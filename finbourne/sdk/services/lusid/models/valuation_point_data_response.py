...
class ValuationPointDataResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "type", "status", "fundDetails", "fundValuationPointData", "shareClassData", "valuationPointCode", "previousValuationPointCode", "apportionmentResults", "bucketSetResults", "stagedModifications", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in apportionment_results (list)
        _items = []
        if self.apportionment_results:
            for _item in self.apportionment_results:
                if _item:
                    _items.append(_item.to_dict(by_alias=by_alias))
        ...
        # and model_fields_set contains the field
        if self.previous_valuation_point_code is None and "previous_valuation_point_code" in self.model_fields_set:
            _dict['previousValuationPointCode'] = None

        # set to None if apportionment_results (nullable) is None
        # and model_fields_set contains the field
    ...
    def from_dict(cls, obj: dict) -> ValuationPointDataResponse:
        ...
        if not isinstance(obj, dict):
            return ValuationPointDataResponse.model_validate(obj)

        _obj = ValuationPointDataResponse.model_validate({
            "href": obj.get("href"),
            "type": obj.get("type"),
...
ValuationPointDataResponse.model_rebuild()
