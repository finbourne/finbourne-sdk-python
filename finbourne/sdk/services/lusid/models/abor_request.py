...
class AborRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "displayName", "description", "portfolioIds", "aborConfigurationId", "properties"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.abor_configuration_id:
            _dict['aborConfigurationId'] = self.abor_configuration_id.to_dict(by_alias=by_alias)
