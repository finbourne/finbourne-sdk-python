...
class ResourceListOfGetIndexConventionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetIndexConventionResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetIndexConventionResponse.model_validate(obj)

        _obj = ResourceListOfGetIndexConventionResponse.model_validate({
            "values": [GetIndexConventionResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetIndexConventionResponse.model_rebuild()
