...
class VersionedResourceListOfOutputTransaction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfOutputTransaction:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfOutputTransaction.model_validate(obj)

        _obj = VersionedResourceListOfOutputTransaction.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [OutputTransaction.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfOutputTransaction.model_rebuild()
