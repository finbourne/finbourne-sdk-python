...
class CheckDefinitionRule(BaseModel):
    ...
    CheckDefinitionRule
    """
    rule_key:  Optional[StrictStr] = Field(default=None,alias="ruleKey", description="The key of the Rule.") 
    display_name:  Optional[StrictStr] = Field(default=None,alias="displayName", description="The name of the Rule.") 
    ...
    def from_dict(cls, obj: dict) -> CheckDefinitionRule:
        ...
        if not isinstance(obj, dict):
            return CheckDefinitionRule.model_validate(obj)

        _obj = CheckDefinitionRule.model_validate({
...
CheckDefinitionRule.model_rebuild()
