...
class OutputTransaction(BaseModel):
    ...
    source_type:  Optional[StrictStr] = Field(default=None,alias="sourceType", description="The type of source that the transaction originated from, eg: InputTransaction, InstrumentEvent, HoldingAdjustment") 
