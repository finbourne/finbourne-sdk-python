...
class OutputTransaction(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="The description of the transaction. This only exists on transactions generated by LUSID e.g. a holdings adjustment transaction.") 
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.transaction_price:
            _dict['transactionPrice'] = self.transaction_price.to_dict(by_alias=by_alias)
        ...
        if self.resolved_transaction_type_details:
            _dict['resolvedTransactionTypeDetails'] = self.resolved_transaction_type_details.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of otc_confirmation
        if self.otc_confirmation:
            _dict['otcConfirmation'] = self.otc_confirmation.to_dict(by_alias=by_alias)
        ...
        if self.allocation_id:
            _dict['allocationId'] = self.allocation_id.to_dict(by_alias=by_alias)
        ...
        if self.data_model_membership:
            _dict['dataModelMembership'] = self.data_model_membership.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of settlement_summary
        if self.settlement_summary:
            _dict['settlementSummary'] = self.settlement_summary.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.transaction_to_portfolio_rate is None and "transaction_to_portfolio_rate" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.realised_gain_loss is None and "realised_gain_loss" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.source_instrument_event_id is None and "source_instrument_event_id" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.accounting_date is None and "accounting_date" in self.model_fields_set:
            _dict['accountingDate'] = None

        # set to None if economics (nullable) is None
        # and model_fields_set contains the field
        if self.economics is None and "economics" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.unresolved_custodian_accounts is None and "unresolved_custodian_accounts" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> OutputTransaction:
        ...
        if not isinstance(obj, dict):
            return OutputTransaction.model_validate(obj)

        _obj = OutputTransaction.model_validate({
            ...
            "unresolved_custodian_accounts": [CustodianEntry.from_dict(_item) for _item in _v] if (_v := obj.get("unresolvedCustodianAccounts")) is not None else None,
            "is_excluded": obj.get("isExcluded")
        })
        return _obj

OutputTransaction.model_rebuild()
