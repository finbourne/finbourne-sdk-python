...
class RecDatesReconciled(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["leftEffectiveAt", "leftAsAt", "rightEffectiveAt", "rightAsAt"]
    ...
    def from_dict(cls, obj: dict) -> RecDatesReconciled:
        ...
        if not isinstance(obj, dict):
            return RecDatesReconciled.model_validate(obj)

        _obj = RecDatesReconciled.model_validate({
...
RecDatesReconciled.model_rebuild()
