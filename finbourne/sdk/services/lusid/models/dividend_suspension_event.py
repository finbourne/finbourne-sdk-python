...
class DividendSuspensionEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "targetPaymentDate", "announcementDate"]
    ...
    def from_dict(cls, obj: dict) -> DividendSuspensionEvent:
        ...
        if not isinstance(obj, dict):
            return DividendSuspensionEvent.model_validate(obj)

        _obj = DividendSuspensionEvent.model_validate({
...
DividendSuspensionEvent.model_rebuild()
