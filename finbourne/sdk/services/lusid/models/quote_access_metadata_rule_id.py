...
class QuoteAccessMetadataRuleId(BaseModel):
    ...
    instrument_id_type:  Optional[StrictStr] = Field(default=None,alias="instrumentIdType", description="The type of instrument identifier used to uniquely identify the instrument that the quote is for.") 
    ...
    __properties: ClassVar[List[str]] = ["provider", "priceSource", "instrumentId", "instrumentIdType", "quoteType", "field"]
