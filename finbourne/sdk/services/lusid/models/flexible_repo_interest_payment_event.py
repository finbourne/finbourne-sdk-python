...
class FlexibleRepoInterestPaymentEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "settlementDate", "entitlementDate", "currency", "interestPerUnit"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.interest_per_unit is None and "interest_per_unit" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FlexibleRepoInterestPaymentEvent:
        ...
        if not isinstance(obj, dict):
            return FlexibleRepoInterestPaymentEvent.model_validate(obj)

        _obj = FlexibleRepoInterestPaymentEvent.model_validate({
...
FlexibleRepoInterestPaymentEvent.model_rebuild()
