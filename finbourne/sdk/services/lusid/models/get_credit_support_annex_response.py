...
class GetCreditSupportAnnexResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetCreditSupportAnnexResponse:
        ...
        if not isinstance(obj, dict):
            return GetCreditSupportAnnexResponse.model_validate(obj)

        _obj = GetCreditSupportAnnexResponse.model_validate({
            "href": obj.get("href"),
            "value": CreditSupportAnnex.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "failed": dict(
...
GetCreditSupportAnnexResponse.model_rebuild()
