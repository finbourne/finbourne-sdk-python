...
class CreateReconciliationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "name", "description", "isPortfolioGroup", "left", "right", "transactions", "positions", "valuations", "properties"]
    ...
    def from_dict(cls, obj: dict) -> CreateReconciliationRequest:
        ...
        if not isinstance(obj, dict):
            return CreateReconciliationRequest.model_validate(obj)

        _obj = CreateReconciliationRequest.model_validate({
            "code": obj.get("code"),
            "name": obj.get("name"),
...
CreateReconciliationRequest.model_rebuild()
