...
class AppendFxForwardTenorCurveData(AppendMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "tenor", "rate"]
    ...
    def from_dict(cls, obj: dict) -> AppendFxForwardTenorCurveData:
        ...
        if not isinstance(obj, dict):
            return AppendFxForwardTenorCurveData.model_validate(obj)

        _obj = AppendFxForwardTenorCurveData.model_validate({
...
AppendFxForwardTenorCurveData.model_rebuild()
