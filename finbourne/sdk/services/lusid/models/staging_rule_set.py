...
class StagingRuleSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entityType", "stagingRuleSetId", "displayName", "description", "rules", "href", "version", "links"]
    ...
    def from_dict(cls, obj: dict) -> StagingRuleSet:
        ...
        if not isinstance(obj, dict):
            return StagingRuleSet.model_validate(obj)

        _obj = StagingRuleSet.model_validate({
