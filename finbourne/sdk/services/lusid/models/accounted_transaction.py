...
class AccountedTransaction(BaseModel):
    ...
    valuation_point_origin:  Optional[StrictStr] = Field(default=None,alias="valuationPointOrigin", description="Designates if the transaction was originally part of the Valuation Point or if it was added as part of a Complex Close action. Available values: None, Original, Added, OriginalAndAdded.") 
