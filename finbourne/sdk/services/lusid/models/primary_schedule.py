...
class PrimarySchedule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["eventHandlerId"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.event_handler_id:
            _dict['eventHandlerId'] = self.event_handler_id.to_dict(by_alias=by_alias)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> PrimarySchedule:
        ...
        if not isinstance(obj, dict):
            return PrimarySchedule.model_validate(obj)

        _obj = PrimarySchedule.model_validate({
            "event_handler_id": ResourceId.from_dict(_v) if (_v := obj.get("eventHandlerId")) is not None else None
        })
        return _obj

PrimarySchedule.model_rebuild()
