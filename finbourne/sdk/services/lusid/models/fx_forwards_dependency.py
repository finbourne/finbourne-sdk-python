...
class FxForwardsDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "domesticCurrency", "foreignCurrency", "curveType", "date"]
    ...
    def from_dict(cls, obj: dict) -> FxForwardsDependency:
        ...
        if not isinstance(obj, dict):
            return FxForwardsDependency.model_validate(obj)

        _obj = FxForwardsDependency.model_validate({
...
FxForwardsDependency.model_rebuild()
