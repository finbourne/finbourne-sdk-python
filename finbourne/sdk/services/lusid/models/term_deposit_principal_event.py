...
class TermDepositPrincipalEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "currency", "paymentDate", "principalPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> TermDepositPrincipalEvent:
        ...
        if not isinstance(obj, dict):
            return TermDepositPrincipalEvent.model_validate(obj)

        _obj = TermDepositPrincipalEvent.model_validate({
...
TermDepositPrincipalEvent.model_rebuild()
