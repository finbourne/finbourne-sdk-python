...
class TermDeposit(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "contractSize", "flowConvention", "rate", "domCcy", "tradingConventions", "timeZoneConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.flow_convention:
            _dict['flowConvention'] = self.flow_convention.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> TermDeposit:
        ...
        if not isinstance(obj, dict):
            return TermDeposit.model_validate(obj)

        _obj = TermDeposit.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "contract_size": obj.get("contractSize"),
            "flow_convention": FlowConventions.from_dict(_v) if (_v := obj.get("flowConvention")) is not None else None,
            "rate": obj.get("rate"),
