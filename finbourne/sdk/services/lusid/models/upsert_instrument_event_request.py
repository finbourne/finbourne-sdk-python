...
class UpsertInstrumentEventRequest(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="The description of the instrument event.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.event_date_stamps is None and "event_date_stamps" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> UpsertInstrumentEventRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertInstrumentEventRequest.model_validate(obj)

        _obj = UpsertInstrumentEventRequest.model_validate({
...
UpsertInstrumentEventRequest.model_rebuild()
