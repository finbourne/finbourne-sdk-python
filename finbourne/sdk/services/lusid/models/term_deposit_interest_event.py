...
class TermDepositInterestEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "currency", "interestPerUnit", "paymentDate"]
    ...
    def from_dict(cls, obj: dict) -> TermDepositInterestEvent:
        ...
        if not isinstance(obj, dict):
            return TermDepositInterestEvent.model_validate(obj)

        _obj = TermDepositInterestEvent.model_validate({
...
TermDepositInterestEvent.model_rebuild()
