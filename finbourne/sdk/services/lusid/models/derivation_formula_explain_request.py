...
class DerivationFormulaExplainRequest(BaseModel):
    ...
    scope:  Optional[StrictStr] = Field(default=None,alias="scope", description="(Optional) The scope that entity exists in. If no scope is provided, the default scope for the entity type will be used.") 
    code:  Optional[StrictStr] = Field(default=None,alias="code", description="(Optional) The code of the entity, to be provided for entities that support scope/code retrieval. If no code or identifier is provided, the logical evaluation tree without resolved values is returned.") 
    subentity_id:  Optional[StrictStr] = Field(default=None,alias="subentityId", description="(Optional) The id of the sub-entity to explain the derived property for. This must be provided along with the scope/code of the parent entity.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.subentity_id is None and "subentity_id" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.partial_formula is None and "partial_formula" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> DerivationFormulaExplainRequest:
        ...
        if not isinstance(obj, dict):
            return DerivationFormulaExplainRequest.model_validate(obj)

        _obj = DerivationFormulaExplainRequest.model_validate({
...
DerivationFormulaExplainRequest.model_rebuild()
