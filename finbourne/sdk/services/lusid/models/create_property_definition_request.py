...
class CreatePropertyDefinitionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreatePropertyDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return CreatePropertyDefinitionRequest.model_validate(obj)

        _obj = CreatePropertyDefinitionRequest.model_validate({
...
CreatePropertyDefinitionRequest.model_rebuild()
