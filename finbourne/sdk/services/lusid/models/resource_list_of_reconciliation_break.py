...
class ResourceListOfReconciliationBreak(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfReconciliationBreak:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfReconciliationBreak.model_validate(obj)

        _obj = ResourceListOfReconciliationBreak.model_validate({
            "values": [ReconciliationBreak.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfReconciliationBreak.model_rebuild()
