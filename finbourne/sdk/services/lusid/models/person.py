...
class Person(BaseModel):
    ...
    Person
    """
    display_name:  Optional[StrictStr] = Field(default=None,alias="displayName", description="The display name of the Person") 
    ...
    lusid_person_id:  Optional[StrictStr] = Field(default=None,alias="lusidPersonId", description="The unique LUSID Person Identifier of the Person.") 
    ...
    __properties: ClassVar[List[str]] = ["displayName", "description", "href", "lusidPersonId", "identifiers", "properties", "relationships", "version", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.lusid_person_id is None and "lusid_person_id" in self.model_fields_set:
