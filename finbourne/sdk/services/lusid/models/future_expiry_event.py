...
class FutureExpiryEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "expiryDate", "settlementCurrency", "notionalAmountPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> FutureExpiryEvent:
        ...
        if not isinstance(obj, dict):
            return FutureExpiryEvent.model_validate(obj)

        _obj = FutureExpiryEvent.model_validate({
...
FutureExpiryEvent.model_rebuild()
