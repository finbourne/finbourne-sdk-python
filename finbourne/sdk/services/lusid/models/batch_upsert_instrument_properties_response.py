...
class BatchUpsertInstrumentPropertiesResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchUpsertInstrumentPropertiesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchUpsertInstrumentPropertiesResponse:
        """Create an instance of BatchUpsertInstrumentPropertiesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchUpsertInstrumentPropertiesResponse.model_validate(obj)

        _obj = BatchUpsertInstrumentPropertiesResponse.model_validate({
            "values": dict(
                (_k,
...
BatchUpsertInstrumentPropertiesResponse.model_rebuild()
