...
class VersionedResourceListOfFundA2BDataRecord(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VersionedResourceListOfFundA2BDataRecord:
        """Create an instance of VersionedResourceListOfFundA2BDataRecord from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VersionedResourceListOfFundA2BDataRecord:
        """Create an instance of VersionedResourceListOfFundA2BDataRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VersionedResourceListOfFundA2BDataRecord.model_validate(obj)

        _obj = VersionedResourceListOfFundA2BDataRecord.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [FundA2BDataRecord.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfFundA2BDataRecord.model_rebuild()
