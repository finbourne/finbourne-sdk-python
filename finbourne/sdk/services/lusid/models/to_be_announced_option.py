...
class ToBeAnnouncedOption(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "expiryDate", "domCcy", "optionType", "strike", "deliveryType", "underlying", "exerciseType", "premium", "deliveryDays", "businessDayConvention", "settlementCalendars", "timeZoneConventions", "tradingConventions"]
    ...
    def from_dict(cls, obj: dict) -> ToBeAnnouncedOption:
        ...
        if not isinstance(obj, dict):
            return ToBeAnnouncedOption.model_validate(obj)

        _obj = ToBeAnnouncedOption.model_validate({
...
ToBeAnnouncedOption.model_rebuild()
