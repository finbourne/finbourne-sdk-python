...
class OpaqueModelOptions(ModelOptions):
    ...
    __properties: ClassVar[List[str]] = ["modelOptionsType", "data"]
    ...
    def from_dict(cls, obj: dict) -> OpaqueModelOptions:
        ...
        if not isinstance(obj, dict):
            return OpaqueModelOptions.model_validate(obj)

        _obj = OpaqueModelOptions.model_validate({
...
OpaqueModelOptions.model_rebuild()
