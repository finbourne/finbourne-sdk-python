...
class InstrumentCapabilities(BaseModel):
    ...
    """
    instrument_id:  Optional[StrictStr] = Field(default=None,alias="instrumentId", description="The Lusid instrument id for the instrument e.g. 'LUID_00003D4X'.") 
    model:  Optional[StrictStr] = Field(default=None,alias="model", description="The pricing model e.g. 'Discounting'.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.supported_addresses is None and "supported_addresses" in self.model_fields_set:
            _dict['supportedAddresses'] = None

        # set to None if economic_dependencies (nullable) is None
        # and model_fields_set contains the field
        if self.economic_dependencies is None and "economic_dependencies" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InstrumentCapabilities:
        ...
        if not isinstance(obj, dict):
            return InstrumentCapabilities.model_validate(obj)

        _obj = InstrumentCapabilities.model_validate({
...
InstrumentCapabilities.model_rebuild()
