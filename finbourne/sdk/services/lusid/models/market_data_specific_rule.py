...
class MarketDataSpecificRule(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.dependency_source_filter:
            _dict['dependencySourceFilter'] = self.dependency_source_filter.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> MarketDataSpecificRule:
        ...
        if not isinstance(obj, dict):
            return MarketDataSpecificRule.model_validate(obj)

        _obj = MarketDataSpecificRule.model_validate({
            "key": obj.get("key"),
...
MarketDataSpecificRule.model_rebuild()
