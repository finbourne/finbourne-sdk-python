...
class A2BMovementRecord(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["portfolioId", "holdingType", "instrumentScope", "instrumentUid", "subHoldingKeys", "currency", "transactionId", "movementName", "effectiveDate", "units", "runningUnits", "runningBalance", "runningCost", "start", "flows", "gains", "carry", "end", "properties", "groupId", "errors"]
    ...
    def from_dict(cls, obj: dict) -> A2BMovementRecord:
        ...
        if not isinstance(obj, dict):
            return A2BMovementRecord.model_validate(obj)

        _obj = A2BMovementRecord.model_validate({
...
A2BMovementRecord.model_rebuild()
