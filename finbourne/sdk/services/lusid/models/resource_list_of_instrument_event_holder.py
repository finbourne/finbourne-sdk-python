...
class ResourceListOfInstrumentEventHolder(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfInstrumentEventHolder:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfInstrumentEventHolder.model_validate(obj)

        _obj = ResourceListOfInstrumentEventHolder.model_validate({
...
ResourceListOfInstrumentEventHolder.model_rebuild()
