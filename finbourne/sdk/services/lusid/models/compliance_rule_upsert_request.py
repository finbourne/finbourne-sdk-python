...
class ComplianceRuleUpsertRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scope", "code", "displayName", "type", "propertyKey", "value", "lowerBound", "upperBound", "schedule", "hardRequirement", "targetPortfolioIds", "description", "addressKey"]
    ...
    def from_dict(cls, obj: dict) -> ComplianceRuleUpsertRequest:
        ...
        if not isinstance(obj, dict):
            return ComplianceRuleUpsertRequest.model_validate(obj)

        _obj = ComplianceRuleUpsertRequest.model_validate({
            "scope": obj.get("scope"),
            "code": obj.get("code"),
...
ComplianceRuleUpsertRequest.model_rebuild()
