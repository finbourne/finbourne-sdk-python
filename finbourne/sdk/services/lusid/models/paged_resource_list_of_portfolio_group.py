...
class PagedResourceListOfPortfolioGroup(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfPortfolioGroup:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfPortfolioGroup.model_validate(obj)

        _obj = PagedResourceListOfPortfolioGroup.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [PortfolioGroup.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfPortfolioGroup.model_rebuild()
