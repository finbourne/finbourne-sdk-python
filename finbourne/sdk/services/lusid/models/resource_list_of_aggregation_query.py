...
class ResourceListOfAggregationQuery(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfAggregationQuery:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfAggregationQuery.model_validate(obj)

        _obj = ResourceListOfAggregationQuery.model_validate({
            "values": [AggregationQuery.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfAggregationQuery.model_rebuild()
