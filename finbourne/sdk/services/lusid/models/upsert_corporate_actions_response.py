...
class UpsertCorporateActionsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertCorporateActionsResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertCorporateActionsResponse.model_validate(obj)

        _obj = UpsertCorporateActionsResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
UpsertCorporateActionsResponse.model_rebuild()
