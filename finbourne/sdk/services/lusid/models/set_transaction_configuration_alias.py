...
class SetTransactionConfigurationAlias(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> SetTransactionConfigurationAlias:
        ...
        if not isinstance(obj, dict):
            return SetTransactionConfigurationAlias.model_validate(obj)

        _obj = SetTransactionConfigurationAlias.model_validate({
            "type": obj.get("type"),
...
SetTransactionConfigurationAlias.model_rebuild()
