...
class ResourceListOfQuote(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfQuote:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfQuote.model_validate(obj)

        _obj = ResourceListOfQuote.model_validate({
            "values": [Quote.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfQuote.model_rebuild()
