...
class SimpleInstrument(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "maturityDate", "domCcy", "assetClass", "fgnCcys", "simpleInstrumentType", "contractSize", "timeZoneConventions", "tradingConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.fgn_ccys is None and "fgn_ccys" in self.model_fields_set:
            _dict['fgnCcys'] = None
    ...
    def from_dict(cls, obj: dict) -> SimpleInstrument:
        ...
        if not isinstance(obj, dict):
            return SimpleInstrument.model_validate(obj)

        _obj = SimpleInstrument.model_validate({
...
SimpleInstrument.model_rebuild()
