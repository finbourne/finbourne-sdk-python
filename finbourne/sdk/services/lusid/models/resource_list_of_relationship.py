...
class ResourceListOfRelationship(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfRelationship:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfRelationship.model_validate(obj)

        _obj = ResourceListOfRelationship.model_validate({
            "values": [Relationship.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfRelationship.model_rebuild()
