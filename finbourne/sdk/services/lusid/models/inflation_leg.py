...
class InflationLeg(LusidInstrument):
    ...
    pay_receive:  Optional[StrictStr] = Field(default=None,alias="payReceive", description="PayReceive flag for the inflation leg.  This field is optional and defaults to Pay.    Supported string (enumeration) values are: [Pay, Receive].") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "flowConventions", "baseCPI", "calculationType", "capRate", "floorRate", "inflationIndexConventions", "notional", "payReceive", "timeZoneConventions"]
    ...
    def from_dict(cls, obj: dict) -> InflationLeg:
        ...
        if not isinstance(obj, dict):
            return InflationLeg.model_validate(obj)

        _obj = InflationLeg.model_validate({
