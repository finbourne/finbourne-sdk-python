...
class ResourceListOfApplicableInstrumentEvent(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfApplicableInstrumentEvent:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfApplicableInstrumentEvent.model_validate(obj)

        _obj = ResourceListOfApplicableInstrumentEvent.model_validate({
            "values": [ApplicableInstrumentEvent.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfApplicableInstrumentEvent.model_rebuild()
