...
class ResourceListOfAddressKeyDefinition(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceListOfAddressKeyDefinition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceListOfAddressKeyDefinition:
        """Create an instance of ResourceListOfAddressKeyDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceListOfAddressKeyDefinition.model_validate(obj)

        _obj = ResourceListOfAddressKeyDefinition.model_validate({
            "values": [AddressKeyDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfAddressKeyDefinition.model_rebuild()
