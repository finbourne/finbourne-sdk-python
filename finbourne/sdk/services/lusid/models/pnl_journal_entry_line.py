...
class PnlJournalEntryLine(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.journal_entry_line:
            _dict['journalEntryLine'] = self.journal_entry_line.to_dict(by_alias=by_alias)
        ...
        if self.pnl_bucket is None and "pnl_bucket" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> PnlJournalEntryLine:
        ...
        if not isinstance(obj, dict):
            return PnlJournalEntryLine.model_validate(obj)
...
PnlJournalEntryLine.model_rebuild()
