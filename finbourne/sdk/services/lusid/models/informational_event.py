...
class InformationalEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "eventType", "anchorDate", "eventWindowEnd", "diagnostics"]
    ...
    def from_dict(cls, obj: dict) -> InformationalEvent:
        ...
        if not isinstance(obj, dict):
            return InformationalEvent.model_validate(obj)

        _obj = InformationalEvent.model_validate({
...
InformationalEvent.model_rebuild()
