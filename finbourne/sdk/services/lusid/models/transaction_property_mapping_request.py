...
class TransactionPropertyMappingRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> TransactionPropertyMappingRequest:
        ...
        if not isinstance(obj, dict):
            return TransactionPropertyMappingRequest.model_validate(obj)

        _obj = TransactionPropertyMappingRequest.model_validate({
...
TransactionPropertyMappingRequest.model_rebuild()
