...
class ConstituentsAdjustmentHeader(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["effectiveAt", "version", "links"]
    ...
    def from_dict(cls, obj: dict) -> ConstituentsAdjustmentHeader:
        ...
        if not isinstance(obj, dict):
            return ConstituentsAdjustmentHeader.model_validate(obj)

        _obj = ConstituentsAdjustmentHeader.model_validate({
...
ConstituentsAdjustmentHeader.model_rebuild()
