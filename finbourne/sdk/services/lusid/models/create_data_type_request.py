...
class CreateDataTypeRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.reference_data:
            _dict['referenceData'] = self.reference_data.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CreateDataTypeRequest:
        ...
        if not isinstance(obj, dict):
            return CreateDataTypeRequest.model_validate(obj)

        _obj = CreateDataTypeRequest.model_validate({
            "scope": obj.get("scope"),
            "code": obj.get("code"),
...
CreateDataTypeRequest.model_rebuild()
