...
class GetRecipeComposerResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetRecipeComposerResponse:
        ...
        if not isinstance(obj, dict):
            return GetRecipeComposerResponse.model_validate(obj)

        _obj = GetRecipeComposerResponse.model_validate({
            "href": obj.get("href"),
            "value": RecipeComposer.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

GetRecipeComposerResponse.model_rebuild()
