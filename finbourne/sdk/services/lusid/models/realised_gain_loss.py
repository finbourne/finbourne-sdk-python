...
class RealisedGainLoss(BaseModel):
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.purchase_trade_date is None and "purchase_trade_date" in self.model_fields_set:
            _dict['purchaseTradeDate'] = None

        # set to None if purchase_settlement_date (nullable) is None
        # and model_fields_set contains the field
        if self.purchase_settlement_date is None and "purchase_settlement_date" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> RealisedGainLoss:
        ...
        if not isinstance(obj, dict):
            return RealisedGainLoss.model_validate(obj)

        _obj = RealisedGainLoss.model_validate({
...
RealisedGainLoss.model_rebuild()
