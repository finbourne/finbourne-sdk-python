...
class Compounding(BaseModel):
    ...
    """
    averaging_method:  Optional[StrictStr] = Field(default=None,alias="averagingMethod", description="Defines whether a weighted or unweighted average is used when calculating the average rate.  It applies only when CompoundingMethod = ‘Averaging‘.    Default value: None. Available values: None, Unweighted, Weighted, UnweightedIncludingWeekends.") 
    calculation_shift_method:  Optional[StrictStr] = Field(default=None,alias="calculationShiftMethod", description="Defines which resets and day counts are used for the rate calculation    Default value: NoShift. Available values: Lookback, NoShift, ObservationPeriodShift, Lockout.") 
    ...
    __properties: ClassVar[List[str]] = ["averagingMethod", "calculationShiftMethod", "compoundingMethod", "resetFrequency", "shift", "spreadCompoundingMethod", "roundingPrecision"]
