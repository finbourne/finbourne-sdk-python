...
class TransactionSettlementStatus(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.settlement_buckets is None and "settlement_buckets" in self.model_fields_set:
            _dict['settlementBuckets'] = None

        # set to None if invalid_instructions (nullable) is None
        # and model_fields_set contains the field
        if self.invalid_instructions is None and "invalid_instructions" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> TransactionSettlementStatus:
        ...
        if not isinstance(obj, dict):
            return TransactionSettlementStatus.model_validate(obj)
...
TransactionSettlementStatus.model_rebuild()
