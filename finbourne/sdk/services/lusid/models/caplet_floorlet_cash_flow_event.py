...
class CapletFloorletCashFlowEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "entitlementDate", "paymentDate", "currency", "cashFlowPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> CapletFloorletCashFlowEvent:
        ...
        if not isinstance(obj, dict):
            return CapletFloorletCashFlowEvent.model_validate(obj)

        _obj = CapletFloorletCashFlowEvent.model_validate({
...
CapletFloorletCashFlowEvent.model_rebuild()
