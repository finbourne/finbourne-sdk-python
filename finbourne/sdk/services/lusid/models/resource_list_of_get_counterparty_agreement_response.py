...
class ResourceListOfGetCounterpartyAgreementResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetCounterpartyAgreementResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetCounterpartyAgreementResponse.model_validate(obj)

        _obj = ResourceListOfGetCounterpartyAgreementResponse.model_validate({
            "values": [GetCounterpartyAgreementResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetCounterpartyAgreementResponse.model_rebuild()
