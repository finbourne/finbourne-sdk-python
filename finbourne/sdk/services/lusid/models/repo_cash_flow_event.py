...
class RepoCashFlowEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "entitlementDate", "settlementDate", "cashFlowPerUnit", "currency"]
    ...
    def from_dict(cls, obj: dict) -> RepoCashFlowEvent:
        ...
        if not isinstance(obj, dict):
            return RepoCashFlowEvent.model_validate(obj)

        _obj = RepoCashFlowEvent.model_validate({
...
RepoCashFlowEvent.model_rebuild()
