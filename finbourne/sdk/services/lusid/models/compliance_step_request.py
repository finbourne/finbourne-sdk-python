...
if TYPE_CHECKING:
    ...
    from finbourne.sdk.services.lusid.models import (
        BranchStepRequest, CheckStepRequest, FilterStepRequest, GroupByStepRequest, GroupFilterStepRequest, IntermediateComplianceStepRequest, PercentCheckStepRequest)
...
class ComplianceStepRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["complianceStepTypeRequest"]
    ...
    def compliance_step_type_request_validate_enum(cls, value):
        ...
        _allowed = ['FilterStepRequest', 'GroupByStepRequest', 'GroupFilterStepRequest', 'BranchStepRequest', 'CheckStepRequest', 'PercentCheckStepRequest']
        if len(_allowed) != 1:
            return value
    ...
    __discriminator_property_name: ClassVar[str] = 'complianceStepTypeRequest'
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[BranchStepRequest, CheckStepRequest, FilterStepRequest, GroupByStepRequest, GroupFilterStepRequest, IntermediateComplianceStepRequest, PercentCheckStepRequest, ComplianceStepRequest]:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union[BranchStepRequest, CheckStepRequest, FilterStepRequest, GroupByStepRequest, GroupFilterStepRequest, IntermediateComplianceStepRequest, PercentCheckStepRequest, ComplianceStepRequest]:
...
ComplianceStepRequest.model_rebuild()
