...
class ConstantVolatilitySurface(ComplexMarketData):
    ...
    lineage:  Optional[StrictStr] = Field(default=None,alias="lineage") 
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "baseDate", "assetType", "lineage", "volatility", "version"]
    ...
    def from_dict(cls, obj: dict) -> ConstantVolatilitySurface:
        ...
        if not isinstance(obj, dict):
            return ConstantVolatilitySurface.model_validate(obj)

        _obj = ConstantVolatilitySurface.model_validate({
...
ConstantVolatilitySurface.model_rebuild()
