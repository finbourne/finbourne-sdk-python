...
class RateCurveShiftDefinition(ScenarioShiftDefinition):
    ...
    __properties: ClassVar[List[str]] = ["scenarioShiftType", "ccy", "amount", "startTenor", "endTenor", "shiftType", "scale", "applyTo", "pivotTenor", "windowBounds", "curveName", "minimumAmountBps", "applyWhenValue"]
