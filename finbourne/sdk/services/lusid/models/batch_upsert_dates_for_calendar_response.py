...
class BatchUpsertDatesForCalendarResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> BatchUpsertDatesForCalendarResponse:
        ...
        if not isinstance(obj, dict):
            return BatchUpsertDatesForCalendarResponse.model_validate(obj)

        _obj = BatchUpsertDatesForCalendarResponse.model_validate({
            "values": dict(
...
BatchUpsertDatesForCalendarResponse.model_rebuild()
