...
class ResourceListOfInstrumentCashFlow(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfInstrumentCashFlow:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfInstrumentCashFlow.model_validate(obj)

        _obj = ResourceListOfInstrumentCashFlow.model_validate({
            "values": [InstrumentCashFlow.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfInstrumentCashFlow.model_rebuild()
