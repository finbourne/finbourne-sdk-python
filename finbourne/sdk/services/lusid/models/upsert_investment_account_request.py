...
class UpsertInvestmentAccountRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertInvestmentAccountRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertInvestmentAccountRequest.model_validate(obj)

        _obj = UpsertInvestmentAccountRequest.model_validate({
            "scope": obj.get("scope"),
            "identifiers": dict(
...
UpsertInvestmentAccountRequest.model_rebuild()
