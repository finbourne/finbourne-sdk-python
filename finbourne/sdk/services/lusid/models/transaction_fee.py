...
class TransactionFee(BaseModel):
    ...
    name:  Optional[StrictStr] = Field(default=None,alias="name", description="The display name of the transaction fee.") 
    ...
    capitalised:  Optional[StrictStr] = Field(default=None,alias="capitalised", description="Specifies whether the fee should be capitalised, not capitalised or conditionally capitalised.") 
    capitalisation_condition:  Optional[StrictStr] = Field(default=None,alias="capitalisationCondition", description="If the fee Capitalisation is Conditional, this condition determines whether the fee is capitalised, when applied to the transaction.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.capitalised is None and "capitalised" in self.model_fields_set:
            _dict['capitalised'] = None

        # set to None if capitalisation_condition (nullable) is None
        # and model_fields_set contains the field
        if self.capitalisation_condition is None and "capitalisation_condition" in self.model_fields_set:
