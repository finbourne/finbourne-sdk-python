...
class ResourceListOfGetRecipeResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetRecipeResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetRecipeResponse.model_validate(obj)

        _obj = ResourceListOfGetRecipeResponse.model_validate({
            "values": [GetRecipeResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetRecipeResponse.model_rebuild()
