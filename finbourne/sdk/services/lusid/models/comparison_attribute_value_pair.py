...
class ComparisonAttributeValuePair(BaseModel):
    ...
    value:  Optional[StrictStr] = Field(default=None,alias="value", description="Computed value for the comparison rule attribute.") 
    __properties: ClassVar[List[str]] = ["attributeName", "value"]
    ...
    def from_dict(cls, obj: dict) -> ComparisonAttributeValuePair:
        ...
        if not isinstance(obj, dict):
            return ComparisonAttributeValuePair.model_validate(obj)

        _obj = ComparisonAttributeValuePair.model_validate({
            "attribute_name": obj.get("attributeName"),
            "value": obj.get("value")
        })
        return _obj

ComparisonAttributeValuePair.model_rebuild()
