...
class OpaqueMarketData(ComplexMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "document", "format", "name", "lineage", "version"]
    ...
    def from_dict(cls, obj: dict) -> OpaqueMarketData:
        ...
        if not isinstance(obj, dict):
            return OpaqueMarketData.model_validate(obj)

        _obj = OpaqueMarketData.model_validate({
...
OpaqueMarketData.model_rebuild()
