...
class ResourceListOfComplianceRule(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfComplianceRule:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfComplianceRule.model_validate(obj)

        _obj = ResourceListOfComplianceRule.model_validate({
            "values": [ComplianceRule.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfComplianceRule.model_rebuild()
