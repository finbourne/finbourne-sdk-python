...
class MbsPrincipalWriteOffEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "exDate", "paymentDate", "currency", "principalPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> MbsPrincipalWriteOffEvent:
        ...
        if not isinstance(obj, dict):
            return MbsPrincipalWriteOffEvent.model_validate(obj)

        _obj = MbsPrincipalWriteOffEvent.model_validate({
...
MbsPrincipalWriteOffEvent.model_rebuild()
