...
class CreditDefaultSwap(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "ticker", "startDate", "maturityDate", "flowConventions", "couponRate", "conventionName", "notional", "protectionDetailSpecification", "additionalPayments", "timeZoneConventions"]
