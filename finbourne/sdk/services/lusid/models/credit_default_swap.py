...
class CreditDefaultSwap(LusidInstrument):
    ...
    """
    ticker:  Optional[StrictStr] = Field(default=None,alias="ticker", description="A ticker to uniquely specify the entity against which the CDS is written. Defaults to \"DefaultCDSTicker\".") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "ticker", "startDate", "maturityDate", "flowConventions", "couponRate", "conventionName", "notional", "isNonStandard", "protectionDetailSpecification", "additionalPayments", "timeZoneConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.protection_detail_specification:
            _dict['protectionDetailSpecification'] = self.protection_detail_specification.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CreditDefaultSwap:
        ...
        if not isinstance(obj, dict):
            return CreditDefaultSwap.model_validate(obj)

        _obj = CreditDefaultSwap.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "ticker": obj.get("ticker") if obj.get("ticker") is not None else 'DefaultCDSTicker',
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "flow_conventions": CdsFlowConventions.from_dict(_v) if (_v := obj.get("flowConventions")) is not None else None,
            ...
            "protection_detail_specification": CdsProtectionDetailSpecification.from_dict(_v) if (_v := obj.get("protectionDetailSpecification")) is not None else None,
...
CreditDefaultSwap.model_rebuild()
