...
class ResourceListOfChangeIntervalWithOrderManagementDetail(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfChangeIntervalWithOrderManagementDetail:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfChangeIntervalWithOrderManagementDetail.model_validate(obj)

        _obj = ResourceListOfChangeIntervalWithOrderManagementDetail.model_validate({
            "values": [ChangeIntervalWithOrderManagementDetail.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfChangeIntervalWithOrderManagementDetail.model_rebuild()
