...
class AnnulSingleStructuredDataResponse(BaseModel):
    """
    ...
    value: Optional[datetime] = Field(default=None, description="The time at which the identifier was annulled")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnulSingleStructuredDataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnulSingleStructuredDataResponse:
        """Create an instance of AnnulSingleStructuredDataResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnulSingleStructuredDataResponse.model_validate(obj)

        _obj = AnnulSingleStructuredDataResponse.model_validate({
            "href": obj.get("href"),
            "value": obj.get("value"),
...
AnnulSingleStructuredDataResponse.model_rebuild()
