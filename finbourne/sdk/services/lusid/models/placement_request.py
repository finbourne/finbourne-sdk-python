...
class PlacementRequest(BaseModel):
    ...
    state:  Optional[StrictStr] = Field(default=None,alias="state", description="The state of this placement (typically a FIX state; Open, Filled, etc).") 
    ...
    __properties: ClassVar[List[str]] = ["id", "parentPlacementId", "blockIds", "properties", "instrumentIdentifiers", "quantity", "amount", "state", "side", "timeInForce", "type", "createdDate", "limitPrice", "stopPrice", "counterparty", "executionSystem", "entryType"]
    ...
    def from_dict(cls, obj: dict) -> PlacementRequest:
        ...
        if not isinstance(obj, dict):
            return PlacementRequest.model_validate(obj)

        _obj = PlacementRequest.model_validate({
