...
class UpsertQuoteAccessMetadataRuleRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertQuoteAccessMetadataRuleRequest:
        ...
        if not isinstance(obj, dict):
            return UpsertQuoteAccessMetadataRuleRequest.model_validate(obj)

        _obj = UpsertQuoteAccessMetadataRuleRequest.model_validate({
...
UpsertQuoteAccessMetadataRuleRequest.model_rebuild()
