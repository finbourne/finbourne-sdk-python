...
class PagedResourceListOfOrderGraphPlacement(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfOrderGraphPlacement:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfOrderGraphPlacement.model_validate(obj)

        _obj = PagedResourceListOfOrderGraphPlacement.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [OrderGraphPlacement.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

PagedResourceListOfOrderGraphPlacement.model_rebuild()
