...
class ResourceListOfListComplexMarketDataWithMetaDataResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfListComplexMarketDataWithMetaDataResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfListComplexMarketDataWithMetaDataResponse.model_validate(obj)

        _obj = ResourceListOfListComplexMarketDataWithMetaDataResponse.model_validate({
            "values": [ListComplexMarketDataWithMetaDataResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfListComplexMarketDataWithMetaDataResponse.model_rebuild()
