...
class LusidInstrument(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[Basket, Bond, BondForward, BondOption, CapFloor, Cash, CashPerpetual, CdsIndex, CdsOption, CommodityCalendarSwap, CommodityForward, ComplexBond, ContractForDifference, CreditDefaultSwap, Equity, EquityOption, EquitySwap, ExchangeTradedOption, ExoticInstrument, FlexibleDeposit, FlexibleLoan, FlexibleRepo, ForwardRateAgreement, FundShareClass, Future, FxForward, FxOption, FxSwap, InflationLeg, InflationLinkedBond, InflationSwap, InstrumentLeg, InterestRateSwap, InterestRateSwaption, LoanFacility, MasteredInstrument, PreferredShare, ReferenceInstrument, Repo, SimpleCashFlowLoan, SimpleInstrument, TermDeposit, ToBeAnnounced, ToBeAnnouncedOption, TotalReturnSwap, VolatilitySwap, LusidInstrument]:
