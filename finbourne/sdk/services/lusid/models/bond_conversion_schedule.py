...
class BondConversionSchedule(Schedule):
    ...
    delivery_type:  Optional[StrictStr] = Field(default=None,alias="deliveryType", description="Is a conversion made into cash or into shares?  Defaults to \"Physical\" if not set.    Supported string (enumeration) values are: [Cash, Physical].") 
    ...
    __properties: ClassVar[List[str]] = ["scheduleType", "identifiers", "bondConversionEntries", "conversionTrigger", "deliveryType", "exerciseType", "includesAccrued", "mandatoryConversion", "notificationPeriodEnd", "notificationPeriodStart"]
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.bond_conversion_entries is None and "bond_conversion_entries" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> BondConversionSchedule:
        ...
        if not isinstance(obj, dict):
            return BondConversionSchedule.model_validate(obj)

        _obj = BondConversionSchedule.model_validate({
            "schedule_type": obj.get("scheduleType"),
            "identifiers": obj.get("identifiers"),
            "bond_conversion_entries": [BondConversionEntry.from_dict(_item) for _item in _v] if (_v := obj.get("bondConversionEntries")) is not None else None,
...
BondConversionSchedule.model_rebuild()
