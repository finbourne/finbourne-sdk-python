...
class InstrumentActivityAdjustment(NavActivityAdjustmentResponse):
    ...
    __properties: ClassVar[List[str]] = ["navActivityAdjustmentType", "navActivityAdjustmentSource", "asAt", "scope", "lusidInstrumentId"]
    ...
    def from_dict(cls, obj: dict) -> InstrumentActivityAdjustment:
        ...
        if not isinstance(obj, dict):
            return InstrumentActivityAdjustment.model_validate(obj)

        _obj = InstrumentActivityAdjustment.model_validate({
...
InstrumentActivityAdjustment.model_rebuild()
