...
class FxVolDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "domesticCurrency", "foreignCurrency", "volType", "date"]
    ...
    def from_dict(cls, obj: dict) -> FxVolDependency:
        ...
        if not isinstance(obj, dict):
            return FxVolDependency.model_validate(obj)

        _obj = FxVolDependency.model_validate({
