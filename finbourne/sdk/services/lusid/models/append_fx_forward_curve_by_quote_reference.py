...
class AppendFxForwardCurveByQuoteReference(AppendMarketData):
    ...
    def from_dict(cls, obj: dict) -> AppendFxForwardCurveByQuoteReference:
        ...
        if not isinstance(obj, dict):
            return AppendFxForwardCurveByQuoteReference.model_validate(obj)

        _obj = AppendFxForwardCurveByQuoteReference.model_validate({
...
AppendFxForwardCurveByQuoteReference.model_rebuild()
