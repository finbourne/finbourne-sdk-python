...
class FlexibleRepoPartialClosureEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "entitlementDate", "settlementDate", "amount", "amountType", "partialClosureConstituents"]
    ...
    def from_dict(cls, obj: dict) -> FlexibleRepoPartialClosureEvent:
        ...
        if not isinstance(obj, dict):
            return FlexibleRepoPartialClosureEvent.model_validate(obj)

        _obj = FlexibleRepoPartialClosureEvent.model_validate({
            "instrument_event_type": obj.get("instrumentEventType"),
            "entitlement_date": obj.get("entitlementDate"),
            "settlement_date": obj.get("settlementDate"),
            "amount": obj.get("amount"),
            "amount_type": obj.get("amountType"),
            "partial_closure_constituents": [PartialClosureConstituent.from_dict(_item) for _item in _v] if (_v := obj.get("partialClosureConstituents")) is not None else None
        })
...
FlexibleRepoPartialClosureEvent.model_rebuild()
