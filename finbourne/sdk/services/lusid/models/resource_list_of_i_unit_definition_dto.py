...
class ResourceListOfIUnitDefinitionDto(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfIUnitDefinitionDto:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfIUnitDefinitionDto.model_validate(obj)

        _obj = ResourceListOfIUnitDefinitionDto.model_validate({
            "values": [IUnitDefinitionDto.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfIUnitDefinitionDto.model_rebuild()
