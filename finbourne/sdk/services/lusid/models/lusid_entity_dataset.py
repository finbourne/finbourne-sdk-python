...
class LusidEntityDataset(BaseModel):
    ...
    scope:  Optional[StrictStr] = Field(default=None,alias="scope", description="The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestorRecord, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity).") 
