...
class ResourceListOfDataModelSummary(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfDataModelSummary:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfDataModelSummary.model_validate(obj)

        _obj = ResourceListOfDataModelSummary.model_validate({
            "values": [DataModelSummary.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfDataModelSummary.model_rebuild()
