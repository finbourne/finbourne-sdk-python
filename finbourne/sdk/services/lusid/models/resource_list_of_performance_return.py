...
class ResourceListOfPerformanceReturn(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPerformanceReturn:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPerformanceReturn.model_validate(obj)

        _obj = ResourceListOfPerformanceReturn.model_validate({
            "values": [PerformanceReturn.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPerformanceReturn.model_rebuild()
