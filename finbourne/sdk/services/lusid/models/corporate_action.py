...
class CorporateAction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CorporateAction:
        ...
        if not isinstance(obj, dict):
            return CorporateAction.model_validate(obj)

        _obj = CorporateAction.model_validate({
            ...
            "transitions": [CorporateActionTransition.from_dict(_item) for _item in _v] if (_v := obj.get("transitions")) is not None else None
        })
        return _obj
