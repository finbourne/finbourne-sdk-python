...
class FlexibleRepoCollateralEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "settlementDate", "entitlementDate", "amount", "collateralInstrument"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.collateral_instrument:
            _dict['collateralInstrument'] = self.collateral_instrument.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> FlexibleRepoCollateralEvent:
        ...
        _obj = FlexibleRepoCollateralEvent.model_validate({
            ...
            "collateral_instrument": NewInstrument.from_dict(_v) if (_v := obj.get("collateralInstrument")) is not None else None
        })
