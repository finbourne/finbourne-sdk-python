...
class BatchUpsertTransactionSettlementInstructionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> BatchUpsertTransactionSettlementInstructionResponse:
        ...
        if not isinstance(obj, dict):
            return BatchUpsertTransactionSettlementInstructionResponse.model_validate(obj)

        _obj = BatchUpsertTransactionSettlementInstructionResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
BatchUpsertTransactionSettlementInstructionResponse.model_rebuild()
