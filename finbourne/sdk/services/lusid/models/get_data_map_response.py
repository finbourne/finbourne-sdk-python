...
class GetDataMapResponse(BaseModel):
    ...
    values: Optional[Dict[str, DataMapping]] = Field(default=None, description="The set of values that were successfully retrieved.")
    failed: Optional[Dict[str, ErrorDetail]] = Field(default=None, description="The set of values that could not be retrieved along with a reason for this, e.g. badly formed request.")
    ...
    def from_dict(cls, obj: dict) -> GetDataMapResponse:
        ...
        if not isinstance(obj, dict):
            return GetDataMapResponse.model_validate(obj)

        _obj = GetDataMapResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
GetDataMapResponse.model_rebuild()
