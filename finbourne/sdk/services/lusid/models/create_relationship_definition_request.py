...
class CreateRelationshipDefinitionRequest(BaseModel):
    ...
    life_time:  Optional[StrictStr] = Field(default=None,alias="lifeTime", description="Describes how the relationships can change over time. Default value: Perpetual. Available values: Perpetual, TimeVariant.") 
    relationship_cardinality:  Optional[StrictStr] = Field(default=None,alias="relationshipCardinality", description="Describes the cardinality of the relationship with a specific source entity object and relationships under this definition. Default value: ManyToMany. Available values: ManyToOne, ManyToMany.") 
    __properties: ClassVar[List[str]] = ["scope", "code", "sourceEntityType", "targetEntityType", "displayName", "outwardDescription", "inwardDescription", "lifeTime", "relationshipCardinality"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.relationship_cardinality is None and "relationship_cardinality" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> CreateRelationshipDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return CreateRelationshipDefinitionRequest.model_validate(obj)

        _obj = CreateRelationshipDefinitionRequest.model_validate({
            "scope": obj.get("scope"),
            "code": obj.get("code"),
...
CreateRelationshipDefinitionRequest.model_rebuild()
