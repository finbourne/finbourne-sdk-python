...
class VersionedResourceListOfHoldingContributor(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfHoldingContributor:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfHoldingContributor.model_validate(obj)

        _obj = VersionedResourceListOfHoldingContributor.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [HoldingContributor.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfHoldingContributor.model_rebuild()
