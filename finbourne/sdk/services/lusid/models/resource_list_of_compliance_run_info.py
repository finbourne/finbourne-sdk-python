...
class ResourceListOfComplianceRunInfo(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfComplianceRunInfo:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfComplianceRunInfo.model_validate(obj)

        _obj = ResourceListOfComplianceRunInfo.model_validate({
            "values": [ComplianceRunInfo.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfComplianceRunInfo.model_rebuild()
