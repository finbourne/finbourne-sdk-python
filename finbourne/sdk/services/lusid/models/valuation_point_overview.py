...
class ValuationPointOverview(BaseModel):
    ...
    diary_entry_variant:  Optional[StrictStr] = Field(default=None,alias="diaryEntryVariant", description="The Variant for the Valuation Point. Together with the valuation point code marks the unique branch for the NavType.") 
    ...
    def from_dict(cls, obj: dict) -> ValuationPointOverview:
        ...
        if not isinstance(obj, dict):
            return ValuationPointOverview.model_validate(obj)

        _obj = ValuationPointOverview.model_validate({
            "href": obj.get("href"),
...
ValuationPointOverview.model_rebuild()
