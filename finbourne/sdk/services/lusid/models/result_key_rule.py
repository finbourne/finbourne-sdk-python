...
if TYPE_CHECKING:
    ...
    from finbourne.sdk.services.lusid.models import (
        PortfolioResultDataKeyRule, ResultDataKeyRule)
...
class ResultKeyRule(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["resultKeyRuleType"]
    ...
    __discriminator_property_name: ClassVar[str] = 'resultKeyRuleType'
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Union[PortfolioResultDataKeyRule, ResultDataKeyRule, ResultKeyRule]:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Union[PortfolioResultDataKeyRule, ResultDataKeyRule, ResultKeyRule]:
