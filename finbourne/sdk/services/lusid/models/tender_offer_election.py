...
class TenderOfferElection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenderOfferCurrency", "tenderOfferPrice", "electionKey", "isChosen", "isDefault"]
    ...
    def from_dict(cls, obj: dict) -> TenderOfferElection:
        ...
        if not isinstance(obj, dict):
            return TenderOfferElection.model_validate(obj)

        _obj = TenderOfferElection.model_validate({
...
TenderOfferElection.model_rebuild()
