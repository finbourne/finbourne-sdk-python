...
class GroupReconciliationUserReviewMatchKey(BaseModel):
    ...
    """
    match_key:  StrictStr = Field(...,alias="matchKey", description="The match key of the reconciliation result.") 
    ...
    __properties: ClassVar[List[str]] = ["matchKey", "userId", "asAtAdded", "asAtInvalid"]
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationUserReviewMatchKey:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationUserReviewMatchKey.model_validate(obj)

        _obj = GroupReconciliationUserReviewMatchKey.model_validate({
...
GroupReconciliationUserReviewMatchKey.model_rebuild()
