...
class TransactionQueryParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "queryMode", "showCancelledTransactions", "timelineScope", "timelineCode", "includeEconomics", "includeSettlementStatus", "settlementStatusDate", "returnExcludedTransactions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.settlement_status_date is None and "settlement_status_date" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> TransactionQueryParameters:
        ...
        if not isinstance(obj, dict):
            return TransactionQueryParameters.model_validate(obj)

        _obj = TransactionQueryParameters.model_validate({
...
TransactionQueryParameters.model_rebuild()
