...
class ExchangeTradedOptionContractDetails(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ExchangeTradedOptionContractDetails:
        ...
        if not isinstance(obj, dict):
            return ExchangeTradedOptionContractDetails.model_validate(obj)

        _obj = ExchangeTradedOptionContractDetails.model_validate({
...
ExchangeTradedOptionContractDetails.model_rebuild()
