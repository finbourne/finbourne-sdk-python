...
class UpdateComplianceTemplateRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdateComplianceTemplateRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateComplianceTemplateRequest.model_validate(obj)

        _obj = UpdateComplianceTemplateRequest.model_validate({
            "code": obj.get("code"),
...
UpdateComplianceTemplateRequest.model_rebuild()
