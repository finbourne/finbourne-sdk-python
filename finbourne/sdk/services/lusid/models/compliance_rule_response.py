...
class ComplianceRuleResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "active", "templateId", "variation", "portfolioGroupId", "parameters", "properties", "version", "stagedModifications", "links"]
