...
class ResourceListOfPortfolioTradeTicket(BaseModel):
    ...
    """
    values: List[PortfolioTradeTicket]
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPortfolioTradeTicket:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPortfolioTradeTicket.model_validate(obj)

        _obj = ResourceListOfPortfolioTradeTicket.model_validate({
            "values": [PortfolioTradeTicket.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPortfolioTradeTicket.model_rebuild()
