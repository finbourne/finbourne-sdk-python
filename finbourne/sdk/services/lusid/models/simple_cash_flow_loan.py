...
class SimpleCashFlowLoan(LusidInstrument):
    ...
    periods: List[LoanPeriod] = Field(description="Periods of the underlying loan")
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "domCcy", "periods", "timeZoneConventions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimpleCashFlowLoan:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimpleCashFlowLoan:
        """Create an instance of SimpleCashFlowLoan from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimpleCashFlowLoan.model_validate(obj)

        _obj = SimpleCashFlowLoan.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "dom_ccy": obj.get("domCcy"),
            "periods": [LoanPeriod.from_dict(_item) for _item in _v] if (_v := obj.get("periods")) is not None else None,
...
SimpleCashFlowLoan.model_rebuild()
