...
class StagedModificationSourceEntity(BaseModel):
    ...
    """
    entity_type:  Optional[StrictStr] = Field(default=None,alias="entityType", description="The type of the source entity.") 
    ...
    def from_dict(cls, obj: dict) -> StagedModificationSourceEntity:
        ...
        if not isinstance(obj, dict):
            return StagedModificationSourceEntity.model_validate(obj)

        _obj = StagedModificationSourceEntity.model_validate({
...
StagedModificationSourceEntity.model_rebuild()
