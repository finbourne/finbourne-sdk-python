...
class FundDefinitionRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.investor_structure is None and "investor_structure" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FundDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return FundDefinitionRequest.model_validate(obj)
...
FundDefinitionRequest.model_rebuild()
