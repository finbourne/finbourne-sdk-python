...
class FxForwardCurveByQuoteReference(ComplexMarketData):
    ...
    spot_days_calculation_type:  Optional[StrictStr] = Field(default=None,alias="spotDaysCalculationType", description="Configures how to calculate the spot date from the build date using the Calendars provided.  Supported string (enumeration) values are: [ SingleCalendar, UnionCalendars ]") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.spot_days_calculation_type is None and "spot_days_calculation_type" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FxForwardCurveByQuoteReference:
        ...
        if not isinstance(obj, dict):
            return FxForwardCurveByQuoteReference.model_validate(obj)

        _obj = FxForwardCurveByQuoteReference.model_validate({
...
FxForwardCurveByQuoteReference.model_rebuild()
