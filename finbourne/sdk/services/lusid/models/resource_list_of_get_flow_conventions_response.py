...
class ResourceListOfGetFlowConventionsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetFlowConventionsResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetFlowConventionsResponse.model_validate(obj)

        _obj = ResourceListOfGetFlowConventionsResponse.model_validate({
            "values": [GetFlowConventionsResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetFlowConventionsResponse.model_rebuild()
