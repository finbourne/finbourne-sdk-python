...
class GetAddressKeyAliasResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAddressKeyAliasResponse:
        """Create an instance of GetAddressKeyAliasResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAddressKeyAliasResponse:
        """Create an instance of GetAddressKeyAliasResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAddressKeyAliasResponse.model_validate(obj)

        _obj = GetAddressKeyAliasResponse.model_validate({
            "href": obj.get("href"),
            "value": AddressKeyAlias.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "failed": ErrorDetail.from_dict(_v) if (_v := obj.get("failed")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

GetAddressKeyAliasResponse.model_rebuild()
