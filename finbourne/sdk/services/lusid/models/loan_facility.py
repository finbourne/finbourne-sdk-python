...
class LoanFacility(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "domCcy", "initialCommitment", "loanType", "schedules", "timeZoneConventions"]
    ...
    def from_dict(cls, obj: dict) -> LoanFacility:
        ...
        if not isinstance(obj, dict):
            return LoanFacility.model_validate(obj)

        _obj = LoanFacility.model_validate({
