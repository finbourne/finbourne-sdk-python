...
class ResourceListOfChange(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfChange:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfChange.model_validate(obj)

        _obj = ResourceListOfChange.model_validate({
            "values": [Change.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfChange.model_rebuild()
