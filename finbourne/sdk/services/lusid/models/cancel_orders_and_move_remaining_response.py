...
class CancelOrdersAndMoveRemainingResponse(BaseModel):
    ...
    values: Optional[Dict[str, CancelOrderAndMoveRemainingResult]] = Field(default=None, description="The orders which have been successfully cancelled, and any remaining quantities moved.")
    ...
    def from_dict(cls, obj: dict) -> CancelOrdersAndMoveRemainingResponse:
        ...
        if not isinstance(obj, dict):
            return CancelOrdersAndMoveRemainingResponse.model_validate(obj)

        _obj = CancelOrdersAndMoveRemainingResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
CancelOrdersAndMoveRemainingResponse.model_rebuild()
