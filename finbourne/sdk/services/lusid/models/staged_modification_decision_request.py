...
class StagedModificationDecisionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> StagedModificationDecisionRequest:
        ...
        if not isinstance(obj, dict):
            return StagedModificationDecisionRequest.model_validate(obj)

        _obj = StagedModificationDecisionRequest.model_validate({
            "decision": obj.get("decision"),
            "comment": obj.get("comment")
        })
        return _obj

StagedModificationDecisionRequest.model_rebuild()
