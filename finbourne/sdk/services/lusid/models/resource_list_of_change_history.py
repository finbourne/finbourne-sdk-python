...
class ResourceListOfChangeHistory(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfChangeHistory:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfChangeHistory.model_validate(obj)

        _obj = ResourceListOfChangeHistory.model_validate({
            "values": [ChangeHistory.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfChangeHistory.model_rebuild()
