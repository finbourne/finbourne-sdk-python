...
class CdsFlowConventions(BaseModel):
    ...
    CdsFlowConventions
    """
    roll_frequency:  Optional[StrictStr] = Field(default=None,alias="rollFrequency", description="The frequency at which the reference bonds are updated, this defaults to 6M, but can be 3M, exp for historically issued products.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid)") 
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.roll_frequency is None and "roll_frequency" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> CdsFlowConventions:
        ...
        if not isinstance(obj, dict):
            return CdsFlowConventions.model_validate(obj)

        _obj = CdsFlowConventions.model_validate({
...
CdsFlowConventions.model_rebuild()
