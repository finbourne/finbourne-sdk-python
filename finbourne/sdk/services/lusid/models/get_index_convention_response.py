...
class GetIndexConventionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetIndexConventionResponse:
        ...
        if not isinstance(obj, dict):
            return GetIndexConventionResponse.model_validate(obj)

        _obj = GetIndexConventionResponse.model_validate({
            "href": obj.get("href"),
            "value": IndexConvention.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "failed": dict(
...
GetIndexConventionResponse.model_rebuild()
