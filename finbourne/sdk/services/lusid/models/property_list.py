...
class PropertyList(ReferenceList):
    ...
    def from_dict(cls, obj: dict) -> PropertyList:
        ...
        if not isinstance(obj, dict):
            return PropertyList.model_validate(obj)

        _obj = PropertyList.model_validate({
            "reference_list_type": obj.get("referenceListType"),
            "values": [ModelProperty.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None
        })
