...
class InvestorRecord(BaseModel):
    ...
    display_name:  Optional[StrictStr] = Field(default=None,alias="displayName", description="The display name of the Investor Record") 
    ...
    lusid_investor_record_id:  Optional[StrictStr] = Field(default=None,alias="lusidInvestorRecordId", description="The unique LUSID Investor Record Identifier of the Investor Record.") 
    ...
    __properties: ClassVar[List[str]] = ["scope", "identifiers", "displayName", "description", "investor", "lusidInvestorRecordId", "properties", "relationships", "href", "version", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.investor:
            _dict['investor'] = self.investor.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.lusid_investor_record_id is None and "lusid_investor_record_id" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InvestorRecord:
        ...
        if not isinstance(obj, dict):
            return InvestorRecord.model_validate(obj)

        _obj = InvestorRecord.model_validate({
            "scope": obj.get("scope"),
            "identifiers": dict(
            ...
            "investor": Investor.from_dict(_v) if (_v := obj.get("investor")) is not None else None,
