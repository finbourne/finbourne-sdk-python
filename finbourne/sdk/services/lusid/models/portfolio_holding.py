...
class PortfolioHolding(BaseModel):
    ...
    """
    instrument_scope:  Optional[StrictStr] = Field(default=None,alias="instrumentScope", description="The scope in which the holding's instrument is in.") 
    ...
    holding_type_name:  Optional[StrictStr] = Field(default=None,alias="holdingTypeName", description="The decoded type of the holding e.g. Position, Balance, CashCommitment, Receivable, ForwardFX etc.") 
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.settlement_schedule is None and "settlement_schedule" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.holding_property_balances is None and "holding_property_balances" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> PortfolioHolding:
        ...
        if not isinstance(obj, dict):
            return PortfolioHolding.model_validate(obj)

        _obj = PortfolioHolding.model_validate({
...
PortfolioHolding.model_rebuild()
