...
class ResourceListOfPropertyDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPropertyDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPropertyDefinition.model_validate(obj)

        _obj = ResourceListOfPropertyDefinition.model_validate({
...
ResourceListOfPropertyDefinition.model_rebuild()
