...
class PropertyValueEquals(MatchCriterion):
    ...
    __properties: ClassVar[List[str]] = ["criterionType", "propertyKey", "value"]
    ...
    def criterion_type_validate_enum(cls, value):
        ...
        _allowed = ['PropertyValueEquals', 'PropertyValueIn', 'SubHoldingKeyValueEquals']
        if len(_allowed) != 1:
            return value
    ...
    def from_dict(cls, obj: dict) -> PropertyValueEquals:
        ...
        if not isinstance(obj, dict):
            return PropertyValueEquals.model_validate(obj)

        _obj = PropertyValueEquals.model_validate({
...
PropertyValueEquals.model_rebuild()
