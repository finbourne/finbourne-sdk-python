...
class ValuationPointResourceListOfPnlJournalEntryLine(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfPnlJournalEntryLine:
        ...
        if not isinstance(obj, dict):
            return ValuationPointResourceListOfPnlJournalEntryLine.model_validate(obj)

        _obj = ValuationPointResourceListOfPnlJournalEntryLine.model_validate({
            "start_valuation_point": DiaryEntry.from_dict(_v) if (_v := obj.get("startValuationPoint")) is not None else None,
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [PnlJournalEntryLine.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfPnlJournalEntryLine.model_rebuild()
