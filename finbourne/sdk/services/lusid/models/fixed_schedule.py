...
class FixedSchedule(Schedule):
    ...
    __properties: ClassVar[List[str]] = ["scheduleType", "startDate", "maturityDate", "flowConventions", "couponRate", "conventionName", "exDividendDays", "notional", "paymentCurrency", "stubType", "exDividendConfiguration", "scheduleId"]
    ...
    def from_dict(cls, obj: dict) -> FixedSchedule:
        ...
        if not isinstance(obj, dict):
            return FixedSchedule.model_validate(obj)

        _obj = FixedSchedule.model_validate({
