...
class CreateCutLabelDefinitionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateCutLabelDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return CreateCutLabelDefinitionRequest.model_validate(obj)

        _obj = CreateCutLabelDefinitionRequest.model_validate({
            "code": obj.get("code"),
...
CreateCutLabelDefinitionRequest.model_rebuild()
