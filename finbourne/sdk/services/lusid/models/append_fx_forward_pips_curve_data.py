...
class AppendFxForwardPipsCurveData(AppendMarketData):
    ...
    __properties: ClassVar[List[str]] = ["marketDataType", "date", "pipRate"]
    ...
    def from_dict(cls, obj: dict) -> AppendFxForwardPipsCurveData:
        ...
        if not isinstance(obj, dict):
            return AppendFxForwardPipsCurveData.model_validate(obj)

        _obj = AppendFxForwardPipsCurveData.model_validate({
...
AppendFxForwardPipsCurveData.model_rebuild()
