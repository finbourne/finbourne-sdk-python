...
class FundJournalEntryLine(BaseModel):
    """
    ...
    tax_lot_id:  Optional[StrictStr] = Field(default=None,alias="taxLotId", description="If the holding type is 'B' (settled cash balance), this is 1. Otherwise, this is the ID of a tax lot if applicable, or the source ID of the original transaction if not.") 
    ...
    posting_module_code:  Optional[StrictStr] = Field(default=None,alias="postingModuleCode", description="The code of the posting module where the posting rules derived the Journal Entry lines.") 
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FundJournalEntryLine:
    ...
    def to_dict(self, by_alias=True):
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in share_class_breakdowns (list)
        _items = []
        if self.share_class_breakdowns:
            for _item in self.share_class_breakdowns:
                if _item:
        ...
        # and model_fields_set contains the field
        if self.posting_module_code is None and "posting_module_code" in self.model_fields_set:
            _dict['postingModuleCode'] = None

        # set to None if activities_description (nullable) is None
        # and model_fields_set contains the field
        if self.activities_description is None and "activities_description" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.levels is None and "levels" in self.model_fields_set:
            _dict['levels'] = None

        # set to None if source_levels (nullable) is None
        # and model_fields_set contains the field
        if self.source_levels is None and "source_levels" in self.model_fields_set:
            _dict['sourceLevels'] = None

        # set to None if movement_sign (nullable) is None
        # and model_fields_set contains the field
        if self.movement_sign is None and "movement_sign" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.ledger_column is None and "ledger_column" in self.model_fields_set:
        ...
        # set to None if share_class_breakdowns (nullable) is None
        # and model_fields_set contains the field
        ...
        # and model_fields_set contains the field
        if self.bucket_memberships is None and "bucket_memberships" in self.model_fields_set:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FundJournalEntryLine:
        """Create an instance of FundJournalEntryLine from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundJournalEntryLine.model_validate(obj)

        _obj = FundJournalEntryLine.model_validate({
            ...
            "bucket_memberships": [BucketMembership.from_dict(_item) for _item in _v] if (_v := obj.get("bucketMemberships")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

FundJournalEntryLine.model_rebuild()
