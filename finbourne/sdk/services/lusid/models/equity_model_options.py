...
class EquityModelOptions(ModelOptions):
    ...
    __properties: ClassVar[List[str]] = ["modelOptionsType", "equityForwardProjectionType"]
    ...
    def from_dict(cls, obj: dict) -> EquityModelOptions:
        ...
        if not isinstance(obj, dict):
            return EquityModelOptions.model_validate(obj)

        _obj = EquityModelOptions.model_validate({
...
EquityModelOptions.model_rebuild()
