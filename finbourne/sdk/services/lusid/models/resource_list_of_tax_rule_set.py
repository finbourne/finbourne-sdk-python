...
class ResourceListOfTaxRuleSet(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfTaxRuleSet:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfTaxRuleSet.model_validate(obj)

        _obj = ResourceListOfTaxRuleSet.model_validate({
            "values": [TaxRuleSet.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfTaxRuleSet.model_rebuild()
