...
class VersionedResourceListOfA2BDataRecord(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfA2BDataRecord:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfA2BDataRecord.model_validate(obj)

        _obj = VersionedResourceListOfA2BDataRecord.model_validate({
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [A2BDataRecord.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
VersionedResourceListOfA2BDataRecord.model_rebuild()
