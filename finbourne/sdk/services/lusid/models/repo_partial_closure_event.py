...
class RepoPartialClosureEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "entitlementDate", "settlementDate", "cashAmount", "cashPercentage"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.cash_amount is None and "cash_amount" in self.model_fields_set:
            _dict['cashAmount'] = None

        # set to None if cash_percentage (nullable) is None
        # and model_fields_set contains the field
        if self.cash_percentage is None and "cash_percentage" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> RepoPartialClosureEvent:
        ...
        if not isinstance(obj, dict):
            return RepoPartialClosureEvent.model_validate(obj)

        _obj = RepoPartialClosureEvent.model_validate({
...
RepoPartialClosureEvent.model_rebuild()
