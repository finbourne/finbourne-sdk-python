...
class MbsInterestShortfallEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "exDate", "paymentDate", "currency", "interestPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> MbsInterestShortfallEvent:
        ...
        if not isinstance(obj, dict):
            return MbsInterestShortfallEvent.model_validate(obj)

        _obj = MbsInterestShortfallEvent.model_validate({
...
MbsInterestShortfallEvent.model_rebuild()
