...
class DividendReinvestmentEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "announcementDate", "cashElections", "exDate", "paymentDate", "recordDate", "securityElections", "securitySettlementDate"]
    ...
    def from_dict(cls, obj: dict) -> DividendReinvestmentEvent:
        ...
        _obj = DividendReinvestmentEvent.model_validate({
            ...
            "security_elections": [SecurityElection.from_dict(_item) for _item in _v] if (_v := obj.get("securityElections")) is not None else None,
