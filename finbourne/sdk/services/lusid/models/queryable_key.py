...
class QueryableKey(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="What does the information that is being queried by the address mean. What is the address for.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.applicable_options is None and "applicable_options" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> QueryableKey:
        ...
        if not isinstance(obj, dict):
            return QueryableKey.model_validate(obj)

        _obj = QueryableKey.model_validate({
