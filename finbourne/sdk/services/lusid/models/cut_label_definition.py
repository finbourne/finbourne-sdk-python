...
class CutLabelDefinition(BaseModel):
    ...
    display_name:  Optional[StrictStr] = Field(default=None,alias="displayName", description="") 
    ...
    time_zone:  Optional[StrictStr] = Field(default=None,alias="timeZone", description="") 
    ...
    def from_dict(cls, obj: dict) -> CutLabelDefinition:
        ...
        if not isinstance(obj, dict):
            return CutLabelDefinition.model_validate(obj)

        _obj = CutLabelDefinition.model_validate({
            "code": obj.get("code"),
...
CutLabelDefinition.model_rebuild()
