...
class ValuationPointResourceListOfFundCashStatementRow(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfFundCashStatementRow:
        ...
        if not isinstance(obj, dict):
            return ValuationPointResourceListOfFundCashStatementRow.model_validate(obj)

        _obj = ValuationPointResourceListOfFundCashStatementRow.model_validate({
            "start_valuation_point": DiaryEntry.from_dict(_v) if (_v := obj.get("startValuationPoint")) is not None else None,
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [FundCashStatementRow.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfFundCashStatementRow.model_rebuild()
