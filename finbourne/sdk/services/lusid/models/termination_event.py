...
class TerminationEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "effectiveDate", "settlementDate", "settlementCurrency", "triggeringEventType", "triggeringEventId", "settlementMethod", "assetSettlementAmount", "fundingAccruedAmount", "terminationAmount", "terminationPrice"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.termination_price is None and "termination_price" in self.model_fields_set:
