...
class DataDefinition(BaseModel):
    ...
    name:  Optional[StrictStr] = Field(default=None,alias="name", description="The name of the data item. This is the name that will appear") 
    data_type:  Optional[StrictStr] = Field(default=None,alias="dataType", description="A member of the set of possible data types, that all data passed under that key is expected to be of.  Currently limited to one of [string, integer, decimal, result0d].") 
    ...
    def from_dict(cls, obj: dict) -> DataDefinition:
        ...
        if not isinstance(obj, dict):
            return DataDefinition.model_validate(obj)

        _obj = DataDefinition.model_validate({
