...
class ResourceListOfPropertyInterval(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfPropertyInterval:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfPropertyInterval.model_validate(obj)

        _obj = ResourceListOfPropertyInterval.model_validate({
            "values": [PropertyInterval.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfPropertyInterval.model_rebuild()
