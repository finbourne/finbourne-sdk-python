...
class GetRecipeResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRecipeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRecipeResponse:
        """Create an instance of GetRecipeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRecipeResponse.model_validate(obj)

        _obj = GetRecipeResponse.model_validate({
            "href": obj.get("href"),
            "value": ConfigurationRecipe.from_dict(obj.get("value")) if obj.get("value") is not None else None,
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

GetRecipeResponse.model_rebuild()
