...
class ResourceListOfRelation(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfRelation:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfRelation.model_validate(obj)

        _obj = ResourceListOfRelation.model_validate({
            "values": [Relation.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfRelation.model_rebuild()
