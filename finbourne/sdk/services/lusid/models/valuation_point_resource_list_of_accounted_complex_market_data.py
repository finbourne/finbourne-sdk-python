...
class ValuationPointResourceListOfAccountedComplexMarketData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["startValuationPoint", "version", "values", "href", "nextPage", "previousPage", "links"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValuationPointResourceListOfAccountedComplexMarketData:
        """Create an instance of ValuationPointResourceListOfAccountedComplexMarketData from a JSON string"""
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.start_valuation_point:
            _dict['startValuationPoint'] = self.start_valuation_point.to_dict(by_alias=by_alias)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfAccountedComplexMarketData:
        """Create an instance of ValuationPointResourceListOfAccountedComplexMarketData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValuationPointResourceListOfAccountedComplexMarketData.model_validate(obj)

        _obj = ValuationPointResourceListOfAccountedComplexMarketData.model_validate({
            "start_valuation_point": DiaryEntry.from_dict(_v) if (_v := obj.get("startValuationPoint")) is not None else None,
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [AccountedComplexMarketData.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfAccountedComplexMarketData.model_rebuild()
