...
class FundingLegModelOptions(ModelOptions):
    ...
    __properties: ClassVar[List[str]] = ["modelOptionsType", "expectedFundingLegNotional"]
    ...
    def from_dict(cls, obj: dict) -> FundingLegModelOptions:
        ...
        if not isinstance(obj, dict):
            return FundingLegModelOptions.model_validate(obj)

        _obj = FundingLegModelOptions.model_validate({
...
FundingLegModelOptions.model_rebuild()
