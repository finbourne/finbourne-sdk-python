...
class Instrument(BaseModel):
    ...
    asset_class:  Optional[StrictStr] = Field(default=None,alias="assetClass", description="The nominal asset class of the instrument. Available values: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown, RealEstate.") 
