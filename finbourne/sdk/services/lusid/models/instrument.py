...
class Instrument(BaseModel):
    ...
    asset_class:  Optional[StrictStr] = Field(default=None,alias="assetClass", description="The nominal asset class of the instrument. Available values: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown, RealEstate, Exotic.") 
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.lookthrough_portfolio:
            _dict['lookthroughPortfolio'] = self.lookthrough_portfolio.to_dict(by_alias=by_alias)
        ...
        if self.settlement_cycle:
            _dict['settlementCycle'] = self.settlement_cycle.to_dict(by_alias=by_alias)
