...
class UpdateInstrumentIdentifierRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdateInstrumentIdentifierRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateInstrumentIdentifierRequest.model_validate(obj)

        _obj = UpdateInstrumentIdentifierRequest.model_validate({
            "type": obj.get("type"),
            "value": obj.get("value"),
...
UpdateInstrumentIdentifierRequest.model_rebuild()
