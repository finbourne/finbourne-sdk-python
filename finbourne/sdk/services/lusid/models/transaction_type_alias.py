...
class TransactionTypeAlias(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "description", "transactionClass", "transactionRoles", "isDefault"]
    ...
    def from_dict(cls, obj: dict) -> TransactionTypeAlias:
        ...
        if not isinstance(obj, dict):
            return TransactionTypeAlias.model_validate(obj)

        _obj = TransactionTypeAlias.model_validate({
            "type": obj.get("type"),
...
TransactionTypeAlias.model_rebuild()
