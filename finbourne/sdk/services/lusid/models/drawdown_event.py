...
class DrawdownEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "amount", "date", "contractDetails", "agencyFxRate"]
    ...
    def from_dict(cls, obj: dict) -> DrawdownEvent:
        ...
        if not isinstance(obj, dict):
            return DrawdownEvent.model_validate(obj)

        _obj = DrawdownEvent.model_validate({
