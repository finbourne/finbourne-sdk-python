...
class ResourceListOfQuoteAccessMetadataRule(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfQuoteAccessMetadataRule:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfQuoteAccessMetadataRule.model_validate(obj)

        _obj = ResourceListOfQuoteAccessMetadataRule.model_validate({
            "values": [QuoteAccessMetadataRule.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfQuoteAccessMetadataRule.model_rebuild()
