...
class WarrantsExerciseEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "paymentDate", "periodOfActionStart", "periodOfActionEnd", "responseDeadlineDate", "marketDeadlineDate", "earlyResponseDeadline", "strikePerUnit", "strikeCurrency", "unitsRatio", "newInstrument", "fractionDisposition", "optionExerciseElections", "lapseElections"]
