...
class WarrantsExerciseEvent(InstrumentEvent):
    ...
    strike_currency:  Optional[StrictStr] = Field(default=None,alias="strikeCurrency", description="Currency of the strike (ISO 4217 3-letter code). Required if StrikePerUnit is non-null.") 
    ...
    fraction_disposition:  Optional[StrictStr] = Field(default=None,alias="fractionDisposition", description="Handling of fractional underlying units. Defaults to round-down (RDDN) in the holdings engine when null.                Supported string (enumeration) values are: [RDDN, CINL]. Available values: RDDN, CINL.") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "paymentDate", "periodOfActionStart", "periodOfActionEnd", "responseDeadlineDate", "marketDeadlineDate", "earlyResponseDeadline", "strikePerUnit", "strikeCurrency", "unitsRatio", "newInstrument", "fractionDisposition", "optionExerciseElections", "lapseElections", "unknownProceedsElections"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.strike_per_unit is None and "strike_per_unit" in self.model_fields_set:
            _dict['strikePerUnit'] = None

        # set to None if strike_currency (nullable) is None
        # and model_fields_set contains the field
        if self.strike_currency is None and "strike_currency" in self.model_fields_set:
            _dict['strikeCurrency'] = None

        # set to None if fraction_disposition (nullable) is None
        # and model_fields_set contains the field
        if self.fraction_disposition is None and "fraction_disposition" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> WarrantsExerciseEvent:
        ...
        if not isinstance(obj, dict):
            return WarrantsExerciseEvent.model_validate(obj)

        _obj = WarrantsExerciseEvent.model_validate({
...
WarrantsExerciseEvent.model_rebuild()
