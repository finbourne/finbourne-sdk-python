...
class ResourceListOfInstrumentIdTypeDescriptor(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfInstrumentIdTypeDescriptor:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfInstrumentIdTypeDescriptor.model_validate(obj)

        _obj = ResourceListOfInstrumentIdTypeDescriptor.model_validate({
            "values": [InstrumentIdTypeDescriptor.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfInstrumentIdTypeDescriptor.model_rebuild()
