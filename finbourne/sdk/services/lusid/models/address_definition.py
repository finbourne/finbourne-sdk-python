...
class AddressDefinition(BaseModel):
    ...
    type:  Optional[StrictStr] = Field(default=None,alias="type", description="Available values: String, Int, Decimal, DateTime, Boolean, ResultValue, Result0D, Result1D, Result2D, Json.") 
    ...
    def type_validate_enum(cls, value):
        ...
        _allowed = ['String', 'Int', 'Decimal', 'DateTime', 'Boolean', 'ResultValue', 'Result0D', 'Result1D', 'Result2D', 'Json']
        if len(_allowed) != 1:
            return value
