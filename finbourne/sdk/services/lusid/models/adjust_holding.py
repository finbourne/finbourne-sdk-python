...
class AdjustHolding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "version", "metadata", "links"]
    ...
    def from_dict(cls, obj: dict) -> AdjustHolding:
        ...
        if not isinstance(obj, dict):
            return AdjustHolding.model_validate(obj)

        _obj = AdjustHolding.model_validate({
            "href": obj.get("href"),
