...
class FundCashStatementLocalCurrency(BaseModel):
    ...
    cash_statement_action_type:  Optional[StrictStr] = Field(default=None,alias="cashStatementActionType", description="The action type: Default, Reversal, TrueUp, SystemCorrection, Opening, or Closing.") 
    entry_type:  Optional[StrictStr] = Field(default=None,alias="entryType", description="What drove the row: SystemGenerated (accounting-engine housekeeping such as a reversal/true-up around a backdated transaction) or UserEntered (a real cash movement booked by a user, e.g. a late trade or amendment).") 
    ...
    __properties: ClassVar[List[str]] = ["groupById", "sequenceNumber", "subHoldingKeys", "sourceId", "cashStatementActionType", "entryType", "accountingDate", "activityDate", "movementName", "portfolioId", "instructionType", "diaryEntryCode", "originDiaryEntryCode", "cashflowLocal", "balanceLocal", "properties", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.cashflow_local:
            _dict['cashflowLocal'] = self.cashflow_local.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of balance_local
        if self.balance_local:
            _dict['balanceLocal'] = self.balance_local.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> FundCashStatementLocalCurrency:
        ...
        if not isinstance(obj, dict):
            return FundCashStatementLocalCurrency.model_validate(obj)

        _obj = FundCashStatementLocalCurrency.model_validate({
...
FundCashStatementLocalCurrency.model_rebuild()
