...
class Quote(BaseModel):
    ...
    cut_label:  Optional[StrictStr] = Field(default=None,alias="cutLabel", description="The cut label that this quote was updated or inserted with.") 
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.quote_id:
            _dict['quoteId'] = self.quote_id.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.cut_label is None and "cut_label" in self.model_fields_set:
            _dict['cutLabel'] = None
