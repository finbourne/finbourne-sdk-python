...
class ShareClass(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShareClass:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShareClass:
        """Create an instance of ShareClass from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShareClass.model_validate(obj)

        _obj = ShareClass.model_validate({
