...
class ShareClass(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instrumentIdentifiers", "series", "code", "name", "description", "shareClassShortCode", "launchPrice", "launchDate", "apportionmentFactor", "properties", "fundShareClassType", "distributionType", "domCcy", "tradingConventions", "unitsPrecision", "pricePrecision", "roundingConventions", "roundingConventionsUnits", "timeZoneConventions", "distributionPaymentType", "hedging"]
    ...
    def from_dict(cls, obj: dict) -> ShareClass:
        ...
        _obj = ShareClass.model_validate({
            ...
            "series": [Series.from_dict(_item) for _item in _v] if (_v := obj.get("series")) is not None else None,
            "code": obj.get("code"),
            "name": obj.get("name"),
