...
class FutureMarkToMarketEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "effectiveDate", "settlementCurrency", "notionalAmountPerUnit"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.notional_amount_per_unit is None and "notional_amount_per_unit" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FutureMarkToMarketEvent:
        ...
        if not isinstance(obj, dict):
            return FutureMarkToMarketEvent.model_validate(obj)

        _obj = FutureMarkToMarketEvent.model_validate({
...
FutureMarkToMarketEvent.model_rebuild()
