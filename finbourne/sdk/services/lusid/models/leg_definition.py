...
class LegDefinition(BaseModel):
    ...
    reset_convention:  Optional[StrictStr] = Field(default=None,alias="resetConvention", description="Control how resets are generated relative to swap payment convention(s).    Supported string (enumeration) values are: [InAdvance, InArrears].  Defaults to \"InAdvance\" if not set.") 
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.first_regular_payment_date is None and "first_regular_payment_date" in self.model_fields_set:
            _dict['firstRegularPaymentDate'] = None

        # set to None if first_coupon_type (nullable) is None
        # and model_fields_set contains the field
        if self.first_coupon_type is None and "first_coupon_type" in self.model_fields_set:
            _dict['firstCouponType'] = None

        # set to None if last_regular_payment_date (nullable) is None
        # and model_fields_set contains the field
        if self.last_regular_payment_date is None and "last_regular_payment_date" in self.model_fields_set:
            _dict['lastRegularPaymentDate'] = None

        # set to None if last_coupon_type (nullable) is None
        # and model_fields_set contains the field
        if self.last_coupon_type is None and "last_coupon_type" in self.model_fields_set:
            _dict['lastCouponType'] = None

        # set to None if intermediate_notional_exchange (nullable) is None
        # and model_fields_set contains the field
        if self.intermediate_notional_exchange is None and "intermediate_notional_exchange" in self.model_fields_set:
