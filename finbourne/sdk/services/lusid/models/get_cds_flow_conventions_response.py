...
class GetCdsFlowConventionsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetCdsFlowConventionsResponse:
        ...
        if not isinstance(obj, dict):
            return GetCdsFlowConventionsResponse.model_validate(obj)

        _obj = GetCdsFlowConventionsResponse.model_validate({
            "href": obj.get("href"),
            "value": CdsFlowConventions.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "failed": dict(
...
GetCdsFlowConventionsResponse.model_rebuild()
