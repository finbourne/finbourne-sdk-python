...
class UpsertReferencePortfolioConstituentPropertiesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "version", "properties", "links"]
    ...
    def from_dict(cls, obj: dict) -> UpsertReferencePortfolioConstituentPropertiesResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertReferencePortfolioConstituentPropertiesResponse.model_validate(obj)

        _obj = UpsertReferencePortfolioConstituentPropertiesResponse.model_validate({
            "href": obj.get("href"),
...
UpsertReferencePortfolioConstituentPropertiesResponse.model_rebuild()
