...
class TransitionEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "announcementDate", "exDate", "recordDate", "paymentDate", "inputTransition", "outputTransitions"]
    ...
    def from_dict(cls, obj: dict) -> TransitionEvent:
        ...
        if not isinstance(obj, dict):
            return TransitionEvent.model_validate(obj)

        _obj = TransitionEvent.model_validate({
            "instrument_event_type": obj.get("instrumentEventType"),
            "announcement_date": obj.get("announcementDate"),
            "ex_date": obj.get("exDate"),
            "record_date": obj.get("recordDate"),
            "payment_date": obj.get("paymentDate"),
            "input_transition": InputTransition.from_dict(_v) if (_v := obj.get("inputTransition")) is not None else None,
            "output_transitions": [OutputTransition.from_dict(_item) for _item in _v] if (_v := obj.get("outputTransitions")) is not None else None
        })
