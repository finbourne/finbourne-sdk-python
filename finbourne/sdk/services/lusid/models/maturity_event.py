...
class MaturityEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "maturityDate"]
    ...
    def from_dict(cls, obj: dict) -> MaturityEvent:
        ...
        if not isinstance(obj, dict):
            return MaturityEvent.model_validate(obj)

        _obj = MaturityEvent.model_validate({
