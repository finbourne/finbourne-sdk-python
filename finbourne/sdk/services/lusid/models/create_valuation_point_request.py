...
class CreateValuationPointRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["valuationPointCode", "variant", "name", "effectiveAt", "queryAsAt", "properties", "applyClearDown", "holdingsAsAtOverride", "valuationsAsAtOverride", "updateInclusionDateNavAdjustments"]
    ...
    def from_dict(cls, obj: dict) -> CreateValuationPointRequest:
        ...
        if not isinstance(obj, dict):
            return CreateValuationPointRequest.model_validate(obj)

        _obj = CreateValuationPointRequest.model_validate({
...
CreateValuationPointRequest.model_rebuild()
