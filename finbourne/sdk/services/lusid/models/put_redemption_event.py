...
class PutRedemptionEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "paymentDate", "offerPrice", "currency", "cashOfferElections", "lapseElections", "marketDeadlineDate", "responseDeadlineDate", "earlyResponseDeadline", "exDate", "announcementDate", "accruedInterestPerUnit", "prorationRate", "retainElections", "unknownProceedsElections"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.retain_elections is None and "retain_elections" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> PutRedemptionEvent:
        ...
        _obj = PutRedemptionEvent.model_validate({
            ...
            "retain_elections": [RetainElection.from_dict(_item) for _item in _v] if (_v := obj.get("retainElections")) is not None else None,
