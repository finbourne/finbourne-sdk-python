...
class DataTypeEntity(BaseModel):
    ...
    prevailing_data_type: Optional[DataType] = Field(default=None, alias="prevailingDataType")
    deleted_data_type: Optional[DataType] = Field(default=None, alias="deletedDataType")
    ...
    previewed_data_type: Optional[DataType] = Field(default=None, alias="previewedDataType")
    links: Optional[List[Link]] = None
    __properties: ClassVar[List[str]] = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingDataType", "deletedDataType", "previewedStatus", "previewedDataType", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.prevailing_data_type:
            _dict['prevailingDataType'] = self.prevailing_data_type.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of deleted_data_type
        if self.deleted_data_type:
            _dict['deletedDataType'] = self.deleted_data_type.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of previewed_data_type
        if self.previewed_data_type:
            _dict['previewedDataType'] = self.previewed_data_type.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> DataTypeEntity:
        ...
        if not isinstance(obj, dict):
            return DataTypeEntity.model_validate(obj)

        _obj = DataTypeEntity.model_validate({
            "href": obj.get("href"),
            ...
            "prevailing_data_type": DataType.from_dict(_v) if (_v := obj.get("prevailingDataType")) is not None else None,
            "deleted_data_type": DataType.from_dict(_v) if (_v := obj.get("deletedDataType")) is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_data_type": DataType.from_dict(_v) if (_v := obj.get("previewedDataType")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

DataTypeEntity.model_rebuild()
