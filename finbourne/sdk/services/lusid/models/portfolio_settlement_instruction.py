...
class PortfolioSettlementInstruction(NavActivityAdjustment):
    ...
    __properties: ClassVar[List[str]] = ["navActivityAdjustmentType", "asAt", "portfolioScope", "portfolioCode", "settlementInstructionId"]
    ...
    def from_dict(cls, obj: dict) -> PortfolioSettlementInstruction:
        ...
        if not isinstance(obj, dict):
            return PortfolioSettlementInstruction.model_validate(obj)

        _obj = PortfolioSettlementInstruction.model_validate({
...
PortfolioSettlementInstruction.model_rebuild()
