...
class CancelledOrderResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["orderState"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.order_state:
            _dict['orderState'] = self.order_state.to_dict(by_alias=by_alias)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> CancelledOrderResult:
        ...
        _obj = CancelledOrderResult.model_validate({
            "order_state": Order.from_dict(_v) if (_v := obj.get("orderState")) is not None else None
        })
        return _obj
