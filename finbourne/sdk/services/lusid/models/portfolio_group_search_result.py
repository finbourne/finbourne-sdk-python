...
class PortfolioGroupSearchResult(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="The long form description of the portfolio group.") 
    ...
    __properties: ClassVar[List[str]] = ["href", "id", "displayName", "description", "created", "portfolios", "subGroups", "version", "links"]
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.portfolios is None and "portfolios" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> PortfolioGroupSearchResult:
        ...
        if not isinstance(obj, dict):
            return PortfolioGroupSearchResult.model_validate(obj)

        _obj = PortfolioGroupSearchResult.model_validate({
            "href": obj.get("href"),
...
PortfolioGroupSearchResult.model_rebuild()
