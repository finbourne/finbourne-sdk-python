...
class UpdatePortfolioRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatePortfolioRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatePortfolioRequest:
        """Create an instance of UpdatePortfolioRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatePortfolioRequest.model_validate(obj)

        _obj = UpdatePortfolioRequest.model_validate({
            "display_name": obj.get("displayName"),
            "description": obj.get("description")
        })
        return _obj

UpdatePortfolioRequest.model_rebuild()
