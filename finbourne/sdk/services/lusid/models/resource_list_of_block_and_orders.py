...
class ResourceListOfBlockAndOrders(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfBlockAndOrders:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfBlockAndOrders.model_validate(obj)

        _obj = ResourceListOfBlockAndOrders.model_validate({
            "values": [BlockAndOrders.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfBlockAndOrders.model_rebuild()
