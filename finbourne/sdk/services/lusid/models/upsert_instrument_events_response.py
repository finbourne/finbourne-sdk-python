...
class UpsertInstrumentEventsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpsertInstrumentEventsResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertInstrumentEventsResponse.model_validate(obj)

        _obj = UpsertInstrumentEventsResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
UpsertInstrumentEventsResponse.model_rebuild()
