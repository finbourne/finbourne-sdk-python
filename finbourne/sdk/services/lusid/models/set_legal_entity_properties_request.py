...
class SetLegalEntityPropertiesRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> SetLegalEntityPropertiesRequest:
        ...
        if not isinstance(obj, dict):
            return SetLegalEntityPropertiesRequest.model_validate(obj)

        _obj = SetLegalEntityPropertiesRequest.model_validate({
            "properties": dict(
...
SetLegalEntityPropertiesRequest.model_rebuild()
