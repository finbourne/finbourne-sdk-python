...
class HoldingsAdjustmentHeader(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["effectiveAt", "version", "unmatchedHoldingMethod", "links"]
    ...
    def from_dict(cls, obj: dict) -> HoldingsAdjustmentHeader:
        ...
        if not isinstance(obj, dict):
            return HoldingsAdjustmentHeader.model_validate(obj)

        _obj = HoldingsAdjustmentHeader.model_validate({
...
HoldingsAdjustmentHeader.model_rebuild()
