...
class UpsertResultValuesDataRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.document_id:
            _dict['documentId'] = self.document_id.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of result_value
        if self.result_value:
            _dict['resultValue'] = self.result_value.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.data_address is None and "data_address" in self.model_fields_set:
...
UpsertResultValuesDataRequest.model_rebuild()
