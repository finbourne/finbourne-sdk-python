...
class ConversionEvent(InstrumentEvent):
    ...
    fractional_units_cash_currency:  Optional[StrictStr] = Field(default=None,alias="fractionalUnitsCashCurrency", description="Optional. Used in calculating cash-in-lieu of fractional shares. Not required.  If provided, must have FractionalUnitsCashPrice too.") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "recordDate", "paymentDate", "newInstrument", "responseDeadlineDate", "marketDeadlineDate", "effectiveDate", "periodOfAction", "fractionalUnitsCashPrice", "fractionalUnitsCashCurrency", "securityOfferElections", "cashAndSecurityOfferElections", "cashOfferElections", "lapseElections"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.period_of_action:
            _dict['periodOfAction'] = self.period_of_action.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> ConversionEvent:
        ...
        if not isinstance(obj, dict):
            return ConversionEvent.model_validate(obj)

        _obj = ConversionEvent.model_validate({
            ...
            "period_of_action": EventDateRange.from_dict(_v) if (_v := obj.get("periodOfAction")) is not None else None,
