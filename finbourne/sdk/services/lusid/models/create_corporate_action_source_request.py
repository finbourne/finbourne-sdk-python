...
class CreateCorporateActionSourceRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateCorporateActionSourceRequest:
        ...
        if not isinstance(obj, dict):
            return CreateCorporateActionSourceRequest.model_validate(obj)

        _obj = CreateCorporateActionSourceRequest.model_validate({
            "scope": obj.get("scope"),
            "code": obj.get("code"),
...
CreateCorporateActionSourceRequest.model_rebuild()
