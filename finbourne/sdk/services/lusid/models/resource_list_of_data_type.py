...
class ResourceListOfDataType(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfDataType:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfDataType.model_validate(obj)

        _obj = ResourceListOfDataType.model_validate({
            "values": [DataType.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfDataType.model_rebuild()
