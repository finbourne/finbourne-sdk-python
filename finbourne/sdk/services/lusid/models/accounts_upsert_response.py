...
class AccountsUpsertResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "version", "accounts", "links"]
    ...
    def from_dict(cls, obj: dict) -> AccountsUpsertResponse:
        ...
        if not isinstance(obj, dict):
            return AccountsUpsertResponse.model_validate(obj)

        _obj = AccountsUpsertResponse.model_validate({
            "href": obj.get("href"),
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "accounts": [Account.from_dict(_item) for _item in _v] if (_v := obj.get("accounts")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

AccountsUpsertResponse.model_rebuild()
