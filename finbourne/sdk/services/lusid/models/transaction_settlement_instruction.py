...
class TransactionSettlementInstruction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> TransactionSettlementInstruction:
        ...
        if not isinstance(obj, dict):
            return TransactionSettlementInstruction.model_validate(obj)

        _obj = TransactionSettlementInstruction.model_validate({
...
TransactionSettlementInstruction.model_rebuild()
