...
class PagedResourceListOfComplianceRuleResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PagedResourceListOfComplianceRuleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PagedResourceListOfComplianceRuleResponse:
        """Create an instance of PagedResourceListOfComplianceRuleResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PagedResourceListOfComplianceRuleResponse.model_validate(obj)

        _obj = PagedResourceListOfComplianceRuleResponse.model_validate({
            "next_page": obj.get("nextPage"),
            "previous_page": obj.get("previousPage"),
            "values": [ComplianceRuleResponse.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None,
            "href": obj.get("href"),
            "links": [Link.from_dict(_item) for _item in obj.get("links")] if obj.get("links") is not None else None
        })
        return _obj

PagedResourceListOfComplianceRuleResponse.model_rebuild()
