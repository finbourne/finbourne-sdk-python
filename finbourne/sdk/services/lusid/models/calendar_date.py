...
class CalendarDate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "dateIdentifier", "fromUtc", "toUtc", "localDate", "timezone", "description", "type", "attributes", "sourceData"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.attributes:
            _dict['attributes'] = self.attributes.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CalendarDate:
        ...
        if not isinstance(obj, dict):
            return CalendarDate.model_validate(obj)

        _obj = CalendarDate.model_validate({
            "href": obj.get("href"),
