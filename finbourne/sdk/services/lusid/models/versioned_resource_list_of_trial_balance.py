...
class VersionedResourceListOfTrialBalance(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> VersionedResourceListOfTrialBalance:
        ...
        if not isinstance(obj, dict):
            return VersionedResourceListOfTrialBalance.model_validate(obj)

        _obj = VersionedResourceListOfTrialBalance.model_validate({
...
VersionedResourceListOfTrialBalance.model_rebuild()
