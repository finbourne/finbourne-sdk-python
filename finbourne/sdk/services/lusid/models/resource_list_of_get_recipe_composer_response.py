...
class ResourceListOfGetRecipeComposerResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetRecipeComposerResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetRecipeComposerResponse.model_validate(obj)

        _obj = ResourceListOfGetRecipeComposerResponse.model_validate({
            "values": [GetRecipeComposerResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetRecipeComposerResponse.model_rebuild()
