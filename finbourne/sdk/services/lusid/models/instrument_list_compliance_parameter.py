...
class InstrumentListComplianceParameter(ComplianceParameter):
    ...
    def from_dict(cls, obj: dict) -> InstrumentListComplianceParameter:
        ...
        if not isinstance(obj, dict):
            return InstrumentListComplianceParameter.model_validate(obj)

        _obj = InstrumentListComplianceParameter.model_validate({
...
InstrumentListComplianceParameter.model_rebuild()
