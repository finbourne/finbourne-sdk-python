...
class GroupReconciliationDefinitionRecipeIds(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationDefinitionRecipeIds:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationDefinitionRecipeIds.model_validate(obj)

        _obj = GroupReconciliationDefinitionRecipeIds.model_validate({
...
GroupReconciliationDefinitionRecipeIds.model_rebuild()
