...
class ComponentFilter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["filterId", "filter"]
    ...
    def from_dict(cls, obj: dict) -> ComponentFilter:
        ...
        if not isinstance(obj, dict):
            return ComponentFilter.model_validate(obj)

        _obj = ComponentFilter.model_validate({
            "filter_id": obj.get("filterId"),
            "filter": obj.get("filter")
        })
        return _obj

ComponentFilter.model_rebuild()
