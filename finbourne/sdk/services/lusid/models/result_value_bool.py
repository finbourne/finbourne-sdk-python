...
class ResultValueBool(ResultValue):
    ...
    """
    value: Optional[StrictBool] = Field(default=None, description="The value itself")
    ...
    def from_dict(cls, obj: dict) -> ResultValueBool:
        ...
        if not isinstance(obj, dict):
            return ResultValueBool.model_validate(obj)

        _obj = ResultValueBool.model_validate({
