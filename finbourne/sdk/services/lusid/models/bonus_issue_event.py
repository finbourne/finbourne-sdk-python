...
class BonusIssueEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "announcementDate", "exDate", "recordDate", "paymentDate", "fractionalUnitsCashPrice", "fractionalUnitsCashCurrency", "fractionalUnitsRoundingConvention", "fractionalUnitsDecimalPlaces", "securityOfferElections", "cashOfferElections", "lapseElections", "mixedLotConstituentsElections"]
    ...
    def from_dict(cls, obj: dict) -> BonusIssueEvent:
        ...
        if not isinstance(obj, dict):
            return BonusIssueEvent.model_validate(obj)

        _obj = BonusIssueEvent.model_validate({
