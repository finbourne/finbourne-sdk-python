...
class GroupReconciliationDefinitionCurrencies(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GroupReconciliationDefinitionCurrencies:
        ...
        if not isinstance(obj, dict):
            return GroupReconciliationDefinitionCurrencies.model_validate(obj)

        _obj = GroupReconciliationDefinitionCurrencies.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right")
        })
        return _obj

GroupReconciliationDefinitionCurrencies.model_rebuild()
