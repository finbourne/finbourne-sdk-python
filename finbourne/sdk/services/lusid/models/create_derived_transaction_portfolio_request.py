...
class CreateDerivedTransactionPortfolioRequest(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="A description for the derived transaction portfolio.") 
    ...
    def from_dict(cls, obj: dict) -> CreateDerivedTransactionPortfolioRequest:
        ...
        if not isinstance(obj, dict):
            return CreateDerivedTransactionPortfolioRequest.model_validate(obj)

        _obj = CreateDerivedTransactionPortfolioRequest.model_validate({
...
CreateDerivedTransactionPortfolioRequest.model_rebuild()
