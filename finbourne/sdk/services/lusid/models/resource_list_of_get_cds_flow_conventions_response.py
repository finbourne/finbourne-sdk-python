...
class ResourceListOfGetCdsFlowConventionsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetCdsFlowConventionsResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetCdsFlowConventionsResponse.model_validate(obj)

        _obj = ResourceListOfGetCdsFlowConventionsResponse.model_validate({
            "values": [GetCdsFlowConventionsResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetCdsFlowConventionsResponse.model_rebuild()
