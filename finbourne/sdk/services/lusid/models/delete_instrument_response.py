...
class DeleteInstrumentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "asAt", "stagedModifications", "links"]
    ...
    def from_dict(cls, obj: dict) -> DeleteInstrumentResponse:
        ...
        if not isinstance(obj, dict):
            return DeleteInstrumentResponse.model_validate(obj)

        _obj = DeleteInstrumentResponse.model_validate({
            "href": obj.get("href"),
            "as_at": obj.get("asAt"),
...
DeleteInstrumentResponse.model_rebuild()
