...
class ResourceListOfReturnsEntity(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfReturnsEntity:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfReturnsEntity.model_validate(obj)

        _obj = ResourceListOfReturnsEntity.model_validate({
            "values": [ReturnsEntity.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfReturnsEntity.model_rebuild()
