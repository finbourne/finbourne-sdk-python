...
class CreateUnitDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "displayName", "description", "details"]
    ...
    def from_dict(cls, obj: dict) -> CreateUnitDefinition:
        ...
        if not isinstance(obj, dict):
            return CreateUnitDefinition.model_validate(obj)

        _obj = CreateUnitDefinition.model_validate({
            "code": obj.get("code"),
...
CreateUnitDefinition.model_rebuild()
