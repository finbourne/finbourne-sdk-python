...
class CheckDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "description", "datasetSchema", "ruleSets", "href", "version", "properties", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.dataset_schema:
            _dict['datasetSchema'] = self.dataset_schema.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> CheckDefinition:
        ...
        _obj = CheckDefinition.model_validate({
            ...
            "rule_sets": [CheckDefinitionRuleSet.from_dict(_item) for _item in _v] if (_v := obj.get("ruleSets")) is not None else None,
            "href": obj.get("href"),
