...
class CreateRecDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "description", "definitionType", "sideNames", "leftPortfolioSources", "rightPortfolioSources", "valuationRecipes", "currencies", "rulesets", "reviewConfiguration"]
