...
class ResourceListOfGetCreditSupportAnnexResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfGetCreditSupportAnnexResponse:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfGetCreditSupportAnnexResponse.model_validate(obj)

        _obj = ResourceListOfGetCreditSupportAnnexResponse.model_validate({
            "values": [GetCreditSupportAnnexResponse.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfGetCreditSupportAnnexResponse.model_rebuild()
