...
class CounterpartySignatory(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.legal_entity_identifier:
            _dict['legalEntityIdentifier'] = self.legal_entity_identifier.to_dict(by_alias=by_alias)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> CounterpartySignatory:
        ...
        if not isinstance(obj, dict):
            return CounterpartySignatory.model_validate(obj)
...
CounterpartySignatory.model_rebuild()
