...
class ReconciliationLeftRightAddressKeyPair(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ReconciliationLeftRightAddressKeyPair:
        ...
        if not isinstance(obj, dict):
            return ReconciliationLeftRightAddressKeyPair.model_validate(obj)

        _obj = ReconciliationLeftRightAddressKeyPair.model_validate({
            "left": obj.get("left"),
            "right": obj.get("right")
        })
        return _obj

ReconciliationLeftRightAddressKeyPair.model_rebuild()
