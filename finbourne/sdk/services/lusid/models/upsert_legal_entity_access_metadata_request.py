...
class UpsertLegalEntityAccessMetadataRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertLegalEntityAccessMetadataRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertLegalEntityAccessMetadataRequest:
...
UpsertLegalEntityAccessMetadataRequest.model_rebuild()
