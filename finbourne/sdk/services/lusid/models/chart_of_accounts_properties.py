...
class ChartOfAccountsProperties(BaseModel):
    ...
    properties: Optional[Dict[str, ModelProperty]] = Field(default=None, description="The Chart of Accounts properties. These will be from the 'ChartOfAccounts' domain.")
    ...
    def from_dict(cls, obj: dict) -> ChartOfAccountsProperties:
        ...
        if not isinstance(obj, dict):
            return ChartOfAccountsProperties.model_validate(obj)

        _obj = ChartOfAccountsProperties.model_validate({
            "href": obj.get("href"),
            "properties": dict(
...
ChartOfAccountsProperties.model_rebuild()
