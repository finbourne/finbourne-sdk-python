...
class RecInstance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "recDefinitionId", "asAtInstantiated", "workflowTaskInstantiated", "status", "asAtLocked", "datesLocked", "closedPeriods", "runLog", "href", "version", "links"]
