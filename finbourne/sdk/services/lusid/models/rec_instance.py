...
class RecInstance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "recDefinitionId", "recDefinitionDisplayName", "asAtInstantiated", "status", "asAtLocked", "datesLocked", "closedPeriods", "runLogs", "href", "version", "links"]
        ...
        if self.run_logs:
            for _key in self.run_logs:
                if self.run_logs[_key]:
                    _field_dict[_key] = self.run_logs[_key].to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> RecInstance:
        ...
        _obj = RecInstance.model_validate({
            ...
            if (_val := obj.get("runLogs")) is not None
            else None,
            "href": obj.get("href"),
