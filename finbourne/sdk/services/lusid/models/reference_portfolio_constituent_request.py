...
class ReferencePortfolioConstituentRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ReferencePortfolioConstituentRequest:
        ...
        if not isinstance(obj, dict):
            return ReferencePortfolioConstituentRequest.model_validate(obj)

        _obj = ReferencePortfolioConstituentRequest.model_validate({
...
ReferencePortfolioConstituentRequest.model_rebuild()
