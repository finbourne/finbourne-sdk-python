...
class TotalReturnSwap(LusidInstrument):
    ...
    __properties: ClassVar[List[str]] = ["instrumentType", "startDate", "maturityDate", "assetLeg", "fundingLeg", "additionalPayments", "timeZoneConventions", "tradingConventions"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.asset_leg:
            _dict['assetLeg'] = self.asset_leg.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> TotalReturnSwap:
        ...
        if not isinstance(obj, dict):
            return TotalReturnSwap.model_validate(obj)

        _obj = TotalReturnSwap.model_validate({
            "instrument_type": obj.get("instrumentType"),
            "start_date": obj.get("startDate"),
            "maturity_date": obj.get("maturityDate"),
            "asset_leg": AssetLeg.from_dict(_v) if (_v := obj.get("assetLeg")) is not None else None,
