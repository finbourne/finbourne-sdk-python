...
class FxForwardSettlementEvent(InstrumentEvent):
    ...
    settlement_ccy:  Optional[StrictStr] = Field(default=None,alias="settlementCcy", description="Optional.  Required if the event is an NDF (i.e. if IsNdf = true).  May be set to either DomCcy or FgnCcy, or a third currency.") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "maturityDate", "domAmountPerUnit", "domCcy", "fgnAmountPerUnit", "fgnCcy", "isNdf", "fixingDate", "settlementCcy", "cashFlowPerUnit", "domesticToForeignRate", "domesticToSettlementRate", "foreignToSettlementRate"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.fixing_date is None and "fixing_date" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.domestic_to_foreign_rate is None and "domestic_to_foreign_rate" in self.model_fields_set:
            _dict['domesticToForeignRate'] = None

        # set to None if domestic_to_settlement_rate (nullable) is None
        # and model_fields_set contains the field
        if self.domestic_to_settlement_rate is None and "domestic_to_settlement_rate" in self.model_fields_set:
            _dict['domesticToSettlementRate'] = None

        # set to None if foreign_to_settlement_rate (nullable) is None
        # and model_fields_set contains the field
        if self.foreign_to_settlement_rate is None and "foreign_to_settlement_rate" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> FxForwardSettlementEvent:
        ...
        if not isinstance(obj, dict):
            return FxForwardSettlementEvent.model_validate(obj)

        _obj = FxForwardSettlementEvent.model_validate({
...
FxForwardSettlementEvent.model_rebuild()
