...
class CompositeDispersion(BaseModel):
    ...
    def to_dict(self):
        ...
        if self.dispersion_calculation is None and "dispersion_calculation" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.constituents_in_scope is None and "constituents_in_scope" in self.model_fields_set:
            _dict['constituentsInScope'] = None

        # set to None if constituents_excluded (nullable) is None
        # and model_fields_set contains the field
        if self.constituents_excluded is None and "constituents_excluded" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> CompositeDispersion:
        ...
        if not isinstance(obj, dict):
            return CompositeDispersion.model_validate(obj)

        _obj = CompositeDispersion.model_validate({
...
CompositeDispersion.model_rebuild()
