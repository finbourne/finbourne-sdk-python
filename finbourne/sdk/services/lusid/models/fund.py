...
class Fund(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.primary_nav_type:
            _dict['primaryNavType'] = self.primary_nav_type.to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.portfolio_ids is None and "portfolio_ids" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.additional_nav_types is None and "additional_nav_types" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> Fund:
        ...
        if not isinstance(obj, dict):
            return Fund.model_validate(obj)
