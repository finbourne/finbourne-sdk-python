...
class ScripDividendEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "announcementDate", "exDate", "recordDate", "paymentDate", "fractionalUnitsCashPrice", "fractionalUnitsCashCurrency", "fractionalUnitsRoundingConvention", "fractionalUnitsDecimalPlaces", "unitsRatio"]
    ...
    def from_dict(cls, obj: dict) -> ScripDividendEvent:
        ...
        if not isinstance(obj, dict):
            return ScripDividendEvent.model_validate(obj)

        _obj = ScripDividendEvent.model_validate({
...
ScripDividendEvent.model_rebuild()
