...
class ResourceListOfConstituentsAdjustmentHeader(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfConstituentsAdjustmentHeader:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfConstituentsAdjustmentHeader.model_validate(obj)

        _obj = ResourceListOfConstituentsAdjustmentHeader.model_validate({
            "values": [ConstituentsAdjustmentHeader.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfConstituentsAdjustmentHeader.model_rebuild()
