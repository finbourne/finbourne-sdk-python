...
class RecipeValue(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.from_recipe:
            _dict['fromRecipe'] = self.from_recipe.to_dict(by_alias=by_alias)
        # set to None if as_json (nullable) is None
        # and model_fields_set contains the field
        if self.as_json is None and "as_json" in self.model_fields_set:
            _dict['asJson'] = None

        # set to None if as_string (nullable) is None
        # and model_fields_set contains the field
        if self.as_string is None and "as_string" in self.model_fields_set:
            _dict['asString'] = None
    ...
    def from_dict(cls, obj: dict) -> RecipeValue:
        ...
        if not isinstance(obj, dict):
            return RecipeValue.model_validate(obj)
