...
class IrVolDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "currency", "volType", "date"]
    ...
    def from_dict(cls, obj: dict) -> IrVolDependency:
        ...
        if not isinstance(obj, dict):
            return IrVolDependency.model_validate(obj)

        _obj = IrVolDependency.model_validate({
