...
class DepositSweepEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "sweepDate", "currency"]
    ...
    def from_dict(cls, obj: dict) -> DepositSweepEvent:
        ...
        if not isinstance(obj, dict):
            return DepositSweepEvent.model_validate(obj)

        _obj = DepositSweepEvent.model_validate({
...
DepositSweepEvent.model_rebuild()
