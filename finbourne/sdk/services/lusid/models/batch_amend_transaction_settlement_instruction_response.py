...
class BatchAmendTransactionSettlementInstructionResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> BatchAmendTransactionSettlementInstructionResponse:
        ...
        if not isinstance(obj, dict):
            return BatchAmendTransactionSettlementInstructionResponse.model_validate(obj)

        _obj = BatchAmendTransactionSettlementInstructionResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
BatchAmendTransactionSettlementInstructionResponse.model_rebuild()
