...
class EquityVolDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "code", "domesticCurrency", "volType", "date"]
    ...
    def from_dict(cls, obj: dict) -> EquityVolDependency:
        ...
        if not isinstance(obj, dict):
            return EquityVolDependency.model_validate(obj)

        _obj = EquityVolDependency.model_validate({
...
EquityVolDependency.model_rebuild()
