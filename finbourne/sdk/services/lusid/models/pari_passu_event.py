...
class PariPassuEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "recordDate", "paymentDate", "newInstrument", "unitsRatio"]
    ...
    def from_dict(cls, obj: dict) -> PariPassuEvent:
        ...
        if not isinstance(obj, dict):
            return PariPassuEvent.model_validate(obj)

        _obj = PariPassuEvent.model_validate({
