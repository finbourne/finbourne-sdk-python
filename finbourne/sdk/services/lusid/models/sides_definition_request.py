...
class SidesDefinitionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["side", "sideRequest"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.side_request:
            _dict['sideRequest'] = self.side_request.to_dict(by_alias=by_alias)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> SidesDefinitionRequest:
        ...
        _obj = SidesDefinitionRequest.model_validate({
            "side": obj.get("side"),
            "side_request": SideDefinitionRequest.from_dict(_v) if (_v := obj.get("sideRequest")) is not None else None
        })
        return _obj
