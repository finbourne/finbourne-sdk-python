...
class ExpiryEvent(InstrumentEvent):
    ...
    """
    expiry_date: Optional[datetime] = Field(default=None, description="Expiry date of the instrument", alias="expiryDate")
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "expiryDate"]
    ...
    def from_dict(cls, obj: dict) -> ExpiryEvent:
        ...
        if not isinstance(obj, dict):
            return ExpiryEvent.model_validate(obj)

        _obj = ExpiryEvent.model_validate({
