...
class DiscountingDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "currency", "date"]
    ...
    def from_dict(cls, obj: dict) -> DiscountingDependency:
        ...
        if not isinstance(obj, dict):
            return DiscountingDependency.model_validate(obj)

        _obj = DiscountingDependency.model_validate({
...
DiscountingDependency.model_rebuild()
