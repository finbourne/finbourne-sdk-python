...
class AdjustHoldingRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instrumentIdentifiers", "subHoldingKeys", "properties", "taxLots", "currency", "custodianAccountId"]
    ...
    def from_dict(cls, obj: dict) -> AdjustHoldingRequest:
        ...
        if not isinstance(obj, dict):
            return AdjustHoldingRequest.model_validate(obj)

        _obj = AdjustHoldingRequest.model_validate({
...
AdjustHoldingRequest.model_rebuild()
