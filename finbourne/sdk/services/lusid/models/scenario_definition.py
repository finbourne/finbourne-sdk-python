...
class ScenarioDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scope", "code", "displayName", "description", "shortCode", "scenarioType", "shifts"]
    ...
    def from_dict(cls, obj: dict) -> ScenarioDefinition:
        ...
        if not isinstance(obj, dict):
            return ScenarioDefinition.model_validate(obj)

        _obj = ScenarioDefinition.model_validate({
            "scope": obj.get("scope"),
            "code": obj.get("code"),
