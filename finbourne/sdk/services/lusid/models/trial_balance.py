...
class TrialBalance(BaseModel):
    ...
    description:  Optional[StrictStr] = Field(default=None,alias="description", description="The description of the record.") 
    ...
    def from_dict(cls, obj: dict) -> TrialBalance:
        ...
        if not isinstance(obj, dict):
            return TrialBalance.model_validate(obj)

        _obj = TrialBalance.model_validate({
