...
class CallOnIntermediateSecuritiesEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "expiryDate", "paymentDate", "newInstrument", "unitsRatio", "price", "exerciseCurrency", "optionExerciseElections", "lapseElections"]
