...
class CallOnIntermediateSecuritiesEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "expiryDate", "paymentDate", "newInstrument", "unitsRatio", "price", "exerciseCurrency", "optionExerciseElections", "lapseElections", "oversubscribeElections", "sellEntitlementElections", "unknownProceedsElections"]
    ...
    def to_dict(self, by_alias=True):
        ...
        # and model_fields_set contains the field
        if self.oversubscribe_elections is None and "oversubscribe_elections" in self.model_fields_set:
            _dict['oversubscribeElections'] = None

        # set to None if sell_entitlement_elections (nullable) is None
        # and model_fields_set contains the field
        if self.sell_entitlement_elections is None and "sell_entitlement_elections" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> CallOnIntermediateSecuritiesEvent:
        ...
        if not isinstance(obj, dict):
            return CallOnIntermediateSecuritiesEvent.model_validate(obj)

        _obj = CallOnIntermediateSecuritiesEvent.model_validate({
            ...
            "oversubscribe_elections": [OversubscribeElection.from_dict(_item) for _item in _v] if (_v := obj.get("oversubscribeElections")) is not None else None,
            "sell_entitlement_elections": [SellEntitlementElection.from_dict(_item) for _item in _v] if (_v := obj.get("sellEntitlementElections")) is not None else None,
...
CallOnIntermediateSecuritiesEvent.model_rebuild()
