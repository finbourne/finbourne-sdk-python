...
class QueryRelationalDatasetRequest(BaseModel):
    ...
    filter:  Optional[StrictStr] = Field(default=None,alias="filter", description="Expression to filter the result set. For more information about filtering LUSID results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.") 
