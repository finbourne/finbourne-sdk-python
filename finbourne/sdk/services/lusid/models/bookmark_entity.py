...
class BookmarkEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["href", "entityUniqueId", "asAtVersionNumber", "status", "asAtDeleted", "userIdDeleted", "requestIdDeleted", "effectiveAtCreated", "prevailingBookmark", "deletedBookmark", "previewedStatus", "previewedBookmark", "links"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.prevailing_bookmark:
            _dict['prevailingBookmark'] = self.prevailing_bookmark.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of deleted_bookmark
        if self.deleted_bookmark:
            _dict['deletedBookmark'] = self.deleted_bookmark.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of previewed_bookmark
        if self.previewed_bookmark:
            _dict['previewedBookmark'] = self.previewed_bookmark.to_dict(by_alias=by_alias)
    ...
    def from_dict(cls, obj: dict) -> BookmarkEntity:
        ...
        if not isinstance(obj, dict):
            return BookmarkEntity.model_validate(obj)

        _obj = BookmarkEntity.model_validate({
            "href": obj.get("href"),
            ...
            "prevailing_bookmark": FundCalendarEntry.from_dict(_v) if (_v := obj.get("prevailingBookmark")) is not None else None,
            "deleted_bookmark": FundCalendarEntry.from_dict(_v) if (_v := obj.get("deletedBookmark")) is not None else None,
            "previewed_status": obj.get("previewedStatus"),
            "previewed_bookmark": FundCalendarEntry.from_dict(_v) if (_v := obj.get("previewedBookmark")) is not None else None,
            "links": [Link.from_dict(_item) for _item in _v] if (_v := obj.get("links")) is not None else None
        })
        return _obj

BookmarkEntity.model_rebuild()
