...
class AccessMetadataValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["value", "provider"]
    ...
    def from_dict(cls, obj: dict) -> AccessMetadataValue:
        ...
        if not isinstance(obj, dict):
            return AccessMetadataValue.model_validate(obj)

        _obj = AccessMetadataValue.model_validate({
            "value": obj.get("value"),
            "provider": obj.get("provider")
        })
        return _obj

AccessMetadataValue.model_rebuild()
