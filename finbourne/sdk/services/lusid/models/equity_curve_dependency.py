...
class EquityCurveDependency(EconomicDependency):
    ...
    __properties: ClassVar[List[str]] = ["dependencyType", "marketIdentifier", "code", "curveType", "date"]
    ...
    def from_dict(cls, obj: dict) -> EquityCurveDependency:
        ...
        if not isinstance(obj, dict):
            return EquityCurveDependency.model_validate(obj)

        _obj = EquityCurveDependency.model_validate({
...
EquityCurveDependency.model_rebuild()
