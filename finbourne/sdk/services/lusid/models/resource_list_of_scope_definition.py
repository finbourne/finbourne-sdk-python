...
class ResourceListOfScopeDefinition(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfScopeDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfScopeDefinition.model_validate(obj)

        _obj = ResourceListOfScopeDefinition.model_validate({
            "values": [ScopeDefinition.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ResourceListOfScopeDefinition.model_rebuild()
