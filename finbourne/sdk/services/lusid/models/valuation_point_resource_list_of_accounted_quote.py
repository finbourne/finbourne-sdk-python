...
class ValuationPointResourceListOfAccountedQuote(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValuationPointResourceListOfAccountedQuote:
        ...
        if not isinstance(obj, dict):
            return ValuationPointResourceListOfAccountedQuote.model_validate(obj)

        _obj = ValuationPointResourceListOfAccountedQuote.model_validate({
            "start_valuation_point": DiaryEntry.from_dict(_v) if (_v := obj.get("startValuationPoint")) is not None else None,
            "version": Version.from_dict(_v) if (_v := obj.get("version")) is not None else None,
            "values": [AccountedQuote.from_dict(_item) for _item in _v] if (_v := obj.get("values")) is not None else None,
            "href": obj.get("href"),
...
ValuationPointResourceListOfAccountedQuote.model_rebuild()
