...
class GetFlowConventionsResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetFlowConventionsResponse:
        ...
        if not isinstance(obj, dict):
            return GetFlowConventionsResponse.model_validate(obj)

        _obj = GetFlowConventionsResponse.model_validate({
            "href": obj.get("href"),
            "value": FlowConventions.from_dict(_v) if (_v := obj.get("value")) is not None else None,
            "failed": dict(
...
GetFlowConventionsResponse.model_rebuild()
