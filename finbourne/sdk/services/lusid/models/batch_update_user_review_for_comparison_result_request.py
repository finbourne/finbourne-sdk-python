...
class BatchUpdateUserReviewForComparisonResultRequest(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.user_review_add:
            _dict['userReviewAdd'] = self.user_review_add.to_dict(by_alias=by_alias)
        # override the default output from pydantic by calling `to_dict()` of user_review_remove
        if self.user_review_remove:
            _dict['userReviewRemove'] = self.user_review_remove.to_dict(by_alias=by_alias)
        return _dict
    ...
    def from_dict(cls, obj: dict) -> BatchUpdateUserReviewForComparisonResultRequest:
        ...
        if not isinstance(obj, dict):
            return BatchUpdateUserReviewForComparisonResultRequest.model_validate(obj)
...
BatchUpdateUserReviewForComparisonResultRequest.model_rebuild()
