...
class EarlyCloseOutEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "closeOutAmount", "closeOutCcy", "closeOutToOtherRate", "effectiveDate", "otherAmount", "otherCcy", "otherToCloseOutRate", "settlementCcy"]
