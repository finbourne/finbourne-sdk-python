...
class EarlyCloseOutEvent(InstrumentEvent):
    ...
    other_ccy:  Optional[StrictStr] = Field(default=None,alias="otherCcy", description="The currency corresponding to the other amount to be closed out early. Optional.") 
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "closeOutAmount", "closeOutCcy", "closeOutToOtherRate", "effectiveDate", "closeOutTolerance", "otherAmount", "otherCcy", "otherToCloseOutRate", "settlementCcy"]
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.close_out_to_other_rate is None and "close_out_to_other_rate" in self.model_fields_set:
            _dict['closeOutToOtherRate'] = None

        # set to None if close_out_tolerance (nullable) is None
        # and model_fields_set contains the field
        if self.close_out_tolerance is None and "close_out_tolerance" in self.model_fields_set:
            _dict['closeOutTolerance'] = None

        # set to None if other_amount (nullable) is None
        # and model_fields_set contains the field
        if self.other_amount is None and "other_amount" in self.model_fields_set:
            _dict['otherAmount'] = None

        # set to None if other_ccy (nullable) is None
        # and model_fields_set contains the field
        if self.other_ccy is None and "other_ccy" in self.model_fields_set:
            _dict['otherCcy'] = None

        # set to None if other_to_close_out_rate (nullable) is None
        # and model_fields_set contains the field
        if self.other_to_close_out_rate is None and "other_to_close_out_rate" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> EarlyCloseOutEvent:
        ...
        if not isinstance(obj, dict):
            return EarlyCloseOutEvent.model_validate(obj)

        _obj = EarlyCloseOutEvent.model_validate({
...
EarlyCloseOutEvent.model_rebuild()
