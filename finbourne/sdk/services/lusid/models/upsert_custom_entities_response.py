...
class UpsertCustomEntitiesResponse(BaseModel):
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.staged:
            for _key in self.staged:
                if self.staged[_key]:
                    _field_dict[_key] = self.staged[_key].to_dict(by_alias=by_alias)
        ...
        # and model_fields_set contains the field
        if self.staged is None and "staged" in self.model_fields_set:
            _dict['staged'] = None
    ...
    def from_dict(cls, obj: dict) -> UpsertCustomEntitiesResponse:
        ...
        if not isinstance(obj, dict):
            return UpsertCustomEntitiesResponse.model_validate(obj)

        _obj = UpsertCustomEntitiesResponse.model_validate({
            "href": obj.get("href"),
            "values": dict(
...
UpsertCustomEntitiesResponse.model_rebuild()
