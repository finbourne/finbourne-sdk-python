...
class CustomDataModelIdentifierTypeSpecification(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifierKey", "required"]
    ...
    def from_dict(cls, obj: dict) -> CustomDataModelIdentifierTypeSpecification:
        ...
        if not isinstance(obj, dict):
            return CustomDataModelIdentifierTypeSpecification.model_validate(obj)

        _obj = CustomDataModelIdentifierTypeSpecification.model_validate({
            "identifier_key": obj.get("identifierKey"),
            "required": obj.get("required")
        })
        return _obj

CustomDataModelIdentifierTypeSpecification.model_rebuild()
