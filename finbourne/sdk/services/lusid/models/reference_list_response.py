...
class ReferenceListResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReferenceListResponse:
    ...
    def to_dict(self, by_alias=True):
        ...
        if self.reference_list:
            _dict['referenceList'] = self.reference_list.to_dict(by_alias=by_alias)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReferenceListResponse:
...
ReferenceListResponse.model_rebuild()
