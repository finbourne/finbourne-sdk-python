...
class ResourceListOfOrderInstruction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfOrderInstruction:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfOrderInstruction.model_validate(obj)

        _obj = ResourceListOfOrderInstruction.model_validate({
...
ResourceListOfOrderInstruction.model_rebuild()
