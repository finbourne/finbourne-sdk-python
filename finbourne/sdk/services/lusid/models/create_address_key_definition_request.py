...
class CreateAddressKeyDefinitionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> CreateAddressKeyDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return CreateAddressKeyDefinitionRequest.model_validate(obj)

        _obj = CreateAddressKeyDefinitionRequest.model_validate({
            "address_key": obj.get("addressKey"),
            "type": obj.get("type")
        })
        return _obj

CreateAddressKeyDefinitionRequest.model_rebuild()
