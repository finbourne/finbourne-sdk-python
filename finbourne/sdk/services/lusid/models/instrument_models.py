...
class InstrumentModels(BaseModel):
    ...
    def to_dict(self):
        ...
        # and model_fields_set contains the field
        if self.supported_models is None and "supported_models" in self.model_fields_set:
    ...
    def from_dict(cls, obj: dict) -> InstrumentModels:
        ...
        if not isinstance(obj, dict):
            return InstrumentModels.model_validate(obj)
...
InstrumentModels.model_rebuild()
