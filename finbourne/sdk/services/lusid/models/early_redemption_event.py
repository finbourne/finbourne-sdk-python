...
class EarlyRedemptionEvent(InstrumentEvent):
    ...
    __properties: ClassVar[List[str]] = ["instrumentEventType", "effectiveDate", "currency", "earlyRedemptionElections", "redemptionPercentage", "pricePerUnit", "accruedInterestPerUnit"]
    ...
    def from_dict(cls, obj: dict) -> EarlyRedemptionEvent:
        ...
        _obj = EarlyRedemptionEvent.model_validate({
            ...
            "early_redemption_elections": [EarlyRedemptionElection.from_dict(_item) for _item in _v] if (_v := obj.get("earlyRedemptionElections")) is not None else None,
