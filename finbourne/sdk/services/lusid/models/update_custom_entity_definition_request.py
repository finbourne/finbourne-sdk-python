...
class UpdateCustomEntityDefinitionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdateCustomEntityDefinitionRequest:
        ...
        if not isinstance(obj, dict):
            return UpdateCustomEntityDefinitionRequest.model_validate(obj)

        _obj = UpdateCustomEntityDefinitionRequest.model_validate({
...
UpdateCustomEntityDefinitionRequest.model_rebuild()
