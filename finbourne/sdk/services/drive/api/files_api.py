...
class FilesApi:
    ...
    @validate_call
    def delete_file(self, id: StrictStr, **kwargs) -> None:
    ...
    @validate_call
    def download_file(self, id: StrictStr, **kwargs) -> bytes:
    ...
    def download_file_with_http_info(self, id: StrictStr, **kwargs) -> ApiResponse[bytes]:
        ...
        return self.sync_api_client.call_api(
            '/drive/api/files/{id}/contents', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def get_file(self, id: StrictStr, **kwargs) -> StorageObject:
    ...
    @validate_call
    def update_file_contents(self, id: StrictStr, content_length: int, body: bytes, **kwargs) -> StorageObject:
    ...
    def update_file_contents_with_http_info(self, id: StrictStr, content_length: int, body: bytes, **kwargs) -> ApiResponse[StorageObject]:
        ...
        return self.sync_api_client.call_api(
            '/drive/api/files/{id}/contents', 'PUT',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_call
    def update_file_metadata(self, id: StrictStr, update_file: UpdateFile, **kwargs) -> StorageObject:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def create_file_async(self, x_lusid_drive_filename: StrictStr, x_lusid_drive_path: StrictStr, content_length: int, body: bytes, **kwargs) -> StorageObject:
            """CreateFile: Uploads a file to Lusid Drive. If using an SDK, consider using the UploadAsStreamAsync function for larger files instead.  # noqa: E501
    ...
    @validate_call
    async def delete_file_async(self, id: StrictStr, **kwargs) -> None:
            """[EARLY ACCESS] DeleteFile: Deletes a file from Drive.  # noqa: E501
    ...
    @validate_call
    async def download_file_async(self, id: StrictStr, **kwargs) -> bytes:
            """DownloadFile: Download the file from Drive.  # noqa: E501
    ...
    @validate_call
    async def get_file_async(self, id: StrictStr, **kwargs) -> StorageObject:
            """[EARLY ACCESS] GetFile: Get a file stored in Drive.  # noqa: E501
    ...
    @validate_call
    async def update_file_contents_async(self, id: StrictStr, content_length: int, body: bytes, **kwargs) -> StorageObject:
            """[EARLY ACCESS] UpdateFileContents: Updates contents of a file in Drive.  # noqa: E501
    ...
    @validate_call
    async def update_file_metadata_async(self, id: StrictStr, update_file: UpdateFile, **kwargs) -> StorageObject:
            """[EARLY ACCESS] UpdateFileMetadata: Updates metadata for a file in Drive.  # noqa: E501
