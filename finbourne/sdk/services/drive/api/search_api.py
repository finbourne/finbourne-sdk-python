...
class SearchApi:
  ...
  # --- ASYNC API METHODS ---
    ...
    @validate_call
    async def search_async(self, search_body: SearchBody, page: Optional[StrictStr] = None, sort_by: Optional[List[str]] = None, limit: Optional[int] = None, filter: Optional[StrictStr] = None, **kwargs) -> PagedResourceListOfStorageObject:
            """[EARLY ACCESS] Search: Search for a file or folder with a given name and path  # noqa: E501
