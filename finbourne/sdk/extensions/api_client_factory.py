...
from finbourne.sdk.extensions.retry import (
    RetryingRestWrapper,
...
from finbourne.sdk.extensions.tcp_keep_alive_connector import (
...
class SyncApiClientFactory:
    def __init__(
        ...
        wrapped_rest_client = rest_client_wrapper(
            rest_object=rc, 
            rate_limit_retries=self.configuration.rate_limit_retries)
    ...
    def get_api_configuration(self) -> Configuration:
        # Always return the single config object
